...
- [Cyclic Graph and Temporal Unrolling](./temporal-unrolling.md) - cycle support, back-edges, double-buffering
- [Multi-Rate and Partial-Screen Rendering](./multi-rate-rendering.md) - pass activation, region descriptors, variable-rate scheduling
- [Sample Applications](./sample-apps.md) - VR stereo, multi-pass toggle, etc.
- [addendum-capabilities.md](addendum-capabilities.md) - Graph instance model, subgraph composition, dynamic pass count
- [addendum-capabilities-2.md](addendum-capabilities-2.md) - Resource resize, GPU readback, external resources, queue selection
- [addendum-capabilities-3.md](addendum-capabilities-3.md) - Manual edges, error recovery, introspection, staleness, priority, optional edges
- [addendum-capabilities-4.md](addendum-capabilities-4.md) - Thread safety, determinism, implementation priority, test plan
