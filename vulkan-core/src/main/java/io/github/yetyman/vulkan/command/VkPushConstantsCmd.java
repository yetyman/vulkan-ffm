 ...
 */
public record VkPushConstantsCmd(MemorySegment pipelineLayout, int stageFlags, int offset, MemorySegment data,
                                 long size) {
    ...
    public static class Builder {
        ...
        public Builder pipelineLayout(MemorySegment layout) {
            this.pipelineLayout = layout;
            return this;
        }

        public Builder pipelineLayout(VkPipeline pipeline) {
            this.pipelineLayout = pipeline.layout();
            return this;
        }

        public Builder pipelineLayout(VkComputePipeline pipeline) {
            this.pipelineLayout = pipeline.layout();
            return this;
        }
        ...
        public Builder data(MemorySegment data, long size) {
            this.data = data;
            this.size = size;
            return this;
        }
