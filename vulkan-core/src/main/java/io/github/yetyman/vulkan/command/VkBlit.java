...
public record VkBlit(MemorySegment srcImage, int srcLayout, MemorySegment dstImage, int dstLayout, 
    ...
    public static void blitImage(MemorySegment cmd, MemorySegment srcImage, int srcLayout, MemorySegment dstImage, int dstLayout,
        ...
        try (Arena arena = Arena.ofConfined()) {
            ...
            VkOffset3D.x(srcOffset0, srcX0); VkOffset3D.y(srcOffset0, srcY0); VkOffset3D.z(srcOffset0, 0);
            VkOffset3D.x(srcOffset1, srcX1); VkOffset3D.y(srcOffset1, srcY1); VkOffset3D.z(srcOffset1, 1);
            ...
            VkOffset3D.x(dstOffset0, dstX0); VkOffset3D.y(dstOffset0, dstY0); VkOffset3D.z(dstOffset0, 0);
            VkOffset3D.x(dstOffset1, dstX1); VkOffset3D.y(dstOffset1, dstY1); VkOffset3D.z(dstOffset1, 1);
    ...
    public static class Builder {
        ...
        public Builder srcImage(MemorySegment image) { this.srcImage = image; return this; }
        public Builder srcLayout(int layout) { this.srcLayout = layout; return this; }
        public Builder dstImage(MemorySegment image) { this.dstImage = image; return this; }
        public Builder dstLayout(int layout) { this.dstLayout = layout; return this; }
        public Builder srcRegion(int x0, int y0, int x1, int y1) { 
            this.srcX0 = x0; this.srcY0 = y0; this.srcX1 = x1; this.srcY1 = y1; 
            return this; 
        }
        public Builder dstRegion(int x0, int y0, int x1, int y1) { 
            this.dstX0 = x0; this.dstY0 = y0; this.dstX1 = x1; this.dstY1 = y1; 
            return this; 
        }
        public Builder srcSize(int width, int height) { 
            this.srcX1 = width; this.srcY1 = height; 
            return this; 
        }
        public Builder dstSize(int width, int height) { 
            this.dstX1 = width; this.dstY1 = height; 
            return this; 
        }
        public Builder filter(int filter) { this.filter = filter; return this; }
        public Builder linear() { this.filter = VkFilter.VK_FILTER_LINEAR.value(); return this; }
        public Builder nearest() { this.filter = VkFilter.VK_FILTER_NEAREST.value(); return this; }
