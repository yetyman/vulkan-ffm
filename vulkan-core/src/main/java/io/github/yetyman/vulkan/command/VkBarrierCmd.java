...
public record VkBarrierCmd(int srcStageMask, int dstStageMask, int dependencyFlags,
    ...
    public static class Builder {
        ...
        public Builder srcStage(int srcStageMask) { this.srcStageMask = srcStageMask; return this; }
        public Builder dstStage(int dstStageMask) { this.dstStageMask = dstStageMask; return this; }
        public Builder dependencyFlags(int dependencyFlags) { this.dependencyFlags = dependencyFlags; return this; }
