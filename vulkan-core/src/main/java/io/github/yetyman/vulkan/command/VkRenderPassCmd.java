 ...
 */
public record VkRenderPassCmd(VkDevice device, MemorySegment renderPass, MemorySegment framebuffer, int x, int y,
    ...
    public void execute(MemorySegment cmd) {
        switch (type) {
            case BEGIN ->
                    beginRenderPass(cmd, renderPass, framebuffer, x, y, width, height, clearValues, clearValueCount, contents);
    ...
    public static class Builder {
        ...
        public Builder renderPass(VkRenderPass renderPass) {
        ...
        public Builder framebuffer(VkFramebuffer framebuffer) {
            this.framebuffer = framebuffer.handle();
            return this;
        }

        public Builder framebuffer(MemorySegment framebuffer) {
        ...
        public Builder beginRenderPass() {
            this.type = RenderPassType.BEGIN;
            return this;
        }

        public Builder endRenderPass() {
            this.type = RenderPassType.END;
            return this;
        }

        public Builder nextSubpass() {
            this.type = RenderPassType.NEXT_SUBPASS;
            return this;
        }

        public Builder inline() {
            this.contents = VkSubpassContents.VK_SUBPASS_CONTENTS_INLINE.value();
            return this;
        }

        public Builder secondaryCommandBuffers() {
            this.contents = VkSubpassContents.VK_SUBPASS_CONTENTS_SECONDARY_COMMAND_BUFFERS.value();
            return this;
        }
