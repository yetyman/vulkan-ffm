...
public record VkClear(MemorySegment image, ClearType type, float[] colorValues, float depthValue, int stencilValue, 
    ...
    public static class Builder {
        ...
        public Builder image(MemorySegment image) { this.image = image; return this; }
        public Builder colorImage() { this.type = ClearType.COLOR_IMAGE; return this; }
        public Builder depthStencilImage() { this.type = ClearType.DEPTH_STENCIL_IMAGE; return this; }
        public Builder color(float r, float g, float b, float a) { 
            this.colorValues = new float[]{r, g, b, a}; 
            return this; 
        }
        public Builder depth(float depth) { this.depthValue = depth; return this; }
        public Builder stencil(int stencil) { this.stencilValue = stencil; return this; }
