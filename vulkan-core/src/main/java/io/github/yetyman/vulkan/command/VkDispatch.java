...
public record VkDispatch(int groupCountX, int groupCountY, int groupCountZ) {
    ...
    public static class Builder {
        ...
        public Builder groupCountX(int count) { this.groupCountX = count; return this; }
        public Builder groupCountY(int count) { this.groupCountY = count; return this; }
        public Builder groupCountZ(int count) { this.groupCountZ = count; return this; }
