...
public record VkQuery(MemorySegment queryPool, int query, QueryType type, int flags, int pipelineStage) {
    ...
    public static class Builder {
        ...
        public Builder queryPool(MemorySegment queryPool) {
        ...
        public Builder beginQuery() {
            this.type = QueryType.BEGIN;
            return this;
        }

        public Builder endQuery() {
            this.type = QueryType.END;
            return this;
        }

        public Builder writeTimestamp() {
            this.type = QueryType.WRITE_TIMESTAMP;
            return this;
        }
        ...
        public Builder pipelineStage(int stage) {
            this.pipelineStage = stage;
            return this;
        }

        public Builder topOfPipe() {
            this.pipelineStage = VkPipelineStageFlagBits.VK_PIPELINE_STAGE_TOP_OF_PIPE_BIT.value();
            return this;
        }

        public Builder bottomOfPipe() {
            this.pipelineStage = VkPipelineStageFlagBits.VK_PIPELINE_STAGE_BOTTOM_OF_PIPE_BIT.value();
            return this;
        }
