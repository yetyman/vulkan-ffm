...
private VkDevice(MemorySegment handle, VkPhysicalDevice physicalDevice) {
    ...
    public VkResult getSemaphoreCounterValue(MemorySegment semaphore, MemorySegment valuePtr) {
        if (vkGetSemaphoreCounterValue == null)
            throw new UnsupportedOperationException("vkGetSemaphoreCounterValue not available — enable timeline semaphore feature on device creation");
        try {
            return VkResult.fromInt((int) vkGetSemaphoreCounterValue.invokeExact(handle, semaphore, valuePtr));
        } catch (Throwable t) {
    ...
    public VkResult waitSemaphores(MemorySegment waitInfo, long timeout) {
        ...
        try {
            return VkResult.fromInt((int) vkWaitSemaphores.invokeExact(handle, waitInfo, timeout));
        } catch (Throwable t) {
            throw new RuntimeException(t);
        }
    }
    ...
    public VkResult signalSemaphore(MemorySegment signalInfo) {
        if (vkSignalSemaphore == null)
            throw new UnsupportedOperationException("vkSignalSemaphore not available — enable timeline semaphore feature on device creation");
        try {
            return VkResult.fromInt((int) vkSignalSemaphore.invokeExact(handle, signalInfo));
        } catch (Throwable t) {
            throw new RuntimeException(t);
        }
    }
