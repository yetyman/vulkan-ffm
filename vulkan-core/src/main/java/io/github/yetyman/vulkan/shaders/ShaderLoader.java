...
public class ShaderLoader {
     ...
     */
    public static Builder vertex() {
        return new Builder(ShadercShaderKind.shaderc_vertex_shader);
    }
    ...
    public static Builder fragment() {
        return new Builder(ShadercShaderKind.shaderc_fragment_shader);
    }

    /**
     * @return a Builder for an inline compute shader.
     */
    public static Builder compute() {
        return new Builder(ShadercShaderKind.shaderc_compute_shader);
    }

    /**
     * @return a Builder for an inline geometry shader.
     */
    public static Builder geometry() {
        return new Builder(ShadercShaderKind.shaderc_geometry_shader);
    }

    /**
     * @return a Builder for an inline tessellation control shader.
     */
    public static Builder tessControl() {
        return new Builder(ShadercShaderKind.shaderc_tess_control_shader);
    }

    /**
     * @return a Builder for an inline tessellation evaluation shader.
     */
    public static Builder tessEval() {
        return new Builder(ShadercShaderKind.shaderc_tess_evaluation_shader);
    }
    ...
    public static class Builder {
         ...
         */
        public String name() {
            return name != null ? name : (resourcePath.equals("<inline>") ? null : resourcePath);
        }
    ...
    public static class ShaderReflection {
         ...
         */
        public DescriptorBindingInfo getBindingByName(String name) {
            return bindingsByName.get(name);
        }

        public List<PushConstantBlockInfo> getPushConstantBlocks() {
            return pushConstantBlocks;
        }

        public List<SpecializationConstantInfo> getSpecializationConstants() {
         ...
         */
        public SpecializationConstantInfo getSpecializationConstant(String name) {
            return specializationConstantsByName.get(name);
        }
    ...
    public static class DescriptorBindingInfo {
        ...
        public SpirvReflectDescriptorType getDescriptorType() {
    ...
    public static class PushConstantBlockInfo {
        ...
        public List<StructMemberInfo> members() {
            return members;
        }

        public StructMemberInfo getMember(String name) {
    ...
    public record StructMemberInfo(String name, int offset, int size, int typeFlags, List<StructMemberInfo> members,
                                   String typeName,
                                   int scalarWidth, int scalarSignedness, int vectorComponents, int matrixColumns,
                                   int matrixRows) {
        /**
        ...
        public boolean isFloat() {
            return (typeFlags & 0x00000008) != 0;
        }

        public boolean isInt() {
            return (typeFlags & 0x00000004) != 0;
        }

        public boolean isBool() {
            return (typeFlags & 0x00000002) != 0;
        }

        public boolean isVector() {
            return (typeFlags & 0x00000100) != 0;
        }

        public boolean isMatrix() {
            return (typeFlags & 0x00000200) != 0;
        }

        public boolean isStruct() {
            return (typeFlags & 0x00000800) != 0;
        }

        public boolean isArray() {
            return (typeFlags & 0x00010000) != 0;
        }
    }
    ...
    public record SpecializationConstantInfo(String name, int constantId, int typeFlags, int defaultValueBits) {
        ...
        public float defaultFloat() {
            return Float.intBitsToFloat(defaultValueBits);
        }
