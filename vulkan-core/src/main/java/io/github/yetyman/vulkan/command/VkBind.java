...
public record VkBind(MemorySegment handle, BindType type, int bindPoint, int firstSet, MemorySegment layout) {
    ...
    public static class Builder {
        ...
        public Builder bindPoint(int bindPoint) { this.bindPoint = bindPoint; return this; }
        public Builder firstSet(int firstSet) { this.firstSet = firstSet; return this; }
        public Builder layout(MemorySegment layout) { this.layout = layout; return this; }
