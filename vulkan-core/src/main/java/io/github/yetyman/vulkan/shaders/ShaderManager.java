...
public class ShaderManager implements AutoCloseable {
    ...
    public static class ShaderSet {
        ...
        public CompiledShader vertex() {
            return shaders.get("vertex");
        }

        public CompiledShader fragment() {
            return shaders.get("fragment");
        }

        public CompiledShader geometry() {
            return shaders.get("geometry");
        }

        public CompiledShader compute() {
            return shaders.get("compute");
        }

        public CompiledShader tessControl() {
            return shaders.get("tessControl");
        }

        public CompiledShader tessEvaluation() {
            return shaders.get("tessEvaluation");
        }

        public CompiledShader get(String stage) {
