...
public class VkFramebufferAttachment {
     ...
     */
    public MemorySegment imageViewHandle() {
    ...
    public boolean isColor() {
        return type == AttachmentType.COLOR;
    }
    ...
    public boolean isDepth() {
        return type == AttachmentType.DEPTH;
    }
    ...
    public boolean isStencil() {
        return type == AttachmentType.STENCIL;
    }
    ...
    public boolean isDepthStencil() {
        return type == AttachmentType.DEPTH_STENCIL;
    }
