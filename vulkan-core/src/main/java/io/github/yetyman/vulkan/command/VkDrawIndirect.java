...
public record VkDrawIndirect(MemorySegment buffer, long offset, int drawCount, int stride) {
    ...
    public static class Builder {
        ...
        public Builder buffer(MemorySegment buffer) { this.buffer = buffer; return this; }
        public Builder buffer(VkBuffer buffer) { this.buffer = buffer.handle(); return this; }
        public Builder offset(long offset) { this.offset = offset; return this; }
        public Builder drawCount(int count) { this.drawCount = count; return this; }
