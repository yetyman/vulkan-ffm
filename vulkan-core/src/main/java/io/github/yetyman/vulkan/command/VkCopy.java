...
public record VkCopy(MemorySegment src, MemorySegment dst, long srcOffset, long dstOffset, long size, CopyType type) {
    ...
    public static void copyImage(MemorySegment cmd, MemorySegment srcImage, int srcLayout, MemorySegment dstImage, int dstLayout, int width, int height, int depth) {
        try (Arena arena = Arena.ofConfined()) {
            ...
            VkOffset3D.x(srcOffset, 0);
            VkOffset3D.y(srcOffset, 0);
            VkOffset3D.z(srcOffset, 0);
            ...
            VkOffset3D.x(dstOffset, 0);
            VkOffset3D.y(dstOffset, 0);
            VkOffset3D.z(dstOffset, 0);
    ...
    public static class Builder {
        ...
        public Builder src(MemorySegment src) {
            this.src = src;
            return this;
        }

        public Builder src(VkBuffer src) {
            this.src = src.handle();
            return this;
        }

        public Builder dst(MemorySegment dst) {
            this.dst = dst;
            return this;
        }

        public Builder dst(VkBuffer dst) {
            this.dst = dst.handle();
            return this;
        }
        ...
        public Builder dstOffset(long offset) {
        ...
        public Builder type(CopyType type) {
            this.type = type;
            return this;
        }
