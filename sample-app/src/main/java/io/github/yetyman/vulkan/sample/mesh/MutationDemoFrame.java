...
/**
 * GraphicsFrame driving a UIComposite for the mesh mutation demo.
 */
public class MutationDemoFrame extends GraphicsFrame {

    private final UIComposite composite;
    private long frameNumber = 0;

    public MutationDemoFrame(Arena arena, VkDevice device, VkQueue queue,
