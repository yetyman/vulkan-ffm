...
public class AdaptiveAA {
    ...
    public VkRenderPass getSceneRenderPass() {
        return sceneRenderPass;
    }

    public VkFramebuffer getSceneFramebuffer() {
    ...
    public int getSampleCount() {
        return mode == Mode.MSAA ? samples : 1;
    }
    ...
    public int getClearColorCount() {
        return mode == Mode.MSAA ? 2 : 1;
    }
