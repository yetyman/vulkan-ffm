...
/**
 * Minimal GraphicsFrame driving a UIComposite (Scene3DOverlayLayer) through the direct-render
 * path. Clears the swapchain image then lets the composite's layers record their own draws.
 * Mirrors TextExampleFrame's structure.
 */
public class Scene3DOverlayExampleFrame extends GraphicsFrame {

    private final UIComposite composite;
    private long frameNumber = 0;

    public Scene3DOverlayExampleFrame(java.lang.foreign.Arena arena, VkDevice device, VkQueue queue,
