...
public record VkPipelineRobustnessBufferBehavior(int value) {
    ...
    public static final VkPipelineRobustnessBufferBehavior VK_PIPELINE_ROBUSTNESS_BUFFER_BEHAVIOR_DEVICE_DEFAULT_EXT = new VkPipelineRobustnessBufferBehavior(0);
    ...
    public static final VkPipelineRobustnessBufferBehavior VK_PIPELINE_ROBUSTNESS_BUFFER_BEHAVIOR_DISABLED_EXT = new VkPipelineRobustnessBufferBehavior(1);
    ...
    public static final VkPipelineRobustnessBufferBehavior VK_PIPELINE_ROBUSTNESS_BUFFER_BEHAVIOR_ROBUST_BUFFER_ACCESS_2_EXT = new VkPipelineRobustnessBufferBehavior(3);
    public static final VkPipelineRobustnessBufferBehavior VK_PIPELINE_ROBUSTNESS_BUFFER_BEHAVIOR_ROBUST_BUFFER_ACCESS_EXT = new VkPipelineRobustnessBufferBehavior(2);
