...
public class VkPerformanceCounterKHR {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        ...
        VulkanWin32FFM.C_INT.withName("unit"),
        VulkanWin32FFM.C_INT.withName("scope"),
        VulkanWin32FFM.C_INT.withName("storage"),
        MemoryLayout.sequenceLayout(16, VulkanWin32FFM.C_CHAR).withName("uuid"),
        MemoryLayout.paddingLayout(4)
    ...
    public static byte uuid(MemorySegment struct, long index0) {
        return (byte)uuid$ELEM_HANDLE.get(struct, uuid$OFFSET, index0);
    }
