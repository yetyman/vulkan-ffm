...
public record VkSubgroupFeatureFlagBits(int value) {
    ...
    public static final VkSubgroupFeatureFlagBits VK_SUBGROUP_FEATURE_ROTATE_BIT_KHR = VK_SUBGROUP_FEATURE_ROTATE_BIT;
    ...
    public static final VkSubgroupFeatureFlagBits VK_SUBGROUP_FEATURE_ROTATE_CLUSTERED_BIT_KHR = VK_SUBGROUP_FEATURE_ROTATE_CLUSTERED_BIT;
