...
/**
 * {@snippet lang=c :
 * typedef VkResult (*PFN_vkEnumerateInstanceExtensionProperties)(const char *, uint32_t *, VkExtensionProperties *) __attribute__((stdcall))
 * }
 */
public final class PFN_vkEnumerateInstanceExtensionProperties {

    private PFN_vkEnumerateInstanceExtensionProperties() {
    ...
    private static final MethodHandle UP$MH = VulkanWin32FFM.upcallHandle(PFN_vkEnumerateInstanceExtensionProperties.Function.class, "apply", $DESC);
