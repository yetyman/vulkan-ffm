...
public record VkImageAspectFlagBits(int value) {
    ...
    public static final VkImageAspectFlagBits VK_IMAGE_ASPECT_NONE_KHR = VK_IMAGE_ASPECT_NONE;
    public static final VkImageAspectFlagBits VK_IMAGE_ASPECT_PLANE_0_BIT = new VkImageAspectFlagBits(16);
    public static final VkImageAspectFlagBits VK_IMAGE_ASPECT_PLANE_0_BIT_KHR = VK_IMAGE_ASPECT_PLANE_0_BIT;
    public static final VkImageAspectFlagBits VK_IMAGE_ASPECT_PLANE_1_BIT = new VkImageAspectFlagBits(32);
    public static final VkImageAspectFlagBits VK_IMAGE_ASPECT_PLANE_1_BIT_KHR = VK_IMAGE_ASPECT_PLANE_1_BIT;
    public static final VkImageAspectFlagBits VK_IMAGE_ASPECT_PLANE_2_BIT = new VkImageAspectFlagBits(64);
    public static final VkImageAspectFlagBits VK_IMAGE_ASPECT_PLANE_2_BIT_KHR = VK_IMAGE_ASPECT_PLANE_2_BIT;
