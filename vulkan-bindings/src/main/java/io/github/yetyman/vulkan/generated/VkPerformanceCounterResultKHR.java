...
public class VkPerformanceCounterResultKHR {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.unionLayout(
        VulkanFFM.C_INT.withName("int32"),
        VulkanFFM.C_LONG_LONG.withName("int64"),
        VulkanFFM.C_INT.withName("uint32"),
        VulkanFFM.C_LONG_LONG.withName("uint64"),
        VulkanFFM.C_FLOAT.withName("float32"),
        VulkanFFM.C_DOUBLE.withName("float64")
