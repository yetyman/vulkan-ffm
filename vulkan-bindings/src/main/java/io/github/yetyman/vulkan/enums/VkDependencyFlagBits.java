...
public record VkDependencyFlagBits(int value) {
    ...
    public static final VkDependencyFlagBits VK_DEPENDENCY_DEVICE_GROUP_BIT_KHR = VK_DEPENDENCY_DEVICE_GROUP_BIT;
    ...
    public static final VkDependencyFlagBits VK_DEPENDENCY_VIEW_LOCAL_BIT_KHR = VK_DEPENDENCY_VIEW_LOCAL_BIT;
