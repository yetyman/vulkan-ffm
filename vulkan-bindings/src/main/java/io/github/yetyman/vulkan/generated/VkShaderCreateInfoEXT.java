...
public class VkShaderCreateInfoEXT {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        ...
        VulkanFFM.C_INT.withName("nextStage"),
        VulkanFFM.C_INT.withName("codeType"),
        VulkanFFM.C_LONG_LONG.withName("codeSize"),
        VulkanFFM.C_POINTER.withName("pCode"),
        VulkanFFM.C_POINTER.withName("pName"),
        VulkanFFM.C_INT.withName("setLayoutCount"),
        MemoryLayout.paddingLayout(4),
        VulkanFFM.C_POINTER.withName("pSetLayouts"),
