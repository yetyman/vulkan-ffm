...
public class StdVideoEncodeH264ReferenceListsInfo {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        ...
        VulkanWin32FFM.C_CHAR.withName("num_ref_idx_l0_active_minus1"),
        VulkanWin32FFM.C_CHAR.withName("num_ref_idx_l1_active_minus1"),
        MemoryLayout.sequenceLayout(32, VulkanWin32FFM.C_CHAR).withName("RefPicList0"),
        MemoryLayout.sequenceLayout(32, VulkanWin32FFM.C_CHAR).withName("RefPicList1"),
        VulkanWin32FFM.C_CHAR.withName("refList0ModOpCount"),
        VulkanWin32FFM.C_CHAR.withName("refList1ModOpCount"),
        VulkanWin32FFM.C_CHAR.withName("refPicMarkingOpCount"),
        MemoryLayout.sequenceLayout(7, VulkanWin32FFM.C_CHAR).withName("reserved1"),
        VulkanWin32FFM.C_POINTER.withName("pRefList0ModOperations"),
        VulkanWin32FFM.C_POINTER.withName("pRefList1ModOperations"),
        VulkanWin32FFM.C_POINTER.withName("pRefPicMarkingOperations")
    ...
    private static final long num_ref_idx_l0_active_minus1$OFFSET = $LAYOUT.byteOffset(groupElement("num_ref_idx_l0_active_minus1"));
    ...
    private static final long num_ref_idx_l1_active_minus1$OFFSET = $LAYOUT.byteOffset(groupElement("num_ref_idx_l1_active_minus1"));
    ...
    private static final long RefPicList0$OFFSET = $LAYOUT.byteOffset(groupElement("RefPicList0"));
    ...
    public static byte RefPicList0(MemorySegment struct, long index0) {
        return (byte)RefPicList0$ELEM_HANDLE.get(struct, RefPicList0$OFFSET, index0);
    }
    ...
    public static void RefPicList0(MemorySegment struct, long index0, byte fieldValue) {
        RefPicList0$ELEM_HANDLE.set(struct, RefPicList0$OFFSET, index0, fieldValue);
    }
    ...
    private static final long RefPicList1$OFFSET = $LAYOUT.byteOffset(groupElement("RefPicList1"));
    ...
    public static byte RefPicList1(MemorySegment struct, long index0) {
        return (byte)RefPicList1$ELEM_HANDLE.get(struct, RefPicList1$OFFSET, index0);
    }
    ...
    public static void RefPicList1(MemorySegment struct, long index0, byte fieldValue) {
        RefPicList1$ELEM_HANDLE.set(struct, RefPicList1$OFFSET, index0, fieldValue);
    }
    ...
    private static final long refList0ModOpCount$OFFSET = $LAYOUT.byteOffset(groupElement("refList0ModOpCount"));
    ...
    private static final long refList1ModOpCount$OFFSET = $LAYOUT.byteOffset(groupElement("refList1ModOpCount"));
    ...
    private static final long refPicMarkingOpCount$OFFSET = $LAYOUT.byteOffset(groupElement("refPicMarkingOpCount"));
    ...
    private static final long pRefList0ModOperations$OFFSET = $LAYOUT.byteOffset(groupElement("pRefList0ModOperations"));
    ...
    private static final long pRefList1ModOperations$OFFSET = $LAYOUT.byteOffset(groupElement("pRefList1ModOperations"));
    ...
    private static final long pRefPicMarkingOperations$OFFSET = $LAYOUT.byteOffset(groupElement("pRefPicMarkingOperations"));
