...
public class VkShaderResourceUsageAMD {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        VulkanFFM.C_INT.withName("numUsedVgprs"),
        VulkanFFM.C_INT.withName("numUsedSgprs"),
        VulkanFFM.C_INT.withName("ldsSizePerLocalWorkGroup"),
        MemoryLayout.paddingLayout(4),
        VulkanFFM.C_LONG_LONG.withName("ldsUsageSizeInBytes"),
        VulkanFFM.C_LONG_LONG.withName("scratchMemUsageInBytes")
