...
public class _ACL {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        VulkanWin32FFM.C_CHAR.withName("AclRevision"),
        VulkanWin32FFM.C_CHAR.withName("Sbz1"),
        VulkanWin32FFM.C_SHORT.withName("AclSize"),
        VulkanWin32FFM.C_SHORT.withName("AceCount"),
        VulkanWin32FFM.C_SHORT.withName("Sbz2")
    ).withName("_ACL");
