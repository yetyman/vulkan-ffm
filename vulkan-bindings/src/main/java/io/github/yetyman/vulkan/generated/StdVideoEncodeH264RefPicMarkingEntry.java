...
public class StdVideoEncodeH264RefPicMarkingEntry {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        VulkanFFM.C_INT.withName("memory_management_control_operation"),
        VulkanFFM.C_SHORT.withName("difference_of_pic_nums_minus1"),
        VulkanFFM.C_SHORT.withName("long_term_pic_num"),
        VulkanFFM.C_SHORT.withName("long_term_frame_idx"),
        VulkanFFM.C_SHORT.withName("max_long_term_frame_idx_plus1")
