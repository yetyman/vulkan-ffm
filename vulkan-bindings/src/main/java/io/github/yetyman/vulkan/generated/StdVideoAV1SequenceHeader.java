...
public class StdVideoAV1SequenceHeader {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        ...
        VulkanFFM.C_INT.withName("seq_profile"),
        VulkanFFM.C_CHAR.withName("frame_width_bits_minus_1"),
        VulkanFFM.C_CHAR.withName("frame_height_bits_minus_1"),
        VulkanFFM.C_SHORT.withName("max_frame_width_minus_1"),
        VulkanFFM.C_SHORT.withName("max_frame_height_minus_1"),
        VulkanFFM.C_CHAR.withName("delta_frame_id_length_minus_2"),
        VulkanFFM.C_CHAR.withName("additional_frame_id_length_minus_1"),
        VulkanFFM.C_CHAR.withName("order_hint_bits_minus_1"),
        VulkanFFM.C_CHAR.withName("seq_force_integer_mv"),
        VulkanFFM.C_CHAR.withName("seq_force_screen_content_tools"),
        MemoryLayout.sequenceLayout(5, VulkanFFM.C_CHAR).withName("reserved1"),
        VulkanFFM.C_POINTER.withName("pColorConfig"),
        VulkanFFM.C_POINTER.withName("pTimingInfo")
