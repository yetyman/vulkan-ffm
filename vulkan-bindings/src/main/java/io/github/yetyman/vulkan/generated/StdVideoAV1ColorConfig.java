...
public class StdVideoAV1ColorConfig {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        ...
        VulkanFFM.C_CHAR.withName("BitDepth"),
        VulkanFFM.C_CHAR.withName("subsampling_x"),
        VulkanFFM.C_CHAR.withName("subsampling_y"),
        VulkanFFM.C_CHAR.withName("reserved1"),
        VulkanFFM.C_INT.withName("color_primaries"),
        VulkanFFM.C_INT.withName("transfer_characteristics"),
        VulkanFFM.C_INT.withName("matrix_coefficients"),
        VulkanFFM.C_INT.withName("chroma_sample_position")
