...
public class _IMAGE_TLS_DIRECTORY64 {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        VulkanWin32FFM.align(VulkanWin32FFM.C_LONG_LONG, 4).withName("StartAddressOfRawData"),
        VulkanWin32FFM.align(VulkanWin32FFM.C_LONG_LONG, 4).withName("EndAddressOfRawData"),
        VulkanWin32FFM.align(VulkanWin32FFM.C_LONG_LONG, 4).withName("AddressOfIndex"),
        VulkanWin32FFM.align(VulkanWin32FFM.C_LONG_LONG, 4).withName("AddressOfCallBacks"),
        VulkanWin32FFM.C_LONG.withName("SizeOfZeroFill"),
        MemoryLayout.unionLayout(
            VulkanWin32FFM.C_LONG.withName("Characteristics"),
            MemoryLayout.structLayout(
                MemoryLayout.paddingLayout(4)
            ).withName("$anon$19589:9")
        ).withName("$anon$19587:5")
    ...
    private static final OfInt Characteristics$LAYOUT = (OfInt)$LAYOUT.select(groupElement("$anon$19587:5"), groupElement("Characteristics"));
    ...
    private static final long Characteristics$OFFSET = $LAYOUT.byteOffset(groupElement("$anon$19587:5"), groupElement("Characteristics"));
