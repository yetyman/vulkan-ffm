...
public class VkShaderStatisticsInfoAMD {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        VulkanFFM.C_INT.withName("shaderStageMask"),
        MemoryLayout.paddingLayout(4),
        VkShaderResourceUsageAMD.layout().withName("resourceUsage"),
        VulkanFFM.C_INT.withName("numPhysicalVgprs"),
        VulkanFFM.C_INT.withName("numPhysicalSgprs"),
        VulkanFFM.C_INT.withName("numAvailableVgprs"),
        VulkanFFM.C_INT.withName("numAvailableSgprs"),
        MemoryLayout.sequenceLayout(3, VulkanFFM.C_INT).withName("computeWorkGroupSize"),
        MemoryLayout.paddingLayout(4)
