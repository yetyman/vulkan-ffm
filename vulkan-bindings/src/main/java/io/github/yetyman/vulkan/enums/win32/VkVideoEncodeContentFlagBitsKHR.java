...
/**
 * Constants for VkVideoEncodeContentFlagBitsKHR
 * Generated from jextract bindings
 */
public final class VkVideoEncodeContentFlagBitsKHR {
    private VkVideoEncodeContentFlagBitsKHR() {}
    ...
    public static final int VK_VIDEO_ENCODE_CONTENT_FLAG_BITS_MAX_ENUM_KHR = 2147483647;
