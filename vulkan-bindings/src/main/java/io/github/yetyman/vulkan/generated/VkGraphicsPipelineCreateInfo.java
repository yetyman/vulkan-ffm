...
public class VkGraphicsPipelineCreateInfo {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        ...
        VulkanFFM.C_INT.withName("stageCount"),
        VulkanFFM.C_POINTER.withName("pStages"),
        VulkanFFM.C_POINTER.withName("pVertexInputState"),
        VulkanFFM.C_POINTER.withName("pInputAssemblyState"),
        VulkanFFM.C_POINTER.withName("pTessellationState"),
        VulkanFFM.C_POINTER.withName("pViewportState"),
        VulkanFFM.C_POINTER.withName("pRasterizationState"),
        VulkanFFM.C_POINTER.withName("pMultisampleState"),
        VulkanFFM.C_POINTER.withName("pDepthStencilState"),
        VulkanFFM.C_POINTER.withName("pColorBlendState"),
        VulkanFFM.C_POINTER.withName("pDynamicState"),
        VulkanFFM.C_POINTER.withName("layout"),
        VulkanFFM.C_POINTER.withName("renderPass"),
        VulkanFFM.C_INT.withName("subpass"),
        MemoryLayout.paddingLayout(4),
        VulkanFFM.C_POINTER.withName("basePipelineHandle"),
        VulkanFFM.C_INT.withName("basePipelineIndex"),
        MemoryLayout.paddingLayout(4)
