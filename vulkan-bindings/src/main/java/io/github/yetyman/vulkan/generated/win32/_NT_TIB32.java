...
public class _NT_TIB32 {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        VulkanWin32FFM.C_LONG.withName("ExceptionList"),
        VulkanWin32FFM.C_LONG.withName("StackBase"),
        VulkanWin32FFM.C_LONG.withName("StackLimit"),
        VulkanWin32FFM.C_LONG.withName("SubSystemTib"),
        MemoryLayout.unionLayout(
            VulkanWin32FFM.C_LONG.withName("FiberData"),
            VulkanWin32FFM.C_LONG.withName("Version")
        ).withName("$anon$12310:5"),
        VulkanWin32FFM.C_LONG.withName("ArbitraryUserPointer"),
        VulkanWin32FFM.C_LONG.withName("Self")
    ).withName("_NT_TIB32");
    ...
    private static final OfInt FiberData$LAYOUT = (OfInt)$LAYOUT.select(groupElement("$anon$12310:5"), groupElement("FiberData"));
    ...
    private static final long FiberData$OFFSET = $LAYOUT.byteOffset(groupElement("$anon$12310:5"), groupElement("FiberData"));
    ...
    private static final OfInt Version$LAYOUT = (OfInt)$LAYOUT.select(groupElement("$anon$12310:5"), groupElement("Version"));
    ...
    private static final long Version$OFFSET = $LAYOUT.byteOffset(groupElement("$anon$12310:5"), groupElement("Version"));
