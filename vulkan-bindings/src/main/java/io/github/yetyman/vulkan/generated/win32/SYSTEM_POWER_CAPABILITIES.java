...
public class SYSTEM_POWER_CAPABILITIES {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        VulkanWin32FFM.C_CHAR.withName("PowerButtonPresent"),
        VulkanWin32FFM.C_CHAR.withName("SleepButtonPresent"),
        VulkanWin32FFM.C_CHAR.withName("LidPresent"),
        VulkanWin32FFM.C_CHAR.withName("SystemS1"),
        VulkanWin32FFM.C_CHAR.withName("SystemS2"),
        VulkanWin32FFM.C_CHAR.withName("SystemS3"),
        VulkanWin32FFM.C_CHAR.withName("SystemS4"),
        VulkanWin32FFM.C_CHAR.withName("SystemS5"),
        VulkanWin32FFM.C_CHAR.withName("HiberFilePresent"),
        VulkanWin32FFM.C_CHAR.withName("FullWake"),
        VulkanWin32FFM.C_CHAR.withName("VideoDimPresent"),
        VulkanWin32FFM.C_CHAR.withName("ApmPresent"),
        VulkanWin32FFM.C_CHAR.withName("UpsPresent"),
        VulkanWin32FFM.C_CHAR.withName("ThermalControl"),
        VulkanWin32FFM.C_CHAR.withName("ProcessorThrottle"),
        VulkanWin32FFM.C_CHAR.withName("ProcessorMinThrottle"),
        VulkanWin32FFM.C_CHAR.withName("ProcessorMaxThrottle"),
        VulkanWin32FFM.C_CHAR.withName("FastSystemS4"),
        VulkanWin32FFM.C_CHAR.withName("Hiberboot"),
        VulkanWin32FFM.C_CHAR.withName("WakeAlarmPresent"),
        VulkanWin32FFM.C_CHAR.withName("AoAc"),
        VulkanWin32FFM.C_CHAR.withName("DiskSpinDown"),
        VulkanWin32FFM.C_CHAR.withName("HiberFileType"),
        VulkanWin32FFM.C_CHAR.withName("AoAcConnectivitySupported"),
        MemoryLayout.sequenceLayout(6, VulkanWin32FFM.C_CHAR).withName("spare3"),
        VulkanWin32FFM.C_CHAR.withName("SystemBatteriesPresent"),
        VulkanWin32FFM.C_CHAR.withName("BatteriesAreShortTerm"),
        MemoryLayout.sequenceLayout(3, BATTERY_REPORTING_SCALE.layout()).withName("BatteryScale"),
        VulkanWin32FFM.C_INT.withName("AcOnLineWake"),
        VulkanWin32FFM.C_INT.withName("SoftLidWake"),
        VulkanWin32FFM.C_INT.withName("RtcWake"),
        VulkanWin32FFM.C_INT.withName("MinDeviceWakeState"),
        VulkanWin32FFM.C_INT.withName("DefaultLowLatencyWake")
    ).withName("$anon$18109:9");
