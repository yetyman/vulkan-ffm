...
public class StdVideoAV1LoopRestoration {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        MemoryLayout.sequenceLayout(3, VulkanFFM.C_INT).withName("FrameRestorationType"),
        MemoryLayout.sequenceLayout(3, VulkanFFM.C_SHORT).withName("LoopRestorationSize"),
