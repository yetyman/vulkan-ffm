...
public class VkSurfaceFullScreenExclusiveWin32InfoEXT {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        ...
        VulkanWin32FFM.C_POINTER.withName("hmonitor")
    ).withName("VkSurfaceFullScreenExclusiveWin32InfoEXT");
    ...
    private static final AddressLayout hmonitor$LAYOUT = (AddressLayout)$LAYOUT.select(groupElement("hmonitor"));
    ...
    private static final long hmonitor$OFFSET = $LAYOUT.byteOffset(groupElement("hmonitor"));
