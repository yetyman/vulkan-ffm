...
public class StdVideoH264HrdParameters {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        VulkanWin32FFM.C_CHAR.withName("cpb_cnt_minus1"),
        ...
        MemoryLayout.sequenceLayout(32, VulkanWin32FFM.C_INT).withName("bit_rate_value_minus1"),
        MemoryLayout.sequenceLayout(32, VulkanWin32FFM.C_INT).withName("cpb_size_value_minus1"),
        MemoryLayout.sequenceLayout(32, VulkanWin32FFM.C_CHAR).withName("cbr_flag"),
        VulkanWin32FFM.C_INT.withName("initial_cpb_removal_delay_length_minus1"),
        VulkanWin32FFM.C_INT.withName("cpb_removal_delay_length_minus1"),
        VulkanWin32FFM.C_INT.withName("dpb_output_delay_length_minus1"),
        VulkanWin32FFM.C_INT.withName("time_offset_length")
    ...
    private static final long bit_rate_value_minus1$OFFSET = $LAYOUT.byteOffset(groupElement("bit_rate_value_minus1"));
    ...
    public static int bit_rate_value_minus1(MemorySegment struct, long index0) {
        return (int)bit_rate_value_minus1$ELEM_HANDLE.get(struct, bit_rate_value_minus1$OFFSET, index0);
    }
    ...
    public static void bit_rate_value_minus1(MemorySegment struct, long index0, int fieldValue) {
        bit_rate_value_minus1$ELEM_HANDLE.set(struct, bit_rate_value_minus1$OFFSET, index0, fieldValue);
    }
    ...
    private static final long cpb_size_value_minus1$OFFSET = $LAYOUT.byteOffset(groupElement("cpb_size_value_minus1"));
    ...
    public static int cpb_size_value_minus1(MemorySegment struct, long index0) {
        return (int)cpb_size_value_minus1$ELEM_HANDLE.get(struct, cpb_size_value_minus1$OFFSET, index0);
    }
    ...
    public static void cpb_size_value_minus1(MemorySegment struct, long index0, int fieldValue) {
        cpb_size_value_minus1$ELEM_HANDLE.set(struct, cpb_size_value_minus1$OFFSET, index0, fieldValue);
    }
    ...
    private static final long cbr_flag$OFFSET = $LAYOUT.byteOffset(groupElement("cbr_flag"));
    ...
    public static byte cbr_flag(MemorySegment struct, long index0) {
        return (byte)cbr_flag$ELEM_HANDLE.get(struct, cbr_flag$OFFSET, index0);
    }
    ...
    public static void cbr_flag(MemorySegment struct, long index0, byte fieldValue) {
        cbr_flag$ELEM_HANDLE.set(struct, cbr_flag$OFFSET, index0, fieldValue);
    }
    ...
    private static final long cpb_removal_delay_length_minus1$OFFSET = $LAYOUT.byteOffset(groupElement("cpb_removal_delay_length_minus1"));
    ...
    private static final long time_offset_length$OFFSET = $LAYOUT.byteOffset(groupElement("time_offset_length"));
