...
public class StdVideoH265DecPicBufMgr {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        MemoryLayout.sequenceLayout(7, VulkanWin32FFM.C_INT).withName("max_latency_increase_plus1"),
        MemoryLayout.sequenceLayout(7, VulkanWin32FFM.C_CHAR).withName("max_dec_pic_buffering_minus1"),
        MemoryLayout.sequenceLayout(7, VulkanWin32FFM.C_CHAR).withName("max_num_reorder_pics"),
    ...
    private static final long max_latency_increase_plus1$OFFSET = $LAYOUT.byteOffset(groupElement("max_latency_increase_plus1"));
    ...
    public static int max_latency_increase_plus1(MemorySegment struct, long index0) {
        return (int)max_latency_increase_plus1$ELEM_HANDLE.get(struct, max_latency_increase_plus1$OFFSET, index0);
    }
    ...
    public static void max_latency_increase_plus1(MemorySegment struct, long index0, int fieldValue) {
        max_latency_increase_plus1$ELEM_HANDLE.set(struct, max_latency_increase_plus1$OFFSET, index0, fieldValue);
    }
    ...
    private static final long max_dec_pic_buffering_minus1$OFFSET = $LAYOUT.byteOffset(groupElement("max_dec_pic_buffering_minus1"));
    ...
    public static byte max_dec_pic_buffering_minus1(MemorySegment struct, long index0) {
        return (byte)max_dec_pic_buffering_minus1$ELEM_HANDLE.get(struct, max_dec_pic_buffering_minus1$OFFSET, index0);
    }
    ...
    public static void max_dec_pic_buffering_minus1(MemorySegment struct, long index0, byte fieldValue) {
        max_dec_pic_buffering_minus1$ELEM_HANDLE.set(struct, max_dec_pic_buffering_minus1$OFFSET, index0, fieldValue);
    }
    ...
    private static final long max_num_reorder_pics$OFFSET = $LAYOUT.byteOffset(groupElement("max_num_reorder_pics"));
    ...
    public static byte max_num_reorder_pics(MemorySegment struct, long index0) {
        return (byte)max_num_reorder_pics$ELEM_HANDLE.get(struct, max_num_reorder_pics$OFFSET, index0);
    }
    ...
    public static void max_num_reorder_pics(MemorySegment struct, long index0, byte fieldValue) {
        max_num_reorder_pics$ELEM_HANDLE.set(struct, max_num_reorder_pics$OFFSET, index0, fieldValue);
    }
