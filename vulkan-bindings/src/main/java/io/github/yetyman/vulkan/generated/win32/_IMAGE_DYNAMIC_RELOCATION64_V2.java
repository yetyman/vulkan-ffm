...
public class _IMAGE_DYNAMIC_RELOCATION64_V2 {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        VulkanWin32FFM.align(VulkanWin32FFM.C_LONG, 1).withName("HeaderSize"),
        VulkanWin32FFM.align(VulkanWin32FFM.C_LONG, 1).withName("FixupInfoSize"),
        VulkanWin32FFM.align(VulkanWin32FFM.C_LONG_LONG, 1).withName("Symbol"),
        VulkanWin32FFM.align(VulkanWin32FFM.C_LONG, 1).withName("SymbolGroup"),
        VulkanWin32FFM.align(VulkanWin32FFM.C_LONG, 1).withName("Flags")
