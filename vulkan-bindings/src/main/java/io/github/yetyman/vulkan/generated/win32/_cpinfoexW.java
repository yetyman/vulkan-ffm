...
public class _cpinfoexW {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        VulkanWin32FFM.C_INT.withName("MaxCharSize"),
        MemoryLayout.sequenceLayout(2, VulkanWin32FFM.C_CHAR).withName("DefaultChar"),
        MemoryLayout.sequenceLayout(12, VulkanWin32FFM.C_CHAR).withName("LeadByte"),
        VulkanWin32FFM.C_SHORT.withName("UnicodeDefaultChar"),
        VulkanWin32FFM.C_INT.withName("CodePage"),
        MemoryLayout.sequenceLayout(260, VulkanWin32FFM.C_SHORT).withName("CodePageName")
    ).withName("_cpinfoexW");
