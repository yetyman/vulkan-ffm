...
public class VkDataGraphPipelineShaderModuleCreateInfoARM {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        ...
        VulkanFFM.C_POINTER.withName("module"),
        VulkanFFM.C_POINTER.withName("pName"),
        VulkanFFM.C_POINTER.withName("pSpecializationInfo"),
        VulkanFFM.C_INT.withName("constantCount"),
        MemoryLayout.paddingLayout(4),
        VulkanFFM.C_POINTER.withName("pConstants")
