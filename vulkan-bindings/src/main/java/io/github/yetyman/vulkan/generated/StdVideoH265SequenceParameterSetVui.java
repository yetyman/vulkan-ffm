...
public class StdVideoH265SequenceParameterSetVui {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        ...
        VulkanFFM.C_INT.withName("aspect_ratio_idc"),
        VulkanFFM.C_SHORT.withName("sar_width"),
        VulkanFFM.C_SHORT.withName("sar_height"),
        VulkanFFM.C_CHAR.withName("video_format"),
        VulkanFFM.C_CHAR.withName("colour_primaries"),
        VulkanFFM.C_CHAR.withName("transfer_characteristics"),
        VulkanFFM.C_CHAR.withName("matrix_coeffs"),
        VulkanFFM.C_CHAR.withName("chroma_sample_loc_type_top_field"),
        VulkanFFM.C_CHAR.withName("chroma_sample_loc_type_bottom_field"),
        VulkanFFM.C_CHAR.withName("reserved1"),
        VulkanFFM.C_CHAR.withName("reserved2"),
        VulkanFFM.C_SHORT.withName("def_disp_win_left_offset"),
        VulkanFFM.C_SHORT.withName("def_disp_win_right_offset"),
        VulkanFFM.C_SHORT.withName("def_disp_win_top_offset"),
        VulkanFFM.C_SHORT.withName("def_disp_win_bottom_offset"),
        VulkanFFM.C_INT.withName("vui_num_units_in_tick"),
        VulkanFFM.C_INT.withName("vui_time_scale"),
        VulkanFFM.C_INT.withName("vui_num_ticks_poc_diff_one_minus1"),
        VulkanFFM.C_SHORT.withName("min_spatial_segmentation_idc"),
        VulkanFFM.C_SHORT.withName("reserved3"),
        VulkanFFM.C_CHAR.withName("max_bytes_per_pic_denom"),
        VulkanFFM.C_CHAR.withName("max_bits_per_min_cu_denom"),
        VulkanFFM.C_CHAR.withName("log2_max_mv_length_horizontal"),
        VulkanFFM.C_CHAR.withName("log2_max_mv_length_vertical"),
        VulkanFFM.C_POINTER.withName("pHrdParameters")
