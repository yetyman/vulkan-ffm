...
public class VkGeneratedCommandsInfoNV {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        ...
        VulkanFFM.C_INT.withName("pipelineBindPoint"),
        MemoryLayout.paddingLayout(4),
        VulkanFFM.C_POINTER.withName("pipeline"),
        VulkanFFM.C_POINTER.withName("indirectCommandsLayout"),
        VulkanFFM.C_INT.withName("streamCount"),
        MemoryLayout.paddingLayout(4),
        VulkanFFM.C_POINTER.withName("pStreams"),
        VulkanFFM.C_INT.withName("sequencesCount"),
        MemoryLayout.paddingLayout(4),
        VulkanFFM.C_POINTER.withName("preprocessBuffer"),
        VulkanFFM.C_LONG_LONG.withName("preprocessOffset"),
        VulkanFFM.C_LONG_LONG.withName("preprocessSize"),
        VulkanFFM.C_POINTER.withName("sequencesCountBuffer"),
        VulkanFFM.C_LONG_LONG.withName("sequencesCountOffset"),
        VulkanFFM.C_POINTER.withName("sequencesIndexBuffer"),
        VulkanFFM.C_LONG_LONG.withName("sequencesIndexOffset")
