...
public class StdVideoDecodeH265PictureInfo {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        ...
        VulkanFFM.C_CHAR.withName("NumDeltaPocsOfRefRpsIdx"),
        VulkanFFM.C_INT.withName("PicOrderCntVal"),
        VulkanFFM.C_SHORT.withName("NumBitsForSTRefPicSetInSlice"),
        VulkanFFM.C_SHORT.withName("reserved"),
        MemoryLayout.sequenceLayout(8, VulkanFFM.C_CHAR).withName("RefPicSetStCurrBefore"),
        MemoryLayout.sequenceLayout(8, VulkanFFM.C_CHAR).withName("RefPicSetStCurrAfter"),
        MemoryLayout.sequenceLayout(8, VulkanFFM.C_CHAR).withName("RefPicSetLtCurr")
