...
public class _IMAGE_TLS_DIRECTORY32 {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        VulkanWin32FFM.C_LONG.withName("StartAddressOfRawData"),
        VulkanWin32FFM.C_LONG.withName("EndAddressOfRawData"),
        VulkanWin32FFM.C_LONG.withName("AddressOfIndex"),
        VulkanWin32FFM.C_LONG.withName("AddressOfCallBacks"),
        VulkanWin32FFM.C_LONG.withName("SizeOfZeroFill"),
        MemoryLayout.unionLayout(
            VulkanWin32FFM.C_LONG.withName("Characteristics"),
            MemoryLayout.structLayout(
                MemoryLayout.paddingLayout(4)
            ).withName("$anon$19608:9")
        ).withName("$anon$19606:5")
    ...
    private static final OfInt Characteristics$LAYOUT = (OfInt)$LAYOUT.select(groupElement("$anon$19606:5"), groupElement("Characteristics"));
    ...
    private static final long Characteristics$OFFSET = $LAYOUT.byteOffset(groupElement("$anon$19606:5"), groupElement("Characteristics"));
