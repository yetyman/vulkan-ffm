...
public class VkShaderStatisticsInfoAMD {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        VulkanWin32FFM.C_INT.withName("shaderStageMask"),
        MemoryLayout.paddingLayout(4),
        VkShaderResourceUsageAMD.layout().withName("resourceUsage"),
        VulkanWin32FFM.C_INT.withName("numPhysicalVgprs"),
        VulkanWin32FFM.C_INT.withName("numPhysicalSgprs"),
        VulkanWin32FFM.C_INT.withName("numAvailableVgprs"),
        VulkanWin32FFM.C_INT.withName("numAvailableSgprs"),
        MemoryLayout.sequenceLayout(3, VulkanWin32FFM.C_INT).withName("computeWorkGroupSize"),
        MemoryLayout.paddingLayout(4)
    ...
    private static final long shaderStageMask$OFFSET = $LAYOUT.byteOffset(groupElement("shaderStageMask"));
    ...
    private static final long resourceUsage$OFFSET = $LAYOUT.byteOffset(groupElement("resourceUsage"));
    ...
    private static final long numPhysicalVgprs$OFFSET = $LAYOUT.byteOffset(groupElement("numPhysicalVgprs"));
    ...
    private static final long numPhysicalSgprs$OFFSET = $LAYOUT.byteOffset(groupElement("numPhysicalSgprs"));
    ...
    private static final long numAvailableVgprs$OFFSET = $LAYOUT.byteOffset(groupElement("numAvailableVgprs"));
    ...
    private static final long numAvailableSgprs$OFFSET = $LAYOUT.byteOffset(groupElement("numAvailableSgprs"));
    ...
    private static final long computeWorkGroupSize$OFFSET = $LAYOUT.byteOffset(groupElement("computeWorkGroupSize"));
    ...
    public static int computeWorkGroupSize(MemorySegment struct, long index0) {
        return (int)computeWorkGroupSize$ELEM_HANDLE.get(struct, computeWorkGroupSize$OFFSET, index0);
    }
    ...
    public static void computeWorkGroupSize(MemorySegment struct, long index0, int fieldValue) {
        computeWorkGroupSize$ELEM_HANDLE.set(struct, computeWorkGroupSize$OFFSET, index0, fieldValue);
    }
