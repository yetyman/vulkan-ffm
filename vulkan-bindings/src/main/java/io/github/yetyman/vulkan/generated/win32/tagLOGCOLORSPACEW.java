...
public class tagLOGCOLORSPACEW {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        VulkanWin32FFM.C_LONG.withName("lcsSignature"),
        VulkanWin32FFM.C_LONG.withName("lcsVersion"),
        VulkanWin32FFM.C_LONG.withName("lcsSize"),
        VulkanWin32FFM.C_LONG.withName("lcsCSType"),
        VulkanWin32FFM.C_LONG.withName("lcsIntent"),
        tagICEXYZTRIPLE.layout().withName("lcsEndpoints"),
        VulkanWin32FFM.C_LONG.withName("lcsGammaRed"),
        VulkanWin32FFM.C_LONG.withName("lcsGammaGreen"),
        VulkanWin32FFM.C_LONG.withName("lcsGammaBlue"),
        MemoryLayout.sequenceLayout(260, VulkanWin32FFM.C_SHORT).withName("lcsFilename")
