...
/**
 * {@snippet lang=c :
 * typedef void (*PFN_vkUpdateDescriptorSets)(VkDevice, uint32_t, const VkWriteDescriptorSet *, uint32_t, const VkCopyDescriptorSet *) __attribute__((stdcall))
 * }
 */
public final class PFN_vkUpdateDescriptorSets {

    private PFN_vkUpdateDescriptorSets() {
    ...
    private static final MethodHandle UP$MH = VulkanWin32FFM.upcallHandle(PFN_vkUpdateDescriptorSets.Function.class, "apply", $DESC);
