...
/**
 * {@snippet lang=c :
 * typedef void (*PFN_vkCmdCopyImage2)(VkCommandBuffer, const VkCopyImageInfo2 *) __attribute__((stdcall))
 * }
 */
public final class PFN_vkCmdCopyImage2 {

    private PFN_vkCmdCopyImage2() {
    ...
    private static final MethodHandle UP$MH = VulkanWin32FFM.upcallHandle(PFN_vkCmdCopyImage2.Function.class, "apply", $DESC);
