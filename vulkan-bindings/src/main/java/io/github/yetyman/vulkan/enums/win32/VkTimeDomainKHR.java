...
public record VkTimeDomainKHR(int value) {
    ...
    public static final VkTimeDomainKHR VK_TIME_DOMAIN_CLOCK_MONOTONIC_KHR = new VkTimeDomainKHR(1);
    public static final VkTimeDomainKHR VK_TIME_DOMAIN_CLOCK_MONOTONIC_RAW_EXT = new VkTimeDomainKHR(2);
    public static final VkTimeDomainKHR VK_TIME_DOMAIN_CLOCK_MONOTONIC_RAW_KHR = new VkTimeDomainKHR(2);
    public static final VkTimeDomainKHR VK_TIME_DOMAIN_DEVICE_EXT = new VkTimeDomainKHR(0);
    public static final VkTimeDomainKHR VK_TIME_DOMAIN_DEVICE_KHR = new VkTimeDomainKHR(0);
    ...
    public static final VkTimeDomainKHR VK_TIME_DOMAIN_QUERY_PERFORMANCE_COUNTER_KHR = new VkTimeDomainKHR(3);
