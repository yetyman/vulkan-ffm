...
public record VkImageLayout(int value) {
    ...
    public static final VkImageLayout VK_IMAGE_LAYOUT_ATTACHMENT_OPTIMAL_KHR = new VkImageLayout(1000314001);
    ...
    public static final VkImageLayout VK_IMAGE_LAYOUT_DEPTH_ATTACHMENT_OPTIMAL_KHR = new VkImageLayout(1000241000);
    ...
    public static final VkImageLayout VK_IMAGE_LAYOUT_DEPTH_ATTACHMENT_STENCIL_READ_ONLY_OPTIMAL_KHR = new VkImageLayout(1000117001);
    public static final VkImageLayout VK_IMAGE_LAYOUT_DEPTH_READ_ONLY_OPTIMAL = new VkImageLayout(1000241001);
    public static final VkImageLayout VK_IMAGE_LAYOUT_DEPTH_READ_ONLY_OPTIMAL_KHR = new VkImageLayout(1000241001);
    ...
    public static final VkImageLayout VK_IMAGE_LAYOUT_DEPTH_READ_ONLY_STENCIL_ATTACHMENT_OPTIMAL_KHR = new VkImageLayout(1000117000);
    ...
    public static final VkImageLayout VK_IMAGE_LAYOUT_READ_ONLY_OPTIMAL_KHR = new VkImageLayout(1000314000);
    public static final VkImageLayout VK_IMAGE_LAYOUT_RENDERING_LOCAL_READ = new VkImageLayout(1000232000);
    public static final VkImageLayout VK_IMAGE_LAYOUT_RENDERING_LOCAL_READ_KHR = new VkImageLayout(1000232000);
    public static final VkImageLayout VK_IMAGE_LAYOUT_SHADER_READ_ONLY_OPTIMAL = new VkImageLayout(5);
    public static final VkImageLayout VK_IMAGE_LAYOUT_SHADING_RATE_OPTIMAL_NV = new VkImageLayout(1000164003);
    ...
    public static final VkImageLayout VK_IMAGE_LAYOUT_STENCIL_ATTACHMENT_OPTIMAL_KHR = new VkImageLayout(1000241002);
    public static final VkImageLayout VK_IMAGE_LAYOUT_STENCIL_READ_ONLY_OPTIMAL = new VkImageLayout(1000241003);
    public static final VkImageLayout VK_IMAGE_LAYOUT_STENCIL_READ_ONLY_OPTIMAL_KHR = new VkImageLayout(1000241003);
