...
public class StdVideoH265ShortTermRefPicSet {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        ...
        VulkanFFM.C_INT.withName("delta_idx_minus1"),
        VulkanFFM.C_SHORT.withName("use_delta_flag"),
        VulkanFFM.C_SHORT.withName("abs_delta_rps_minus1"),
        VulkanFFM.C_SHORT.withName("used_by_curr_pic_flag"),
        VulkanFFM.C_SHORT.withName("used_by_curr_pic_s0_flag"),
        VulkanFFM.C_SHORT.withName("used_by_curr_pic_s1_flag"),
        VulkanFFM.C_SHORT.withName("reserved1"),
        VulkanFFM.C_CHAR.withName("reserved2"),
        VulkanFFM.C_CHAR.withName("reserved3"),
        VulkanFFM.C_CHAR.withName("num_negative_pics"),
        VulkanFFM.C_CHAR.withName("num_positive_pics"),
        MemoryLayout.sequenceLayout(16, VulkanFFM.C_SHORT).withName("delta_poc_s0_minus1"),
        MemoryLayout.sequenceLayout(16, VulkanFFM.C_SHORT).withName("delta_poc_s1_minus1")
