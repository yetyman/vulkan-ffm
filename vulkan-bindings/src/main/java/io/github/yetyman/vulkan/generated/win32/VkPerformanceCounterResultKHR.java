...
public class VkPerformanceCounterResultKHR {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.unionLayout(
        VulkanWin32FFM.C_INT.withName("int32"),
        VulkanWin32FFM.C_LONG_LONG.withName("int64"),
        VulkanWin32FFM.C_INT.withName("uint32"),
        VulkanWin32FFM.C_LONG_LONG.withName("uint64"),
        VulkanWin32FFM.C_FLOAT.withName("float32"),
        VulkanWin32FFM.C_DOUBLE.withName("float64")
    ...
    private static final long uint64$OFFSET = $LAYOUT.byteOffset(groupElement("uint64"));
    ...
    private static final long float64$OFFSET = $LAYOUT.byteOffset(groupElement("float64"));
