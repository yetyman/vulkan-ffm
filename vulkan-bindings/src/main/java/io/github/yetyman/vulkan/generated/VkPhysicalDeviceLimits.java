...
public class VkPhysicalDeviceLimits {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        VulkanFFM.C_INT.withName("maxImageDimension1D"),
        VulkanFFM.C_INT.withName("maxImageDimension2D"),
        VulkanFFM.C_INT.withName("maxImageDimension3D"),
        VulkanFFM.C_INT.withName("maxImageDimensionCube"),
        VulkanFFM.C_INT.withName("maxImageArrayLayers"),
        VulkanFFM.C_INT.withName("maxTexelBufferElements"),
        VulkanFFM.C_INT.withName("maxUniformBufferRange"),
        VulkanFFM.C_INT.withName("maxStorageBufferRange"),
        VulkanFFM.C_INT.withName("maxPushConstantsSize"),
        VulkanFFM.C_INT.withName("maxMemoryAllocationCount"),
        VulkanFFM.C_INT.withName("maxSamplerAllocationCount"),
        MemoryLayout.paddingLayout(4),
        VulkanFFM.C_LONG_LONG.withName("bufferImageGranularity"),
        VulkanFFM.C_LONG_LONG.withName("sparseAddressSpaceSize"),
        VulkanFFM.C_INT.withName("maxBoundDescriptorSets"),
        VulkanFFM.C_INT.withName("maxPerStageDescriptorSamplers"),
        VulkanFFM.C_INT.withName("maxPerStageDescriptorUniformBuffers"),
        VulkanFFM.C_INT.withName("maxPerStageDescriptorStorageBuffers"),
        VulkanFFM.C_INT.withName("maxPerStageDescriptorSampledImages"),
        VulkanFFM.C_INT.withName("maxPerStageDescriptorStorageImages"),
        VulkanFFM.C_INT.withName("maxPerStageDescriptorInputAttachments"),
        VulkanFFM.C_INT.withName("maxPerStageResources"),
        VulkanFFM.C_INT.withName("maxDescriptorSetSamplers"),
        VulkanFFM.C_INT.withName("maxDescriptorSetUniformBuffers"),
        VulkanFFM.C_INT.withName("maxDescriptorSetUniformBuffersDynamic"),
        VulkanFFM.C_INT.withName("maxDescriptorSetStorageBuffers"),
        VulkanFFM.C_INT.withName("maxDescriptorSetStorageBuffersDynamic"),
        VulkanFFM.C_INT.withName("maxDescriptorSetSampledImages"),
        VulkanFFM.C_INT.withName("maxDescriptorSetStorageImages"),
        VulkanFFM.C_INT.withName("maxDescriptorSetInputAttachments"),
        VulkanFFM.C_INT.withName("maxVertexInputAttributes"),
        VulkanFFM.C_INT.withName("maxVertexInputBindings"),
        VulkanFFM.C_INT.withName("maxVertexInputAttributeOffset"),
        VulkanFFM.C_INT.withName("maxVertexInputBindingStride"),
        VulkanFFM.C_INT.withName("maxVertexOutputComponents"),
        VulkanFFM.C_INT.withName("maxTessellationGenerationLevel"),
        VulkanFFM.C_INT.withName("maxTessellationPatchSize"),
        VulkanFFM.C_INT.withName("maxTessellationControlPerVertexInputComponents"),
        VulkanFFM.C_INT.withName("maxTessellationControlPerVertexOutputComponents"),
        VulkanFFM.C_INT.withName("maxTessellationControlPerPatchOutputComponents"),
        VulkanFFM.C_INT.withName("maxTessellationControlTotalOutputComponents"),
        VulkanFFM.C_INT.withName("maxTessellationEvaluationInputComponents"),
        VulkanFFM.C_INT.withName("maxTessellationEvaluationOutputComponents"),
        VulkanFFM.C_INT.withName("maxGeometryShaderInvocations"),
        VulkanFFM.C_INT.withName("maxGeometryInputComponents"),
        VulkanFFM.C_INT.withName("maxGeometryOutputComponents"),
        VulkanFFM.C_INT.withName("maxGeometryOutputVertices"),
        VulkanFFM.C_INT.withName("maxGeometryTotalOutputComponents"),
        VulkanFFM.C_INT.withName("maxFragmentInputComponents"),
        VulkanFFM.C_INT.withName("maxFragmentOutputAttachments"),
        VulkanFFM.C_INT.withName("maxFragmentDualSrcAttachments"),
        VulkanFFM.C_INT.withName("maxFragmentCombinedOutputResources"),
        VulkanFFM.C_INT.withName("maxComputeSharedMemorySize"),
        MemoryLayout.sequenceLayout(3, VulkanFFM.C_INT).withName("maxComputeWorkGroupCount"),
        VulkanFFM.C_INT.withName("maxComputeWorkGroupInvocations"),
        MemoryLayout.sequenceLayout(3, VulkanFFM.C_INT).withName("maxComputeWorkGroupSize"),
        VulkanFFM.C_INT.withName("subPixelPrecisionBits"),
        VulkanFFM.C_INT.withName("subTexelPrecisionBits"),
        VulkanFFM.C_INT.withName("mipmapPrecisionBits"),
        VulkanFFM.C_INT.withName("maxDrawIndexedIndexValue"),
        VulkanFFM.C_INT.withName("maxDrawIndirectCount"),
        VulkanFFM.C_FLOAT.withName("maxSamplerLodBias"),
        VulkanFFM.C_FLOAT.withName("maxSamplerAnisotropy"),
        VulkanFFM.C_INT.withName("maxViewports"),
        MemoryLayout.sequenceLayout(2, VulkanFFM.C_INT).withName("maxViewportDimensions"),
        MemoryLayout.sequenceLayout(2, VulkanFFM.C_FLOAT).withName("viewportBoundsRange"),
        VulkanFFM.C_INT.withName("viewportSubPixelBits"),
        MemoryLayout.paddingLayout(4),
        VulkanFFM.C_LONG_LONG.withName("minMemoryMapAlignment"),
        VulkanFFM.C_LONG_LONG.withName("minTexelBufferOffsetAlignment"),
        VulkanFFM.C_LONG_LONG.withName("minUniformBufferOffsetAlignment"),
        VulkanFFM.C_LONG_LONG.withName("minStorageBufferOffsetAlignment"),
        VulkanFFM.C_INT.withName("minTexelOffset"),
        VulkanFFM.C_INT.withName("maxTexelOffset"),
        VulkanFFM.C_INT.withName("minTexelGatherOffset"),
        VulkanFFM.C_INT.withName("maxTexelGatherOffset"),
        VulkanFFM.C_FLOAT.withName("minInterpolationOffset"),
        VulkanFFM.C_FLOAT.withName("maxInterpolationOffset"),
        VulkanFFM.C_INT.withName("subPixelInterpolationOffsetBits"),
        VulkanFFM.C_INT.withName("maxFramebufferWidth"),
        VulkanFFM.C_INT.withName("maxFramebufferHeight"),
        VulkanFFM.C_INT.withName("maxFramebufferLayers"),
        VulkanFFM.C_INT.withName("framebufferColorSampleCounts"),
        VulkanFFM.C_INT.withName("framebufferDepthSampleCounts"),
        VulkanFFM.C_INT.withName("framebufferStencilSampleCounts"),
        VulkanFFM.C_INT.withName("framebufferNoAttachmentsSampleCounts"),
        VulkanFFM.C_INT.withName("maxColorAttachments"),
        VulkanFFM.C_INT.withName("sampledImageColorSampleCounts"),
        VulkanFFM.C_INT.withName("sampledImageIntegerSampleCounts"),
        VulkanFFM.C_INT.withName("sampledImageDepthSampleCounts"),
        VulkanFFM.C_INT.withName("sampledImageStencilSampleCounts"),
        VulkanFFM.C_INT.withName("storageImageSampleCounts"),
        VulkanFFM.C_INT.withName("maxSampleMaskWords"),
        VulkanFFM.C_INT.withName("timestampComputeAndGraphics"),
        VulkanFFM.C_FLOAT.withName("timestampPeriod"),
        VulkanFFM.C_INT.withName("maxClipDistances"),
        VulkanFFM.C_INT.withName("maxCullDistances"),
        VulkanFFM.C_INT.withName("maxCombinedClipAndCullDistances"),
        VulkanFFM.C_INT.withName("discreteQueuePriorities"),
        MemoryLayout.sequenceLayout(2, VulkanFFM.C_FLOAT).withName("pointSizeRange"),
        MemoryLayout.sequenceLayout(2, VulkanFFM.C_FLOAT).withName("lineWidthRange"),
        VulkanFFM.C_FLOAT.withName("pointSizeGranularity"),
        VulkanFFM.C_FLOAT.withName("lineWidthGranularity"),
        VulkanFFM.C_INT.withName("strictLines"),
        VulkanFFM.C_INT.withName("standardSampleLocations"),
        MemoryLayout.paddingLayout(4),
        VulkanFFM.C_LONG_LONG.withName("optimalBufferCopyOffsetAlignment"),
        VulkanFFM.C_LONG_LONG.withName("optimalBufferCopyRowPitchAlignment"),
        VulkanFFM.C_LONG_LONG.withName("nonCoherentAtomSize")
