...
public class StdVideoEncodeH265SliceSegmentHeader {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        ...
        VulkanFFM.C_INT.withName("slice_type"),
        VulkanFFM.C_INT.withName("slice_segment_address"),
        VulkanFFM.C_CHAR.withName("collocated_ref_idx"),
        VulkanFFM.C_CHAR.withName("MaxNumMergeCand"),
        VulkanFFM.C_CHAR.withName("slice_cb_qp_offset"),
        VulkanFFM.C_CHAR.withName("slice_cr_qp_offset"),
        VulkanFFM.C_CHAR.withName("slice_beta_offset_div2"),
        VulkanFFM.C_CHAR.withName("slice_tc_offset_div2"),
        VulkanFFM.C_CHAR.withName("slice_act_y_qp_offset"),
        VulkanFFM.C_CHAR.withName("slice_act_cb_qp_offset"),
        VulkanFFM.C_CHAR.withName("slice_act_cr_qp_offset"),
        VulkanFFM.C_CHAR.withName("slice_qp_delta"),
        VulkanFFM.C_SHORT.withName("reserved1"),
        VulkanFFM.C_POINTER.withName("pWeightTable")
