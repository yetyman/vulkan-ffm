...
public class VkCommandBufferInheritanceInfo {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        ...
        MemoryLayout.paddingLayout(4),
        VulkanFFM.C_POINTER.withName("framebuffer"),
        VulkanFFM.C_INT.withName("occlusionQueryEnable"),
        VulkanFFM.C_INT.withName("queryFlags"),
        VulkanFFM.C_INT.withName("pipelineStatistics"),
        MemoryLayout.paddingLayout(4)
