...
public record VkShaderStageFlagBits(int value) {
    ...
    public static final VkShaderStageFlagBits VK_SHADER_STAGE_ANY_HIT_BIT_NV = VK_SHADER_STAGE_ANY_HIT_BIT_KHR;
    public static final VkShaderStageFlagBits VK_SHADER_STAGE_CALLABLE_BIT_KHR = new VkShaderStageFlagBits(8192);
    public static final VkShaderStageFlagBits VK_SHADER_STAGE_CALLABLE_BIT_NV = VK_SHADER_STAGE_CALLABLE_BIT_KHR;
    public static final VkShaderStageFlagBits VK_SHADER_STAGE_CLOSEST_HIT_BIT_KHR = new VkShaderStageFlagBits(1024);
    public static final VkShaderStageFlagBits VK_SHADER_STAGE_CLOSEST_HIT_BIT_NV = VK_SHADER_STAGE_CLOSEST_HIT_BIT_KHR;
    ...
    public static final VkShaderStageFlagBits VK_SHADER_STAGE_FLAG_BITS_MAX_ENUM = VK_SHADER_STAGE_ALL;
    ...
    public static final VkShaderStageFlagBits VK_SHADER_STAGE_INTERSECTION_BIT_NV = VK_SHADER_STAGE_INTERSECTION_BIT_KHR;
    public static final VkShaderStageFlagBits VK_SHADER_STAGE_MESH_BIT_EXT = new VkShaderStageFlagBits(128);
    public static final VkShaderStageFlagBits VK_SHADER_STAGE_MESH_BIT_NV = VK_SHADER_STAGE_MESH_BIT_EXT;
    public static final VkShaderStageFlagBits VK_SHADER_STAGE_MISS_BIT_KHR = new VkShaderStageFlagBits(2048);
    public static final VkShaderStageFlagBits VK_SHADER_STAGE_MISS_BIT_NV = VK_SHADER_STAGE_MISS_BIT_KHR;
    public static final VkShaderStageFlagBits VK_SHADER_STAGE_RAYGEN_BIT_KHR = new VkShaderStageFlagBits(256);
    public static final VkShaderStageFlagBits VK_SHADER_STAGE_RAYGEN_BIT_NV = VK_SHADER_STAGE_RAYGEN_BIT_KHR;
    ...
    public static final VkShaderStageFlagBits VK_SHADER_STAGE_TASK_BIT_NV = VK_SHADER_STAGE_TASK_BIT_EXT;
