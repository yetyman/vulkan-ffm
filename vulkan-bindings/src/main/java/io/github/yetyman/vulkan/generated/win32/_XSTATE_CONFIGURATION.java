...
public class _XSTATE_CONFIGURATION {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        VulkanWin32FFM.C_LONG_LONG.withName("EnabledFeatures"),
        VulkanWin32FFM.C_LONG_LONG.withName("EnabledVolatileFeatures"),
        VulkanWin32FFM.C_LONG.withName("Size"),
        MemoryLayout.unionLayout(
            VulkanWin32FFM.C_LONG.withName("ControlFlags"),
            MemoryLayout.structLayout(
                MemoryLayout.paddingLayout(4)
            ).withName("$anon$13874:9")
        ).withName("$anon$13872:5"),
        MemoryLayout.sequenceLayout(64, _XSTATE_FEATURE.layout()).withName("Features"),
        VulkanWin32FFM.C_LONG_LONG.withName("EnabledSupervisorFeatures"),
        VulkanWin32FFM.C_LONG_LONG.withName("AlignedFeatures"),
        VulkanWin32FFM.C_LONG.withName("AllFeatureSize"),
        MemoryLayout.sequenceLayout(64, VulkanWin32FFM.C_LONG).withName("AllFeatures"),
        MemoryLayout.paddingLayout(4),
        VulkanWin32FFM.C_LONG_LONG.withName("EnabledUserVisibleSupervisorFeatures"),
        VulkanWin32FFM.C_LONG_LONG.withName("ExtendedFeatureDisableFeatures"),
        VulkanWin32FFM.C_LONG.withName("AllNonLargeFeatureSize"),
        VulkanWin32FFM.C_LONG.withName("Spare")
    ...
    private static final OfInt ControlFlags$LAYOUT = (OfInt)$LAYOUT.select(groupElement("$anon$13872:5"), groupElement("ControlFlags"));
    ...
    private static final long ControlFlags$OFFSET = $LAYOUT.byteOffset(groupElement("$anon$13872:5"), groupElement("ControlFlags"));
