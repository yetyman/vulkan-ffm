...
public class VkPerformanceValueDataINTEL {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.unionLayout(
        VulkanFFM.C_INT.withName("value32"),
        VulkanFFM.C_LONG_LONG.withName("value64"),
        VulkanFFM.C_FLOAT.withName("valueFloat"),
        VulkanFFM.C_INT.withName("valueBool"),
        VulkanFFM.C_POINTER.withName("valueString")
