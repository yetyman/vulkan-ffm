...
public class StdVideoEncodeH264WeightTableFlags {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        VulkanFFM.C_INT.withName("luma_weight_l0_flag"),
        VulkanFFM.C_INT.withName("chroma_weight_l0_flag"),
        VulkanFFM.C_INT.withName("luma_weight_l1_flag"),
        VulkanFFM.C_INT.withName("chroma_weight_l1_flag")
