...
public class VkPhysicalDeviceSparseProperties {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        VulkanFFM.C_INT.withName("residencyStandard2DBlockShape"),
        VulkanFFM.C_INT.withName("residencyStandard2DMultisampleBlockShape"),
        VulkanFFM.C_INT.withName("residencyStandard3DBlockShape"),
        VulkanFFM.C_INT.withName("residencyAlignedMipSize"),
        VulkanFFM.C_INT.withName("residencyNonResidentStrict")
