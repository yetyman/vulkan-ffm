...
public record VkToolPurposeFlagBits(int value) {
    ...
    public static final VkToolPurposeFlagBits VK_TOOL_PURPOSE_ADDITIONAL_FEATURES_BIT_EXT = VK_TOOL_PURPOSE_ADDITIONAL_FEATURES_BIT;
    ...
    public static final VkToolPurposeFlagBits VK_TOOL_PURPOSE_MODIFYING_FEATURES_BIT_EXT = VK_TOOL_PURPOSE_MODIFYING_FEATURES_BIT;
    public static final VkToolPurposeFlagBits VK_TOOL_PURPOSE_PROFILING_BIT = new VkToolPurposeFlagBits(2);
    public static final VkToolPurposeFlagBits VK_TOOL_PURPOSE_PROFILING_BIT_EXT = VK_TOOL_PURPOSE_PROFILING_BIT;
    public static final VkToolPurposeFlagBits VK_TOOL_PURPOSE_TRACING_BIT = new VkToolPurposeFlagBits(4);
    public static final VkToolPurposeFlagBits VK_TOOL_PURPOSE_TRACING_BIT_EXT = VK_TOOL_PURPOSE_TRACING_BIT;
    public static final VkToolPurposeFlagBits VK_TOOL_PURPOSE_VALIDATION_BIT = new VkToolPurposeFlagBits(1);
    public static final VkToolPurposeFlagBits VK_TOOL_PURPOSE_VALIDATION_BIT_EXT = VK_TOOL_PURPOSE_VALIDATION_BIT;
