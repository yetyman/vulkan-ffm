...
/**
 * {@snippet lang=c :
 * typedef VkResult (*PFN_vkCreateSharedSwapchainsKHR)(VkDevice, uint32_t, const VkSwapchainCreateInfoKHR *, const VkAllocationCallbacks *, VkSwapchainKHR *) __attribute__((stdcall))
 * }
 */
public final class PFN_vkCreateSharedSwapchainsKHR {

    private PFN_vkCreateSharedSwapchainsKHR() {
    ...
    private static final MethodHandle UP$MH = VulkanWin32FFM.upcallHandle(PFN_vkCreateSharedSwapchainsKHR.Function.class, "apply", $DESC);
