...
public class tagMULTIKEYHELPW {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        VulkanWin32FFM.C_LONG.withName("mkSize"),
        VulkanWin32FFM.C_SHORT.withName("mkKeylist"),
        MemoryLayout.sequenceLayout(1, VulkanWin32FFM.C_SHORT).withName("szKeyphrase")
