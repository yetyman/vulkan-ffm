...
public class VkPhysicalDeviceVulkan12Properties {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        ...
        VulkanFFM.C_INT.withName("driverID"),
        MemoryLayout.sequenceLayout(256, VulkanFFM.C_CHAR).withName("driverName"),
        MemoryLayout.sequenceLayout(256, VulkanFFM.C_CHAR).withName("driverInfo"),
        VkConformanceVersion.layout().withName("conformanceVersion"),
        VulkanFFM.C_INT.withName("denormBehaviorIndependence"),
        VulkanFFM.C_INT.withName("roundingModeIndependence"),
        VulkanFFM.C_INT.withName("shaderSignedZeroInfNanPreserveFloat16"),
        VulkanFFM.C_INT.withName("shaderSignedZeroInfNanPreserveFloat32"),
        VulkanFFM.C_INT.withName("shaderSignedZeroInfNanPreserveFloat64"),
        VulkanFFM.C_INT.withName("shaderDenormPreserveFloat16"),
        VulkanFFM.C_INT.withName("shaderDenormPreserveFloat32"),
        VulkanFFM.C_INT.withName("shaderDenormPreserveFloat64"),
        VulkanFFM.C_INT.withName("shaderDenormFlushToZeroFloat16"),
        VulkanFFM.C_INT.withName("shaderDenormFlushToZeroFloat32"),
        VulkanFFM.C_INT.withName("shaderDenormFlushToZeroFloat64"),
        VulkanFFM.C_INT.withName("shaderRoundingModeRTEFloat16"),
        VulkanFFM.C_INT.withName("shaderRoundingModeRTEFloat32"),
        VulkanFFM.C_INT.withName("shaderRoundingModeRTEFloat64"),
        VulkanFFM.C_INT.withName("shaderRoundingModeRTZFloat16"),
        VulkanFFM.C_INT.withName("shaderRoundingModeRTZFloat32"),
        VulkanFFM.C_INT.withName("shaderRoundingModeRTZFloat64"),
        VulkanFFM.C_INT.withName("maxUpdateAfterBindDescriptorsInAllPools"),
        VulkanFFM.C_INT.withName("shaderUniformBufferArrayNonUniformIndexingNative"),
        VulkanFFM.C_INT.withName("shaderSampledImageArrayNonUniformIndexingNative"),
        VulkanFFM.C_INT.withName("shaderStorageBufferArrayNonUniformIndexingNative"),
        VulkanFFM.C_INT.withName("shaderStorageImageArrayNonUniformIndexingNative"),
        VulkanFFM.C_INT.withName("shaderInputAttachmentArrayNonUniformIndexingNative"),
        VulkanFFM.C_INT.withName("robustBufferAccessUpdateAfterBind"),
        VulkanFFM.C_INT.withName("quadDivergentImplicitLod"),
        VulkanFFM.C_INT.withName("maxPerStageDescriptorUpdateAfterBindSamplers"),
        VulkanFFM.C_INT.withName("maxPerStageDescriptorUpdateAfterBindUniformBuffers"),
        VulkanFFM.C_INT.withName("maxPerStageDescriptorUpdateAfterBindStorageBuffers"),
        VulkanFFM.C_INT.withName("maxPerStageDescriptorUpdateAfterBindSampledImages"),
        VulkanFFM.C_INT.withName("maxPerStageDescriptorUpdateAfterBindStorageImages"),
        VulkanFFM.C_INT.withName("maxPerStageDescriptorUpdateAfterBindInputAttachments"),
        VulkanFFM.C_INT.withName("maxPerStageUpdateAfterBindResources"),
        VulkanFFM.C_INT.withName("maxDescriptorSetUpdateAfterBindSamplers"),
        VulkanFFM.C_INT.withName("maxDescriptorSetUpdateAfterBindUniformBuffers"),
        VulkanFFM.C_INT.withName("maxDescriptorSetUpdateAfterBindUniformBuffersDynamic"),
        VulkanFFM.C_INT.withName("maxDescriptorSetUpdateAfterBindStorageBuffers"),
        VulkanFFM.C_INT.withName("maxDescriptorSetUpdateAfterBindStorageBuffersDynamic"),
        VulkanFFM.C_INT.withName("maxDescriptorSetUpdateAfterBindSampledImages"),
        VulkanFFM.C_INT.withName("maxDescriptorSetUpdateAfterBindStorageImages"),
        VulkanFFM.C_INT.withName("maxDescriptorSetUpdateAfterBindInputAttachments"),
        VulkanFFM.C_INT.withName("supportedDepthResolveModes"),
        VulkanFFM.C_INT.withName("supportedStencilResolveModes"),
        VulkanFFM.C_INT.withName("independentResolveNone"),
        VulkanFFM.C_INT.withName("independentResolve"),
        VulkanFFM.C_INT.withName("filterMinmaxSingleComponentFormats"),
        VulkanFFM.C_INT.withName("filterMinmaxImageComponentMapping"),
        VulkanFFM.C_LONG_LONG.withName("maxTimelineSemaphoreValueDifference"),
        VulkanFFM.C_INT.withName("framebufferIntegerColorSampleCounts"),
        MemoryLayout.paddingLayout(4)
