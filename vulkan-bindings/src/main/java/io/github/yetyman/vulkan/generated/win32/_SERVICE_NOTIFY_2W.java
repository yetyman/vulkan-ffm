...
public class _SERVICE_NOTIFY_2W {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        ...
        VulkanWin32FFM.C_POINTER.withName("pfnNotifyCallback"),
        VulkanWin32FFM.C_POINTER.withName("pContext"),
        VulkanWin32FFM.C_LONG.withName("dwNotificationStatus"),
        _SERVICE_STATUS_PROCESS.layout().withName("ServiceStatus"),
        VulkanWin32FFM.C_LONG.withName("dwNotificationTriggered"),
        MemoryLayout.paddingLayout(4),
        VulkanWin32FFM.C_POINTER.withName("pszServiceNames")
