...
public class VkClearColorValue {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.unionLayout(
        MemoryLayout.sequenceLayout(4, VulkanWin32FFM.C_FLOAT).withName("float32"),
        MemoryLayout.sequenceLayout(4, VulkanWin32FFM.C_INT).withName("int32"),
        MemoryLayout.sequenceLayout(4, VulkanWin32FFM.C_INT).withName("uint32")
