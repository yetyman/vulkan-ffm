...
/**
 * {@snippet lang=c :
 * typedef void (*PFN_vkCmdSetFrontFaceEXT)(VkCommandBuffer, VkFrontFace) __attribute__((stdcall))
 * }
 */
public final class PFN_vkCmdSetFrontFaceEXT {

    private PFN_vkCmdSetFrontFaceEXT() {
    ...
    private static final MethodHandle UP$MH = VulkanWin32FFM.upcallHandle(PFN_vkCmdSetFrontFaceEXT.Function.class, "apply", $DESC);
