...
public class JOBOBJECT_LIMIT_VIOLATION_INFORMATION_2 {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        VulkanWin32FFM.C_LONG.withName("LimitFlags"),
        VulkanWin32FFM.C_LONG.withName("ViolationLimitFlags"),
        VulkanWin32FFM.C_LONG_LONG.withName("IoReadBytes"),
        VulkanWin32FFM.C_LONG_LONG.withName("IoReadBytesLimit"),
        VulkanWin32FFM.C_LONG_LONG.withName("IoWriteBytes"),
        VulkanWin32FFM.C_LONG_LONG.withName("IoWriteBytesLimit"),
        _LARGE_INTEGER.layout().withName("PerJobUserTime"),
        _LARGE_INTEGER.layout().withName("PerJobUserTimeLimit"),
        VulkanWin32FFM.C_LONG_LONG.withName("JobMemory"),
        MemoryLayout.unionLayout(
            VulkanWin32FFM.C_LONG_LONG.withName("JobHighMemoryLimit"),
            VulkanWin32FFM.C_LONG_LONG.withName("JobMemoryLimit")
        ).withName("$anon$13000:5"),
        MemoryLayout.unionLayout(
            VulkanWin32FFM.C_INT.withName("RateControlTolerance"),
            VulkanWin32FFM.C_INT.withName("CpuRateControlTolerance")
        ).withName("$anon$13005:5"),
        MemoryLayout.unionLayout(
            VulkanWin32FFM.C_INT.withName("RateControlToleranceLimit"),
            VulkanWin32FFM.C_INT.withName("CpuRateControlToleranceLimit")
        ).withName("$anon$13010:5"),
        VulkanWin32FFM.C_LONG_LONG.withName("JobLowMemoryLimit"),
        VulkanWin32FFM.C_INT.withName("IoRateControlTolerance"),
        VulkanWin32FFM.C_INT.withName("IoRateControlToleranceLimit"),
        VulkanWin32FFM.C_INT.withName("NetRateControlTolerance"),
        VulkanWin32FFM.C_INT.withName("NetRateControlToleranceLimit")
    ...
    private static final OfLong JobHighMemoryLimit$LAYOUT = (OfLong)$LAYOUT.select(groupElement("$anon$13000:5"), groupElement("JobHighMemoryLimit"));
    ...
    private static final long JobHighMemoryLimit$OFFSET = $LAYOUT.byteOffset(groupElement("$anon$13000:5"), groupElement("JobHighMemoryLimit"));
    ...
    private static final OfLong JobMemoryLimit$LAYOUT = (OfLong)$LAYOUT.select(groupElement("$anon$13000:5"), groupElement("JobMemoryLimit"));
    ...
    private static final long JobMemoryLimit$OFFSET = $LAYOUT.byteOffset(groupElement("$anon$13000:5"), groupElement("JobMemoryLimit"));
    ...
    private static final OfInt RateControlTolerance$LAYOUT = (OfInt)$LAYOUT.select(groupElement("$anon$13005:5"), groupElement("RateControlTolerance"));
    ...
    private static final long RateControlTolerance$OFFSET = $LAYOUT.byteOffset(groupElement("$anon$13005:5"), groupElement("RateControlTolerance"));
    ...
    private static final OfInt CpuRateControlTolerance$LAYOUT = (OfInt)$LAYOUT.select(groupElement("$anon$13005:5"), groupElement("CpuRateControlTolerance"));
    ...
    private static final long CpuRateControlTolerance$OFFSET = $LAYOUT.byteOffset(groupElement("$anon$13005:5"), groupElement("CpuRateControlTolerance"));
    ...
    private static final OfInt RateControlToleranceLimit$LAYOUT = (OfInt)$LAYOUT.select(groupElement("$anon$13010:5"), groupElement("RateControlToleranceLimit"));
    ...
    private static final long RateControlToleranceLimit$OFFSET = $LAYOUT.byteOffset(groupElement("$anon$13010:5"), groupElement("RateControlToleranceLimit"));
    ...
    private static final OfInt CpuRateControlToleranceLimit$LAYOUT = (OfInt)$LAYOUT.select(groupElement("$anon$13010:5"), groupElement("CpuRateControlToleranceLimit"));
    ...
    private static final long CpuRateControlToleranceLimit$OFFSET = $LAYOUT.byteOffset(groupElement("$anon$13010:5"), groupElement("CpuRateControlToleranceLimit"));
