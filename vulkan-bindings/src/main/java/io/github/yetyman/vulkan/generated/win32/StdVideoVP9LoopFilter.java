 ...
 * }
 */
public class StdVideoVP9LoopFilter {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        StdVideoVP9LoopFilterFlags.layout().withName("flags"),
        VulkanWin32FFM.C_CHAR.withName("loop_filter_level"),
        VulkanWin32FFM.C_CHAR.withName("loop_filter_sharpness"),
        VulkanWin32FFM.C_CHAR.withName("update_ref_delta"),
        MemoryLayout.sequenceLayout(4, VulkanWin32FFM.C_CHAR).withName("loop_filter_ref_deltas"),
        VulkanWin32FFM.C_CHAR.withName("update_mode_delta"),
        MemoryLayout.sequenceLayout(2, VulkanWin32FFM.C_CHAR).withName("loop_filter_mode_deltas"),
        MemoryLayout.paddingLayout(2)
    ).withName("StdVideoVP9LoopFilter");
    ...
    private static final OfByte loop_filter_level$LAYOUT = (OfByte)$LAYOUT.select(groupElement("loop_filter_level"));
     ...
     * }
     */
    public static final OfByte loop_filter_level$layout() {
        return loop_filter_level$LAYOUT;
    }

    private static final long loop_filter_level$OFFSET = $LAYOUT.byteOffset(groupElement("loop_filter_level"));
     ...
     * }
     */
    public static byte loop_filter_level(MemorySegment struct) {
        return struct.get(loop_filter_level$LAYOUT, loop_filter_level$OFFSET);
    }
     ...
     * }
     */
    public static void loop_filter_level(MemorySegment struct, byte fieldValue) {
        struct.set(loop_filter_level$LAYOUT, loop_filter_level$OFFSET, fieldValue);
    }
    ...
    private static final long loop_filter_sharpness$OFFSET = $LAYOUT.byteOffset(groupElement("loop_filter_sharpness"));
    ...
    private static final long update_ref_delta$OFFSET = $LAYOUT.byteOffset(groupElement("update_ref_delta"));
    ...
    private static final long loop_filter_ref_deltas$OFFSET = $LAYOUT.byteOffset(groupElement("loop_filter_ref_deltas"));
    ...
    private static long[] loop_filter_ref_deltas$DIMS = { 4 };
    ...
    public static byte loop_filter_ref_deltas(MemorySegment struct, long index0) {
        return (byte)loop_filter_ref_deltas$ELEM_HANDLE.get(struct, loop_filter_ref_deltas$OFFSET, index0);
    }
    ...
    public static void loop_filter_ref_deltas(MemorySegment struct, long index0, byte fieldValue) {
        loop_filter_ref_deltas$ELEM_HANDLE.set(struct, loop_filter_ref_deltas$OFFSET, index0, fieldValue);
    }
    ...
    private static final long update_mode_delta$OFFSET = $LAYOUT.byteOffset(groupElement("update_mode_delta"));
    ...
    private static final long loop_filter_mode_deltas$OFFSET = $LAYOUT.byteOffset(groupElement("loop_filter_mode_deltas"));
    ...
    public static byte loop_filter_mode_deltas(MemorySegment struct, long index0) {
        return (byte)loop_filter_mode_deltas$ELEM_HANDLE.get(struct, loop_filter_mode_deltas$OFFSET, index0);
    }
    ...
    public static void loop_filter_mode_deltas(MemorySegment struct, long index0, byte fieldValue) {
        loop_filter_mode_deltas$ELEM_HANDLE.set(struct, loop_filter_mode_deltas$OFFSET, index0, fieldValue);
    }
