...
public class StdVideoH265SequenceParameterSetVui {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        ...
        VulkanWin32FFM.C_INT.withName("aspect_ratio_idc"),
        VulkanWin32FFM.C_SHORT.withName("sar_width"),
        VulkanWin32FFM.C_SHORT.withName("sar_height"),
        VulkanWin32FFM.C_CHAR.withName("video_format"),
        VulkanWin32FFM.C_CHAR.withName("colour_primaries"),
        VulkanWin32FFM.C_CHAR.withName("transfer_characteristics"),
        VulkanWin32FFM.C_CHAR.withName("matrix_coeffs"),
        VulkanWin32FFM.C_CHAR.withName("chroma_sample_loc_type_top_field"),
        VulkanWin32FFM.C_CHAR.withName("chroma_sample_loc_type_bottom_field"),
        VulkanWin32FFM.C_CHAR.withName("reserved1"),
        VulkanWin32FFM.C_CHAR.withName("reserved2"),
        VulkanWin32FFM.C_SHORT.withName("def_disp_win_left_offset"),
        VulkanWin32FFM.C_SHORT.withName("def_disp_win_right_offset"),
        VulkanWin32FFM.C_SHORT.withName("def_disp_win_top_offset"),
        VulkanWin32FFM.C_SHORT.withName("def_disp_win_bottom_offset"),
        VulkanWin32FFM.C_INT.withName("vui_num_units_in_tick"),
        VulkanWin32FFM.C_INT.withName("vui_time_scale"),
        VulkanWin32FFM.C_INT.withName("vui_num_ticks_poc_diff_one_minus1"),
        VulkanWin32FFM.C_SHORT.withName("min_spatial_segmentation_idc"),
        VulkanWin32FFM.C_SHORT.withName("reserved3"),
        VulkanWin32FFM.C_CHAR.withName("max_bytes_per_pic_denom"),
        VulkanWin32FFM.C_CHAR.withName("max_bits_per_min_cu_denom"),
        VulkanWin32FFM.C_CHAR.withName("log2_max_mv_length_horizontal"),
        VulkanWin32FFM.C_CHAR.withName("log2_max_mv_length_vertical"),
    ...
    private static final long aspect_ratio_idc$OFFSET = $LAYOUT.byteOffset(groupElement("aspect_ratio_idc"));
    ...
    private static final long sar_width$OFFSET = $LAYOUT.byteOffset(groupElement("sar_width"));
    ...
    private static final long sar_height$OFFSET = $LAYOUT.byteOffset(groupElement("sar_height"));
    ...
    private static final long video_format$OFFSET = $LAYOUT.byteOffset(groupElement("video_format"));
    ...
    private static final long colour_primaries$OFFSET = $LAYOUT.byteOffset(groupElement("colour_primaries"));
    ...
    private static final long matrix_coeffs$OFFSET = $LAYOUT.byteOffset(groupElement("matrix_coeffs"));
    ...
    private static final long chroma_sample_loc_type_top_field$OFFSET = $LAYOUT.byteOffset(groupElement("chroma_sample_loc_type_top_field"));
    ...
    private static final long chroma_sample_loc_type_bottom_field$OFFSET = $LAYOUT.byteOffset(groupElement("chroma_sample_loc_type_bottom_field"));
    ...
    private static final long def_disp_win_left_offset$OFFSET = $LAYOUT.byteOffset(groupElement("def_disp_win_left_offset"));
    ...
    private static final long def_disp_win_right_offset$OFFSET = $LAYOUT.byteOffset(groupElement("def_disp_win_right_offset"));
    ...
    private static final long def_disp_win_top_offset$OFFSET = $LAYOUT.byteOffset(groupElement("def_disp_win_top_offset"));
    ...
    private static final long def_disp_win_bottom_offset$OFFSET = $LAYOUT.byteOffset(groupElement("def_disp_win_bottom_offset"));
    ...
    private static final long vui_num_units_in_tick$OFFSET = $LAYOUT.byteOffset(groupElement("vui_num_units_in_tick"));
    ...
    private static final long vui_time_scale$OFFSET = $LAYOUT.byteOffset(groupElement("vui_time_scale"));
    ...
    private static final long vui_num_ticks_poc_diff_one_minus1$OFFSET = $LAYOUT.byteOffset(groupElement("vui_num_ticks_poc_diff_one_minus1"));
    ...
    private static final long min_spatial_segmentation_idc$OFFSET = $LAYOUT.byteOffset(groupElement("min_spatial_segmentation_idc"));
    ...
    private static final long max_bytes_per_pic_denom$OFFSET = $LAYOUT.byteOffset(groupElement("max_bytes_per_pic_denom"));
    ...
    private static final long max_bits_per_min_cu_denom$OFFSET = $LAYOUT.byteOffset(groupElement("max_bits_per_min_cu_denom"));
    ...
    private static final long log2_max_mv_length_horizontal$OFFSET = $LAYOUT.byteOffset(groupElement("log2_max_mv_length_horizontal"));
    ...
    private static final long log2_max_mv_length_vertical$OFFSET = $LAYOUT.byteOffset(groupElement("log2_max_mv_length_vertical"));
