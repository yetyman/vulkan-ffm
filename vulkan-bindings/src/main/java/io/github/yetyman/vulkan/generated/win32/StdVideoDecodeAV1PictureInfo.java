...
public class StdVideoDecodeAV1PictureInfo {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        ...
        MemoryLayout.sequenceLayout(2, VulkanWin32FFM.C_CHAR).withName("SkipModeFrame"),
        VulkanWin32FFM.C_CHAR.withName("coded_denom"),
        MemoryLayout.sequenceLayout(3, VulkanWin32FFM.C_CHAR).withName("reserved2"),
        MemoryLayout.sequenceLayout(8, VulkanWin32FFM.C_CHAR).withName("OrderHints"),
        MemoryLayout.sequenceLayout(8, VulkanWin32FFM.C_INT).withName("expectedFrameId"),
        ...
        VulkanWin32FFM.C_POINTER.withName("pFilmGrain")
    ...
    private static final long SkipModeFrame$OFFSET = $LAYOUT.byteOffset(groupElement("SkipModeFrame"));
    ...
    public static byte SkipModeFrame(MemorySegment struct, long index0) {
        return (byte)SkipModeFrame$ELEM_HANDLE.get(struct, SkipModeFrame$OFFSET, index0);
    }
    ...
    public static void SkipModeFrame(MemorySegment struct, long index0, byte fieldValue) {
        SkipModeFrame$ELEM_HANDLE.set(struct, SkipModeFrame$OFFSET, index0, fieldValue);
    }
    ...
    private static final long OrderHints$OFFSET = $LAYOUT.byteOffset(groupElement("OrderHints"));
    ...
    public static byte OrderHints(MemorySegment struct, long index0) {
        return (byte)OrderHints$ELEM_HANDLE.get(struct, OrderHints$OFFSET, index0);
    }
    ...
    public static void OrderHints(MemorySegment struct, long index0, byte fieldValue) {
        OrderHints$ELEM_HANDLE.set(struct, OrderHints$OFFSET, index0, fieldValue);
    }
    ...
    private static final long expectedFrameId$OFFSET = $LAYOUT.byteOffset(groupElement("expectedFrameId"));
    ...
    public static int expectedFrameId(MemorySegment struct, long index0) {
        return (int)expectedFrameId$ELEM_HANDLE.get(struct, expectedFrameId$OFFSET, index0);
    }
    ...
    public static void expectedFrameId(MemorySegment struct, long index0, int fieldValue) {
        expectedFrameId$ELEM_HANDLE.set(struct, expectedFrameId$OFFSET, index0, fieldValue);
    }
    ...
    private static final long pFilmGrain$OFFSET = $LAYOUT.byteOffset(groupElement("pFilmGrain"));
