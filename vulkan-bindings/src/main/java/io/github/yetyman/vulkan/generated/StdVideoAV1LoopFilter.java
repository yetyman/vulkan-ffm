...
public class StdVideoAV1LoopFilter {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        ...
        MemoryLayout.sequenceLayout(4, VulkanFFM.C_CHAR).withName("loop_filter_level"),
        VulkanFFM.C_CHAR.withName("loop_filter_sharpness"),
        VulkanFFM.C_CHAR.withName("update_ref_delta"),
        MemoryLayout.sequenceLayout(8, VulkanFFM.C_CHAR).withName("loop_filter_ref_deltas"),
