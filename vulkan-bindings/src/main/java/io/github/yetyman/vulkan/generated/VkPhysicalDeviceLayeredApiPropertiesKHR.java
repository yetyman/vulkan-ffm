...
public class VkPhysicalDeviceLayeredApiPropertiesKHR {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        ...
        VulkanFFM.C_INT.withName("vendorID"),
        VulkanFFM.C_INT.withName("deviceID"),
        VulkanFFM.C_INT.withName("layeredAPI"),
        MemoryLayout.sequenceLayout(256, VulkanFFM.C_CHAR).withName("deviceName"),
        MemoryLayout.paddingLayout(4)
