...
public record VkExternalMemoryFeatureFlagBits(int value) {
    ...
    public static final VkExternalMemoryFeatureFlagBits VK_EXTERNAL_MEMORY_FEATURE_DEDICATED_ONLY_BIT_KHR = new VkExternalMemoryFeatureFlagBits(1);
    ...
    public static final VkExternalMemoryFeatureFlagBits VK_EXTERNAL_MEMORY_FEATURE_EXPORTABLE_BIT_KHR = new VkExternalMemoryFeatureFlagBits(2);
    ...
    public static final VkExternalMemoryFeatureFlagBits VK_EXTERNAL_MEMORY_FEATURE_IMPORTABLE_BIT_KHR = new VkExternalMemoryFeatureFlagBits(4);
