...
public class _IMAGE_FUNCTION_ENTRY64 {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        VulkanWin32FFM.align(VulkanWin32FFM.C_LONG_LONG, 4).withName("StartingAddress"),
        VulkanWin32FFM.align(VulkanWin32FFM.C_LONG_LONG, 4).withName("EndingAddress"),
        MemoryLayout.unionLayout(
            VulkanWin32FFM.align(VulkanWin32FFM.C_LONG_LONG, 4).withName("EndOfPrologue"),
            VulkanWin32FFM.align(VulkanWin32FFM.C_LONG_LONG, 4).withName("UnwindInfoAddress")
        ).withName("$anon$20470:5")
    ...
    private static final OfLong EndOfPrologue$LAYOUT = (OfLong)$LAYOUT.select(groupElement("$anon$20470:5"), groupElement("EndOfPrologue"));
    ...
    private static final long EndOfPrologue$OFFSET = $LAYOUT.byteOffset(groupElement("$anon$20470:5"), groupElement("EndOfPrologue"));
    ...
    private static final OfLong UnwindInfoAddress$LAYOUT = (OfLong)$LAYOUT.select(groupElement("$anon$20470:5"), groupElement("UnwindInfoAddress"));
    ...
    private static final long UnwindInfoAddress$OFFSET = $LAYOUT.byteOffset(groupElement("$anon$20470:5"), groupElement("UnwindInfoAddress"));
