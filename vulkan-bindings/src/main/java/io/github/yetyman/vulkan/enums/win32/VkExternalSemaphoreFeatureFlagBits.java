...
public record VkExternalSemaphoreFeatureFlagBits(int value) {
    ...
    public static final VkExternalSemaphoreFeatureFlagBits VK_EXTERNAL_SEMAPHORE_FEATURE_EXPORTABLE_BIT_KHR = new VkExternalSemaphoreFeatureFlagBits(1);
    ...
    public static final VkExternalSemaphoreFeatureFlagBits VK_EXTERNAL_SEMAPHORE_FEATURE_IMPORTABLE_BIT_KHR = new VkExternalSemaphoreFeatureFlagBits(2);
