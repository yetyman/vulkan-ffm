...
public class _PROCESS_MITIGATION_CONTROL_FLOW_GUARD_POLICY {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        MemoryLayout.unionLayout(
            ...
            ).withName("$anon$12637:9")
        ).withName("$anon$12635:5")
    ...
    private static final OfInt Flags$LAYOUT = (OfInt)$LAYOUT.select(groupElement("$anon$12635:5"), groupElement("Flags"));
    ...
    private static final long Flags$OFFSET = $LAYOUT.byteOffset(groupElement("$anon$12635:5"), groupElement("Flags"));
