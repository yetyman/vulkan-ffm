...
public class _SYSTEM_CPU_SET_INFORMATION {
    ...
    public static class CpuSet {
        ...
        private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
            VulkanWin32FFM.C_LONG.withName("Id"),
            VulkanWin32FFM.C_SHORT.withName("Group"),
            VulkanWin32FFM.C_CHAR.withName("LogicalProcessorIndex"),
            VulkanWin32FFM.C_CHAR.withName("CoreIndex"),
            VulkanWin32FFM.C_CHAR.withName("LastLevelCacheIndex"),
            VulkanWin32FFM.C_CHAR.withName("NumaNodeIndex"),
            VulkanWin32FFM.C_CHAR.withName("EfficiencyClass"),
            MemoryLayout.unionLayout(
                VulkanWin32FFM.C_CHAR.withName("AllFlags"),
                MemoryLayout.structLayout(
                    MemoryLayout.paddingLayout(1)
                ).withName("$anon$13582:17")
            ).withName("$anon$13574:13"),
            MemoryLayout.unionLayout(
                VulkanWin32FFM.C_LONG.withName("Reserved"),
                VulkanWin32FFM.C_CHAR.withName("SchedulingClass")
            ).withName("$anon$13591:13"),
            VulkanWin32FFM.C_LONG_LONG.withName("AllocationTag")
        ).withName("$anon$13566:9");
        ...
        private static final OfByte AllFlags$LAYOUT = (OfByte)$LAYOUT.select(groupElement("$anon$13574:13"), groupElement("AllFlags"));
        ...
        private static final long AllFlags$OFFSET = $LAYOUT.byteOffset(groupElement("$anon$13574:13"), groupElement("AllFlags"));
        ...
        private static final OfInt Reserved$LAYOUT = (OfInt)$LAYOUT.select(groupElement("$anon$13591:13"), groupElement("Reserved"));
        ...
        private static final long Reserved$OFFSET = $LAYOUT.byteOffset(groupElement("$anon$13591:13"), groupElement("Reserved"));
        ...
        private static final OfByte SchedulingClass$LAYOUT = (OfByte)$LAYOUT.select(groupElement("$anon$13591:13"), groupElement("SchedulingClass"));
        ...
        private static final long SchedulingClass$OFFSET = $LAYOUT.byteOffset(groupElement("$anon$13591:13"), groupElement("SchedulingClass"));
    ...
    private static final GroupLayout CpuSet$LAYOUT = (GroupLayout)$LAYOUT.select(groupElement("$anon$13565:5"), groupElement("CpuSet"));
    ...
    private static final long CpuSet$OFFSET = $LAYOUT.byteOffset(groupElement("$anon$13565:5"), groupElement("CpuSet"));
