...
/**
 * Constants for VkVideoEncodeH265RateControlFlagBitsKHR
 * Generated from jextract bindings
 */
public final class VkVideoEncodeH265RateControlFlagBitsKHR {
    private VkVideoEncodeH265RateControlFlagBitsKHR() {}

    public static final int VK_VIDEO_ENCODE_H265_RATE_CONTROL_ATTEMPT_HRD_COMPLIANCE_BIT_KHR = 1;
    public static final int VK_VIDEO_ENCODE_H265_RATE_CONTROL_FLAG_BITS_MAX_ENUM_KHR = 2147483647;
