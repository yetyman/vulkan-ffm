...
public class _ULARGE_INTEGER {
    ...
    private static final long LowPart$OFFSET = $LAYOUT.byteOffset(groupElement("$anon$895:5"), groupElement("LowPart"));
    ...
    private static final long HighPart$OFFSET = $LAYOUT.byteOffset(groupElement("$anon$895:5"), groupElement("HighPart"));
