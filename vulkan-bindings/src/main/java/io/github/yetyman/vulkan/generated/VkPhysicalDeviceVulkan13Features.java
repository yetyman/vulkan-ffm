...
public class VkPhysicalDeviceVulkan13Features {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        ...
        VulkanFFM.C_INT.withName("robustImageAccess"),
        VulkanFFM.C_INT.withName("inlineUniformBlock"),
        VulkanFFM.C_INT.withName("descriptorBindingInlineUniformBlockUpdateAfterBind"),
        VulkanFFM.C_INT.withName("pipelineCreationCacheControl"),
        VulkanFFM.C_INT.withName("privateData"),
        VulkanFFM.C_INT.withName("shaderDemoteToHelperInvocation"),
        VulkanFFM.C_INT.withName("shaderTerminateInvocation"),
        VulkanFFM.C_INT.withName("subgroupSizeControl"),
        VulkanFFM.C_INT.withName("computeFullSubgroups"),
        VulkanFFM.C_INT.withName("synchronization2"),
        VulkanFFM.C_INT.withName("textureCompressionASTC_HDR"),
        VulkanFFM.C_INT.withName("shaderZeroInitializeWorkgroupMemory"),
        VulkanFFM.C_INT.withName("dynamicRendering"),
        VulkanFFM.C_INT.withName("shaderIntegerDotProduct"),
        VulkanFFM.C_INT.withName("maintenance4"),
        MemoryLayout.paddingLayout(4)
