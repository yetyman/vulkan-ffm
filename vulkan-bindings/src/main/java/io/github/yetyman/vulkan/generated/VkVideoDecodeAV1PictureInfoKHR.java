...
public class VkVideoDecodeAV1PictureInfoKHR {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        ...
        VulkanFFM.C_INT.withName("frameHeaderOffset"),
        VulkanFFM.C_INT.withName("tileCount"),
        MemoryLayout.paddingLayout(4),
        VulkanFFM.C_POINTER.withName("pTileOffsets"),
        VulkanFFM.C_POINTER.withName("pTileSizes")
