...
public class VkVideoInlineQueryInfoKHR {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        ...
        VulkanWin32FFM.C_POINTER.withName("queryPool"),
        VulkanWin32FFM.C_INT.withName("firstQuery"),
    ...
    private static final long queryPool$OFFSET = $LAYOUT.byteOffset(groupElement("queryPool"));
    ...
    private static final long firstQuery$OFFSET = $LAYOUT.byteOffset(groupElement("firstQuery"));
