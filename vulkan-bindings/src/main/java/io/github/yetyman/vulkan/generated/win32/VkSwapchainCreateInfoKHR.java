...
public class VkSwapchainCreateInfoKHR {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        ...
        MemoryLayout.paddingLayout(4),
        VulkanWin32FFM.C_POINTER.withName("surface"),
        VulkanWin32FFM.C_INT.withName("minImageCount"),
        VulkanWin32FFM.C_INT.withName("imageFormat"),
        VulkanWin32FFM.C_INT.withName("imageColorSpace"),
        VkExtent2D.layout().withName("imageExtent"),
        VulkanWin32FFM.C_INT.withName("imageArrayLayers"),
        VulkanWin32FFM.C_INT.withName("imageUsage"),
        VulkanWin32FFM.C_INT.withName("imageSharingMode"),
        VulkanWin32FFM.C_INT.withName("queueFamilyIndexCount"),
        MemoryLayout.paddingLayout(4),
        VulkanWin32FFM.C_POINTER.withName("pQueueFamilyIndices"),
        VulkanWin32FFM.C_INT.withName("preTransform"),
        VulkanWin32FFM.C_INT.withName("compositeAlpha"),
        VulkanWin32FFM.C_INT.withName("presentMode"),
        VulkanWin32FFM.C_INT.withName("clipped"),
        VulkanWin32FFM.C_POINTER.withName("oldSwapchain")
