...
public class _WIN32_STREAM_ID {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        VulkanWin32FFM.C_LONG.withName("dwStreamId"),
        VulkanWin32FFM.C_LONG.withName("dwStreamAttributes"),
        _LARGE_INTEGER.layout().withName("Size"),
        VulkanWin32FFM.C_LONG.withName("dwStreamNameSize"),
        MemoryLayout.sequenceLayout(1, VulkanWin32FFM.C_SHORT).withName("cStreamName"),
