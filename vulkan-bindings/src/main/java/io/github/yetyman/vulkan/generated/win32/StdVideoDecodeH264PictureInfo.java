...
public class StdVideoDecodeH264PictureInfo {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        ...
        VulkanWin32FFM.C_SHORT.withName("frame_num"),
        VulkanWin32FFM.C_SHORT.withName("idr_pic_id"),
        MemoryLayout.sequenceLayout(2, VulkanWin32FFM.C_INT).withName("PicOrderCnt")
    ...
    public static int PicOrderCnt(MemorySegment struct, long index0) {
        return (int)PicOrderCnt$ELEM_HANDLE.get(struct, PicOrderCnt$OFFSET, index0);
    }
    ...
    public static void PicOrderCnt(MemorySegment struct, long index0, int fieldValue) {
        PicOrderCnt$ELEM_HANDLE.set(struct, PicOrderCnt$OFFSET, index0, fieldValue);
    }
