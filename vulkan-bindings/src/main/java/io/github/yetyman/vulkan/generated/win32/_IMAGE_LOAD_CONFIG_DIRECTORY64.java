...
public class _IMAGE_LOAD_CONFIG_DIRECTORY64 {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        ...
        VulkanWin32FFM.align(VulkanWin32FFM.C_LONG_LONG, 4).withName("DeCommitFreeBlockThreshold"),
        VulkanWin32FFM.align(VulkanWin32FFM.C_LONG_LONG, 4).withName("DeCommitTotalFreeThreshold"),
        VulkanWin32FFM.align(VulkanWin32FFM.C_LONG_LONG, 4).withName("LockPrefixTable"),
        VulkanWin32FFM.align(VulkanWin32FFM.C_LONG_LONG, 4).withName("MaximumAllocationSize"),
        VulkanWin32FFM.align(VulkanWin32FFM.C_LONG_LONG, 4).withName("VirtualMemoryThreshold"),
        VulkanWin32FFM.align(VulkanWin32FFM.C_LONG_LONG, 4).withName("ProcessAffinityMask"),
        ...
        VulkanWin32FFM.align(VulkanWin32FFM.C_LONG_LONG, 4).withName("EditList"),
        VulkanWin32FFM.align(VulkanWin32FFM.C_LONG_LONG, 4).withName("SecurityCookie"),
        VulkanWin32FFM.align(VulkanWin32FFM.C_LONG_LONG, 4).withName("SEHandlerTable"),
        VulkanWin32FFM.align(VulkanWin32FFM.C_LONG_LONG, 4).withName("SEHandlerCount"),
        VulkanWin32FFM.align(VulkanWin32FFM.C_LONG_LONG, 4).withName("GuardCFCheckFunctionPointer"),
        VulkanWin32FFM.align(VulkanWin32FFM.C_LONG_LONG, 4).withName("GuardCFDispatchFunctionPointer"),
        VulkanWin32FFM.align(VulkanWin32FFM.C_LONG_LONG, 4).withName("GuardCFFunctionTable"),
        VulkanWin32FFM.align(VulkanWin32FFM.C_LONG_LONG, 4).withName("GuardCFFunctionCount"),
        VulkanWin32FFM.C_LONG.withName("GuardFlags"),
        _IMAGE_LOAD_CONFIG_CODE_INTEGRITY.layout().withName("CodeIntegrity"),
        VulkanWin32FFM.align(VulkanWin32FFM.C_LONG_LONG, 4).withName("GuardAddressTakenIatEntryTable"),
        VulkanWin32FFM.align(VulkanWin32FFM.C_LONG_LONG, 4).withName("GuardAddressTakenIatEntryCount"),
        VulkanWin32FFM.align(VulkanWin32FFM.C_LONG_LONG, 4).withName("GuardLongJumpTargetTable"),
        VulkanWin32FFM.align(VulkanWin32FFM.C_LONG_LONG, 4).withName("GuardLongJumpTargetCount"),
        VulkanWin32FFM.align(VulkanWin32FFM.C_LONG_LONG, 4).withName("DynamicValueRelocTable"),
        VulkanWin32FFM.align(VulkanWin32FFM.C_LONG_LONG, 4).withName("CHPEMetadataPointer"),
        VulkanWin32FFM.align(VulkanWin32FFM.C_LONG_LONG, 4).withName("GuardRFFailureRoutine"),
        VulkanWin32FFM.align(VulkanWin32FFM.C_LONG_LONG, 4).withName("GuardRFFailureRoutineFunctionPointer"),
        ...
        VulkanWin32FFM.align(VulkanWin32FFM.C_LONG_LONG, 4).withName("GuardRFVerifyStackPointerFunctionPointer"),
        VulkanWin32FFM.C_LONG.withName("HotPatchTableOffset"),
        VulkanWin32FFM.C_LONG.withName("Reserved3"),
        VulkanWin32FFM.align(VulkanWin32FFM.C_LONG_LONG, 4).withName("EnclaveConfigurationPointer"),
        VulkanWin32FFM.align(VulkanWin32FFM.C_LONG_LONG, 4).withName("VolatileMetadataPointer"),
        VulkanWin32FFM.align(VulkanWin32FFM.C_LONG_LONG, 4).withName("GuardEHContinuationTable"),
        VulkanWin32FFM.align(VulkanWin32FFM.C_LONG_LONG, 4).withName("GuardEHContinuationCount"),
        VulkanWin32FFM.align(VulkanWin32FFM.C_LONG_LONG, 4).withName("GuardXFGCheckFunctionPointer"),
        VulkanWin32FFM.align(VulkanWin32FFM.C_LONG_LONG, 4).withName("GuardXFGDispatchFunctionPointer"),
        VulkanWin32FFM.align(VulkanWin32FFM.C_LONG_LONG, 4).withName("GuardXFGTableDispatchFunctionPointer"),
        VulkanWin32FFM.align(VulkanWin32FFM.C_LONG_LONG, 4).withName("CastGuardOsDeterminedFailureMode"),
        VulkanWin32FFM.align(VulkanWin32FFM.C_LONG_LONG, 4).withName("GuardMemcpyFunctionPointer")
