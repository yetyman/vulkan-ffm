...
public class _UMS_SYSTEM_THREAD_INFORMATION {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        VulkanWin32FFM.C_LONG.withName("UmsVersion"),
        MemoryLayout.unionLayout(
            MemoryLayout.structLayout(
                MemoryLayout.paddingLayout(4)
            ).withName("$anon$1615:9"),
            VulkanWin32FFM.C_LONG.withName("ThreadUmsFlags")
        ).withName("$anon$1614:5")
    ...
    private static final OfInt ThreadUmsFlags$LAYOUT = (OfInt)$LAYOUT.select(groupElement("$anon$1614:5"), groupElement("ThreadUmsFlags"));
    ...
    private static final long ThreadUmsFlags$OFFSET = $LAYOUT.byteOffset(groupElement("$anon$1614:5"), groupElement("ThreadUmsFlags"));
