...
public class VkPipelineColorBlendAttachmentState {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        VulkanFFM.C_INT.withName("blendEnable"),
        VulkanFFM.C_INT.withName("srcColorBlendFactor"),
        VulkanFFM.C_INT.withName("dstColorBlendFactor"),
        VulkanFFM.C_INT.withName("colorBlendOp"),
        VulkanFFM.C_INT.withName("srcAlphaBlendFactor"),
        VulkanFFM.C_INT.withName("dstAlphaBlendFactor"),
        VulkanFFM.C_INT.withName("alphaBlendOp"),
        VulkanFFM.C_INT.withName("colorWriteMask")
