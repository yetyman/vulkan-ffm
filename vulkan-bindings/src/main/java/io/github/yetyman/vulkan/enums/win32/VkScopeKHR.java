...
public record VkScopeKHR(int value) {
    ...
    public static final VkScopeKHR VK_SCOPE_DEVICE_NV = new VkScopeKHR(1);
    ...
    public static final VkScopeKHR VK_SCOPE_QUEUE_FAMILY_NV = new VkScopeKHR(5);
    public static final VkScopeKHR VK_SCOPE_SUBGROUP_KHR = new VkScopeKHR(3);
    public static final VkScopeKHR VK_SCOPE_SUBGROUP_NV = new VkScopeKHR(3);
    public static final VkScopeKHR VK_SCOPE_WORKGROUP_KHR = new VkScopeKHR(2);
    public static final VkScopeKHR VK_SCOPE_WORKGROUP_NV = new VkScopeKHR(2);
