...
public class VkPipelineDepthStencilStateCreateInfo {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        ...
        VulkanFFM.C_INT.withName("depthTestEnable"),
        VulkanFFM.C_INT.withName("depthWriteEnable"),
        VulkanFFM.C_INT.withName("depthCompareOp"),
        VulkanFFM.C_INT.withName("depthBoundsTestEnable"),
        VulkanFFM.C_INT.withName("stencilTestEnable"),
        VkStencilOpState.layout().withName("front"),
        VkStencilOpState.layout().withName("back"),
        VulkanFFM.C_FLOAT.withName("minDepthBounds"),
        VulkanFFM.C_FLOAT.withName("maxDepthBounds")
