...
public class StdVideoAV1LoopRestoration {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        MemoryLayout.sequenceLayout(3, VulkanWin32FFM.C_INT).withName("FrameRestorationType"),
        MemoryLayout.sequenceLayout(3, VulkanWin32FFM.C_SHORT).withName("LoopRestorationSize"),
