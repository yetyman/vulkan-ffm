...
/**
 * {@snippet lang=c :
 * typedef VkResult (*PFN_vkBindOpticalFlowSessionImageNV)(VkDevice, VkOpticalFlowSessionNV, VkOpticalFlowSessionBindingPointNV, VkImageView, VkImageLayout) __attribute__((stdcall))
 * }
 */
public final class PFN_vkBindOpticalFlowSessionImageNV {

    private PFN_vkBindOpticalFlowSessionImageNV() {
    ...
    private static final MethodHandle UP$MH = VulkanWin32FFM.upcallHandle(PFN_vkBindOpticalFlowSessionImageNV.Function.class, "apply", $DESC);
