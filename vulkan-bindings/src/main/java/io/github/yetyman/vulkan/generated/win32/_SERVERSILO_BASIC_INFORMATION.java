...
public class _SERVERSILO_BASIC_INFORMATION {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        VulkanWin32FFM.C_LONG.withName("ServiceSessionId"),
        VulkanWin32FFM.C_INT.withName("State"),
        VulkanWin32FFM.C_LONG.withName("ExitStatus"),
        VulkanWin32FFM.C_CHAR.withName("IsDownlevelContainer"),
        MemoryLayout.paddingLayout(3),
        VulkanWin32FFM.C_POINTER.withName("ApiSetSchema"),
        VulkanWin32FFM.C_POINTER.withName("HostApiSetSchema")
    ...
    private static final long IsDownlevelContainer$OFFSET = $LAYOUT.byteOffset(groupElement("IsDownlevelContainer"));
