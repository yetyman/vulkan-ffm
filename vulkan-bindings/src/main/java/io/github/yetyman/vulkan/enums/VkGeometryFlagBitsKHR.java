...
public record VkGeometryFlagBitsKHR(int value) {
    ...
    public static final VkGeometryFlagBitsKHR VK_GEOMETRY_NO_DUPLICATE_ANY_HIT_INVOCATION_BIT_NV = VK_GEOMETRY_NO_DUPLICATE_ANY_HIT_INVOCATION_BIT_KHR;
    public static final VkGeometryFlagBitsKHR VK_GEOMETRY_OPAQUE_BIT_KHR = new VkGeometryFlagBitsKHR(1);
    public static final VkGeometryFlagBitsKHR VK_GEOMETRY_OPAQUE_BIT_NV = VK_GEOMETRY_OPAQUE_BIT_KHR;
