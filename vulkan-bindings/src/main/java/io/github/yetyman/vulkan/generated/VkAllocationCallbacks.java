...
public class VkAllocationCallbacks {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        VulkanFFM.C_POINTER.withName("pUserData"),
        VulkanFFM.C_POINTER.withName("pfnAllocation"),
        VulkanFFM.C_POINTER.withName("pfnReallocation"),
        VulkanFFM.C_POINTER.withName("pfnFree"),
        VulkanFFM.C_POINTER.withName("pfnInternalAllocation"),
        VulkanFFM.C_POINTER.withName("pfnInternalFree")
