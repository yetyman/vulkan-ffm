...
public class VkPhysicalDeviceDescriptorBufferPropertiesEXT {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        ...
        VulkanFFM.C_INT.withName("combinedImageSamplerDescriptorSingleArray"),
        VulkanFFM.C_INT.withName("bufferlessPushDescriptors"),
        VulkanFFM.C_INT.withName("allowSamplerImageViewPostSubmitCreation"),
        MemoryLayout.paddingLayout(4),
        VulkanFFM.C_LONG_LONG.withName("descriptorBufferOffsetAlignment"),
        VulkanFFM.C_INT.withName("maxDescriptorBufferBindings"),
        VulkanFFM.C_INT.withName("maxResourceDescriptorBufferBindings"),
        VulkanFFM.C_INT.withName("maxSamplerDescriptorBufferBindings"),
        VulkanFFM.C_INT.withName("maxEmbeddedImmutableSamplerBindings"),
        VulkanFFM.C_INT.withName("maxEmbeddedImmutableSamplers"),
        MemoryLayout.paddingLayout(4),
        VulkanFFM.C_LONG_LONG.withName("bufferCaptureReplayDescriptorDataSize"),
        VulkanFFM.C_LONG_LONG.withName("imageCaptureReplayDescriptorDataSize"),
        VulkanFFM.C_LONG_LONG.withName("imageViewCaptureReplayDescriptorDataSize"),
        VulkanFFM.C_LONG_LONG.withName("samplerCaptureReplayDescriptorDataSize"),
        VulkanFFM.C_LONG_LONG.withName("accelerationStructureCaptureReplayDescriptorDataSize"),
        VulkanFFM.C_LONG_LONG.withName("samplerDescriptorSize"),
        VulkanFFM.C_LONG_LONG.withName("combinedImageSamplerDescriptorSize"),
        VulkanFFM.C_LONG_LONG.withName("sampledImageDescriptorSize"),
        VulkanFFM.C_LONG_LONG.withName("storageImageDescriptorSize"),
        VulkanFFM.C_LONG_LONG.withName("uniformTexelBufferDescriptorSize"),
        VulkanFFM.C_LONG_LONG.withName("robustUniformTexelBufferDescriptorSize"),
        VulkanFFM.C_LONG_LONG.withName("storageTexelBufferDescriptorSize"),
        VulkanFFM.C_LONG_LONG.withName("robustStorageTexelBufferDescriptorSize"),
        VulkanFFM.C_LONG_LONG.withName("uniformBufferDescriptorSize"),
        VulkanFFM.C_LONG_LONG.withName("robustUniformBufferDescriptorSize"),
        VulkanFFM.C_LONG_LONG.withName("storageBufferDescriptorSize"),
        VulkanFFM.C_LONG_LONG.withName("robustStorageBufferDescriptorSize"),
        VulkanFFM.C_LONG_LONG.withName("inputAttachmentDescriptorSize"),
        VulkanFFM.C_LONG_LONG.withName("accelerationStructureDescriptorSize"),
        VulkanFFM.C_LONG_LONG.withName("maxSamplerDescriptorBufferRange"),
        VulkanFFM.C_LONG_LONG.withName("maxResourceDescriptorBufferRange"),
        VulkanFFM.C_LONG_LONG.withName("samplerDescriptorBufferAddressSpaceSize"),
        VulkanFFM.C_LONG_LONG.withName("resourceDescriptorBufferAddressSpaceSize"),
        VulkanFFM.C_LONG_LONG.withName("descriptorBufferAddressSpaceSize")
