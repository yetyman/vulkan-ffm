...
public record VkResolveModeFlagBits(int value) {
    ...
    public static final VkResolveModeFlagBits VK_RESOLVE_MODE_AVERAGE_BIT_KHR = VK_RESOLVE_MODE_AVERAGE_BIT;
    ...
    public static final VkResolveModeFlagBits VK_RESOLVE_MODE_EXTERNAL_FORMAT_DOWNSAMPLE_BIT_ANDROID = VK_RESOLVE_MODE_EXTERNAL_FORMAT_DOWNSAMPLE_ANDROID;
    ...
    public static final VkResolveModeFlagBits VK_RESOLVE_MODE_MAX_BIT_KHR = VK_RESOLVE_MODE_MAX_BIT;
    public static final VkResolveModeFlagBits VK_RESOLVE_MODE_MIN_BIT = new VkResolveModeFlagBits(4);
    public static final VkResolveModeFlagBits VK_RESOLVE_MODE_MIN_BIT_KHR = VK_RESOLVE_MODE_MIN_BIT;
    public static final VkResolveModeFlagBits VK_RESOLVE_MODE_NONE = new VkResolveModeFlagBits(0);
    public static final VkResolveModeFlagBits VK_RESOLVE_MODE_NONE_KHR = VK_RESOLVE_MODE_NONE;
    public static final VkResolveModeFlagBits VK_RESOLVE_MODE_SAMPLE_ZERO_BIT = new VkResolveModeFlagBits(1);
    public static final VkResolveModeFlagBits VK_RESOLVE_MODE_SAMPLE_ZERO_BIT_KHR = VK_RESOLVE_MODE_SAMPLE_ZERO_BIT;
