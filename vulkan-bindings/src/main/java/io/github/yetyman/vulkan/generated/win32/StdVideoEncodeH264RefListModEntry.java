...
public class StdVideoEncodeH264RefListModEntry {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        VulkanWin32FFM.C_INT.withName("modification_of_pic_nums_idc"),
        VulkanWin32FFM.C_SHORT.withName("abs_diff_pic_num_minus1"),
    ...
    private static final long modification_of_pic_nums_idc$OFFSET = $LAYOUT.byteOffset(groupElement("modification_of_pic_nums_idc"));
    ...
    private static final long abs_diff_pic_num_minus1$OFFSET = $LAYOUT.byteOffset(groupElement("abs_diff_pic_num_minus1"));
