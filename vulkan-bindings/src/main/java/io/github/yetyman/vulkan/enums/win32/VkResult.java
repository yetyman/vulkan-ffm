...
public record VkResult(int value) {
    ...
    public static final VkResult VK_ERROR_FRAGMENTATION_EXT = new VkResult(-1000161000);
    ...
    public static final VkResult VK_ERROR_INVALID_EXTERNAL_HANDLE_KHR = new VkResult(-1000072003);
    public static final VkResult VK_ERROR_INVALID_OPAQUE_CAPTURE_ADDRESS = new VkResult(-1000257000);
    public static final VkResult VK_ERROR_INVALID_OPAQUE_CAPTURE_ADDRESS_KHR = new VkResult(-1000257000);
    ...
    public static final VkResult VK_ERROR_NOT_PERMITTED_EXT = new VkResult(-1000174001);
    public static final VkResult VK_ERROR_NOT_PERMITTED_KHR = new VkResult(-1000174001);
    ...
    public static final VkResult VK_ERROR_OUT_OF_POOL_MEMORY_KHR = new VkResult(-1000069000);
    ...
    public static final VkResult VK_ERROR_VALIDATION_FAILED_EXT = new VkResult(-1000011001);
    ...
    public static final VkResult VK_INCOMPATIBLE_SHADER_BINARY_EXT = new VkResult(1000482000);
    ...
    public static final VkResult VK_PIPELINE_COMPILE_REQUIRED = new VkResult(1000297000);
    public static final VkResult VK_PIPELINE_COMPILE_REQUIRED_EXT = new VkResult(1000297000);
