...
public record VkGeometryTypeKHR(int value) {
    ...
    public static final VkGeometryTypeKHR VK_GEOMETRY_TYPE_AABBS_NV = VK_GEOMETRY_TYPE_AABBS_KHR;
    ...
    public static final VkGeometryTypeKHR VK_GEOMETRY_TYPE_TRIANGLES_NV = VK_GEOMETRY_TYPE_TRIANGLES_KHR;
