...
public class _IMAGE_IMPORT_DESCRIPTOR {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        MemoryLayout.unionLayout(
            VulkanWin32FFM.C_LONG.withName("Characteristics"),
            VulkanWin32FFM.C_LONG.withName("OriginalFirstThunk")
        ).withName("$anon$19638:5"),
        VulkanWin32FFM.C_LONG.withName("TimeDateStamp"),
        VulkanWin32FFM.C_LONG.withName("ForwarderChain"),
        VulkanWin32FFM.C_LONG.withName("Name"),
        VulkanWin32FFM.C_LONG.withName("FirstThunk")
    ...
    private static final OfInt Characteristics$LAYOUT = (OfInt)$LAYOUT.select(groupElement("$anon$19638:5"), groupElement("Characteristics"));
    ...
    private static final long Characteristics$OFFSET = $LAYOUT.byteOffset(groupElement("$anon$19638:5"), groupElement("Characteristics"));
    ...
    private static final OfInt OriginalFirstThunk$LAYOUT = (OfInt)$LAYOUT.select(groupElement("$anon$19638:5"), groupElement("OriginalFirstThunk"));
    ...
    private static final long OriginalFirstThunk$OFFSET = $LAYOUT.byteOffset(groupElement("$anon$19638:5"), groupElement("OriginalFirstThunk"));
