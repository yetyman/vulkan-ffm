...
public class VkPipelineExecutableStatisticValueKHR {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.unionLayout(
        VulkanWin32FFM.C_INT.withName("b32"),
        VulkanWin32FFM.C_LONG_LONG.withName("i64"),
        VulkanWin32FFM.C_LONG_LONG.withName("u64"),
        VulkanWin32FFM.C_DOUBLE.withName("f64")
    ...
    private static final long b32$OFFSET = $LAYOUT.byteOffset(groupElement("b32"));
