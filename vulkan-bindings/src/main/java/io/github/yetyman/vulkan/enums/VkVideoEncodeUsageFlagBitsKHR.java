...
/**
 * Constants for VkVideoEncodeUsageFlagBitsKHR
 * Generated from jextract bindings
 */
public final class VkVideoEncodeUsageFlagBitsKHR {
    private VkVideoEncodeUsageFlagBitsKHR() {}
    ...
    public static final int VK_VIDEO_ENCODE_USAGE_FLAG_BITS_MAX_ENUM_KHR = 2147483647;
