...
public class StdVideoEncodeH265WeightTable {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        ...
        VulkanWin32FFM.C_CHAR.withName("luma_log2_weight_denom"),
        VulkanWin32FFM.C_CHAR.withName("delta_chroma_log2_weight_denom"),
        MemoryLayout.sequenceLayout(15, VulkanWin32FFM.C_CHAR).withName("delta_luma_weight_l0"),
        MemoryLayout.sequenceLayout(15, VulkanWin32FFM.C_CHAR).withName("luma_offset_l0"),
        MemoryLayout.sequenceLayout(15, MemoryLayout.sequenceLayout(2, VulkanWin32FFM.C_CHAR)).withName("delta_chroma_weight_l0"),
        MemoryLayout.sequenceLayout(15, MemoryLayout.sequenceLayout(2, VulkanWin32FFM.C_CHAR)).withName("delta_chroma_offset_l0"),
        MemoryLayout.sequenceLayout(15, VulkanWin32FFM.C_CHAR).withName("delta_luma_weight_l1"),
        MemoryLayout.sequenceLayout(15, VulkanWin32FFM.C_CHAR).withName("luma_offset_l1"),
        MemoryLayout.sequenceLayout(15, MemoryLayout.sequenceLayout(2, VulkanWin32FFM.C_CHAR)).withName("delta_chroma_weight_l1"),
        MemoryLayout.sequenceLayout(15, MemoryLayout.sequenceLayout(2, VulkanWin32FFM.C_CHAR)).withName("delta_chroma_offset_l1")
    ...
    private static final long luma_log2_weight_denom$OFFSET = $LAYOUT.byteOffset(groupElement("luma_log2_weight_denom"));
    ...
    private static final long delta_chroma_log2_weight_denom$OFFSET = $LAYOUT.byteOffset(groupElement("delta_chroma_log2_weight_denom"));
    ...
    private static final long delta_luma_weight_l0$OFFSET = $LAYOUT.byteOffset(groupElement("delta_luma_weight_l0"));
    ...
    public static byte delta_luma_weight_l0(MemorySegment struct, long index0) {
        return (byte)delta_luma_weight_l0$ELEM_HANDLE.get(struct, delta_luma_weight_l0$OFFSET, index0);
    }
    ...
    public static void delta_luma_weight_l0(MemorySegment struct, long index0, byte fieldValue) {
        delta_luma_weight_l0$ELEM_HANDLE.set(struct, delta_luma_weight_l0$OFFSET, index0, fieldValue);
    }
    ...
    private static final long luma_offset_l0$OFFSET = $LAYOUT.byteOffset(groupElement("luma_offset_l0"));
    ...
    public static byte luma_offset_l0(MemorySegment struct, long index0) {
        return (byte)luma_offset_l0$ELEM_HANDLE.get(struct, luma_offset_l0$OFFSET, index0);
    }
    ...
    public static void luma_offset_l0(MemorySegment struct, long index0, byte fieldValue) {
        luma_offset_l0$ELEM_HANDLE.set(struct, luma_offset_l0$OFFSET, index0, fieldValue);
    }
    ...
    private static final long delta_chroma_weight_l0$OFFSET = $LAYOUT.byteOffset(groupElement("delta_chroma_weight_l0"));
    ...
    public static byte delta_chroma_weight_l0(MemorySegment struct, long index0, long index1) {
        return (byte)delta_chroma_weight_l0$ELEM_HANDLE.get(struct, delta_chroma_weight_l0$OFFSET, index0, index1);
    }
    ...
    public static void delta_chroma_weight_l0(MemorySegment struct, long index0, long index1, byte fieldValue) {
        delta_chroma_weight_l0$ELEM_HANDLE.set(struct, delta_chroma_weight_l0$OFFSET, index0, index1, fieldValue);
    }
    ...
    private static final long delta_chroma_offset_l0$OFFSET = $LAYOUT.byteOffset(groupElement("delta_chroma_offset_l0"));
    ...
    public static byte delta_chroma_offset_l0(MemorySegment struct, long index0, long index1) {
        return (byte)delta_chroma_offset_l0$ELEM_HANDLE.get(struct, delta_chroma_offset_l0$OFFSET, index0, index1);
    }
    ...
    public static void delta_chroma_offset_l0(MemorySegment struct, long index0, long index1, byte fieldValue) {
        delta_chroma_offset_l0$ELEM_HANDLE.set(struct, delta_chroma_offset_l0$OFFSET, index0, index1, fieldValue);
    }
    ...
    private static final long delta_luma_weight_l1$OFFSET = $LAYOUT.byteOffset(groupElement("delta_luma_weight_l1"));
    ...
    public static byte delta_luma_weight_l1(MemorySegment struct, long index0) {
        return (byte)delta_luma_weight_l1$ELEM_HANDLE.get(struct, delta_luma_weight_l1$OFFSET, index0);
    }
    ...
    public static void delta_luma_weight_l1(MemorySegment struct, long index0, byte fieldValue) {
        delta_luma_weight_l1$ELEM_HANDLE.set(struct, delta_luma_weight_l1$OFFSET, index0, fieldValue);
    }
    ...
    private static final long luma_offset_l1$OFFSET = $LAYOUT.byteOffset(groupElement("luma_offset_l1"));
    ...
    public static byte luma_offset_l1(MemorySegment struct, long index0) {
        return (byte)luma_offset_l1$ELEM_HANDLE.get(struct, luma_offset_l1$OFFSET, index0);
    }
    ...
    public static void luma_offset_l1(MemorySegment struct, long index0, byte fieldValue) {
        luma_offset_l1$ELEM_HANDLE.set(struct, luma_offset_l1$OFFSET, index0, fieldValue);
    }
    ...
    private static final long delta_chroma_weight_l1$OFFSET = $LAYOUT.byteOffset(groupElement("delta_chroma_weight_l1"));
    ...
    public static byte delta_chroma_weight_l1(MemorySegment struct, long index0, long index1) {
        return (byte)delta_chroma_weight_l1$ELEM_HANDLE.get(struct, delta_chroma_weight_l1$OFFSET, index0, index1);
    }
    ...
    public static void delta_chroma_weight_l1(MemorySegment struct, long index0, long index1, byte fieldValue) {
        delta_chroma_weight_l1$ELEM_HANDLE.set(struct, delta_chroma_weight_l1$OFFSET, index0, index1, fieldValue);
    }
    ...
    private static final long delta_chroma_offset_l1$OFFSET = $LAYOUT.byteOffset(groupElement("delta_chroma_offset_l1"));
    ...
    public static byte delta_chroma_offset_l1(MemorySegment struct, long index0, long index1) {
        return (byte)delta_chroma_offset_l1$ELEM_HANDLE.get(struct, delta_chroma_offset_l1$OFFSET, index0, index1);
    }
    ...
    public static void delta_chroma_offset_l1(MemorySegment struct, long index0, long index1, byte fieldValue) {
        delta_chroma_offset_l1$ELEM_HANDLE.set(struct, delta_chroma_offset_l1$OFFSET, index0, index1, fieldValue);
    }
