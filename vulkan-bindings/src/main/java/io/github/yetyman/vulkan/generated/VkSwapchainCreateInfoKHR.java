...
public class VkSwapchainCreateInfoKHR {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        ...
        MemoryLayout.paddingLayout(4),
        VulkanFFM.C_POINTER.withName("surface"),
        VulkanFFM.C_INT.withName("minImageCount"),
        VulkanFFM.C_INT.withName("imageFormat"),
        VulkanFFM.C_INT.withName("imageColorSpace"),
        VkExtent2D.layout().withName("imageExtent"),
        VulkanFFM.C_INT.withName("imageArrayLayers"),
        VulkanFFM.C_INT.withName("imageUsage"),
        VulkanFFM.C_INT.withName("imageSharingMode"),
        VulkanFFM.C_INT.withName("queueFamilyIndexCount"),
        MemoryLayout.paddingLayout(4),
        VulkanFFM.C_POINTER.withName("pQueueFamilyIndices"),
        VulkanFFM.C_INT.withName("preTransform"),
        VulkanFFM.C_INT.withName("compositeAlpha"),
        VulkanFFM.C_INT.withName("presentMode"),
        VulkanFFM.C_INT.withName("clipped"),
        VulkanFFM.C_POINTER.withName("oldSwapchain")
