...
public class tagDROPSTRUCT {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        VulkanWin32FFM.C_POINTER.withName("hwndSource"),
        VulkanWin32FFM.C_POINTER.withName("hwndSink"),
        VulkanWin32FFM.C_LONG.withName("wFmt"),
        MemoryLayout.paddingLayout(4),
        VulkanWin32FFM.C_LONG_LONG.withName("dwData"),
        tagPOINT.layout().withName("ptDrop"),
        VulkanWin32FFM.C_LONG.withName("dwControlData"),
        MemoryLayout.paddingLayout(4)
