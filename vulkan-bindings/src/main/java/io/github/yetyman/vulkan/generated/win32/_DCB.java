...
public class _DCB {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        VulkanWin32FFM.C_LONG.withName("DCBlength"),
        VulkanWin32FFM.C_LONG.withName("BaudRate"),
        MemoryLayout.paddingLayout(4),
        VulkanWin32FFM.C_SHORT.withName("wReserved"),
        VulkanWin32FFM.C_SHORT.withName("XonLim"),
        VulkanWin32FFM.C_SHORT.withName("XoffLim"),
        VulkanWin32FFM.C_CHAR.withName("ByteSize"),
        VulkanWin32FFM.C_CHAR.withName("Parity"),
        VulkanWin32FFM.C_CHAR.withName("StopBits"),
        VulkanWin32FFM.C_CHAR.withName("XonChar"),
        VulkanWin32FFM.C_CHAR.withName("XoffChar"),
        VulkanWin32FFM.C_CHAR.withName("ErrorChar"),
        VulkanWin32FFM.C_CHAR.withName("EofChar"),
        VulkanWin32FFM.C_CHAR.withName("EvtChar"),
        VulkanWin32FFM.C_SHORT.withName("wReserved1")
    ).withName("_DCB");
