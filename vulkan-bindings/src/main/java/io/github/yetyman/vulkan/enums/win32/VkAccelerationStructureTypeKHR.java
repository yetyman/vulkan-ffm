...
public record VkAccelerationStructureTypeKHR(int value) {
    ...
    public static final VkAccelerationStructureTypeKHR VK_ACCELERATION_STRUCTURE_TYPE_BOTTOM_LEVEL_NV = new VkAccelerationStructureTypeKHR(1);
    ...
    public static final VkAccelerationStructureTypeKHR VK_ACCELERATION_STRUCTURE_TYPE_TOP_LEVEL_NV = new VkAccelerationStructureTypeKHR(0);
