...
public record VkExternalFenceFeatureFlagBits(int value) {
    ...
    public static final VkExternalFenceFeatureFlagBits VK_EXTERNAL_FENCE_FEATURE_EXPORTABLE_BIT_KHR = new VkExternalFenceFeatureFlagBits(1);
    ...
    public static final VkExternalFenceFeatureFlagBits VK_EXTERNAL_FENCE_FEATURE_IMPORTABLE_BIT_KHR = new VkExternalFenceFeatureFlagBits(2);
