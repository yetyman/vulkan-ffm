...
public record VkBufferCreateFlagBits(int value) {
    ...
    public static final VkBufferCreateFlagBits VK_BUFFER_CREATE_DEVICE_ADDRESS_CAPTURE_REPLAY_BIT_EXT = new VkBufferCreateFlagBits(16);
    public static final VkBufferCreateFlagBits VK_BUFFER_CREATE_DEVICE_ADDRESS_CAPTURE_REPLAY_BIT_KHR = new VkBufferCreateFlagBits(16);
