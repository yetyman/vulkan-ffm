...
public class VkImageCreateInfo {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        ...
        VulkanFFM.C_INT.withName("imageType"),
        VulkanFFM.C_INT.withName("format"),
        VkExtent3D.layout().withName("extent"),
        VulkanFFM.C_INT.withName("mipLevels"),
        VulkanFFM.C_INT.withName("arrayLayers"),
        VulkanFFM.C_INT.withName("samples"),
        VulkanFFM.C_INT.withName("tiling"),
        VulkanFFM.C_INT.withName("usage"),
        VulkanFFM.C_INT.withName("sharingMode"),
        VulkanFFM.C_INT.withName("queueFamilyIndexCount"),
        MemoryLayout.paddingLayout(4),
        VulkanFFM.C_POINTER.withName("pQueueFamilyIndices"),
        VulkanFFM.C_INT.withName("initialLayout"),
        MemoryLayout.paddingLayout(4)
