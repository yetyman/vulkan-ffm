...
public class StdVideoH265SubLayerHrdParameters {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        ...
        MemoryLayout.sequenceLayout(32, VulkanWin32FFM.C_INT).withName("cpb_size_du_value_minus1"),
        MemoryLayout.sequenceLayout(32, VulkanWin32FFM.C_INT).withName("bit_rate_du_value_minus1"),
        VulkanWin32FFM.C_INT.withName("cbr_flag")
    ...
    private static final long cpb_size_du_value_minus1$OFFSET = $LAYOUT.byteOffset(groupElement("cpb_size_du_value_minus1"));
    ...
    public static int cpb_size_du_value_minus1(MemorySegment struct, long index0) {
        return (int)cpb_size_du_value_minus1$ELEM_HANDLE.get(struct, cpb_size_du_value_minus1$OFFSET, index0);
    }
    ...
    public static void cpb_size_du_value_minus1(MemorySegment struct, long index0, int fieldValue) {
        cpb_size_du_value_minus1$ELEM_HANDLE.set(struct, cpb_size_du_value_minus1$OFFSET, index0, fieldValue);
    }
    ...
    private static final long bit_rate_du_value_minus1$OFFSET = $LAYOUT.byteOffset(groupElement("bit_rate_du_value_minus1"));
    ...
    public static int bit_rate_du_value_minus1(MemorySegment struct, long index0) {
        return (int)bit_rate_du_value_minus1$ELEM_HANDLE.get(struct, bit_rate_du_value_minus1$OFFSET, index0);
    }
    ...
    public static void bit_rate_du_value_minus1(MemorySegment struct, long index0, int fieldValue) {
        bit_rate_du_value_minus1$ELEM_HANDLE.set(struct, bit_rate_du_value_minus1$OFFSET, index0, fieldValue);
    }
