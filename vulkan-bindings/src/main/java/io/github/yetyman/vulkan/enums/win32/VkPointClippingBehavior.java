...
public record VkPointClippingBehavior(int value) {
    ...
    public static final VkPointClippingBehavior VK_POINT_CLIPPING_BEHAVIOR_ALL_CLIP_PLANES_KHR = new VkPointClippingBehavior(0);
    ...
    public static final VkPointClippingBehavior VK_POINT_CLIPPING_BEHAVIOR_USER_CLIP_PLANES_ONLY_KHR = new VkPointClippingBehavior(1);
