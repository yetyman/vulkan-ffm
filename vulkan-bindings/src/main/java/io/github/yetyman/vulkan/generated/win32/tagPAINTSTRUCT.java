...
public class tagPAINTSTRUCT {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        VulkanWin32FFM.C_POINTER.withName("hdc"),
        VulkanWin32FFM.C_INT.withName("fErase"),
        tagRECT.layout().withName("rcPaint"),
        VulkanWin32FFM.C_INT.withName("fRestore"),
        VulkanWin32FFM.C_INT.withName("fIncUpdate"),
        MemoryLayout.sequenceLayout(32, VulkanWin32FFM.C_CHAR).withName("rgbReserved"),
