...
public record VkAccessFlagBits(int value) {
    ...
    public static final VkAccessFlagBits VK_ACCESS_ACCELERATION_STRUCTURE_READ_BIT_NV = new VkAccessFlagBits(2097152);
    public static final VkAccessFlagBits VK_ACCESS_ACCELERATION_STRUCTURE_WRITE_BIT_KHR = new VkAccessFlagBits(4194304);
    public static final VkAccessFlagBits VK_ACCESS_ACCELERATION_STRUCTURE_WRITE_BIT_NV = new VkAccessFlagBits(4194304);
    ...
    public static final VkAccessFlagBits VK_ACCESS_COMMAND_PREPROCESS_READ_BIT_NV = new VkAccessFlagBits(131072);
    public static final VkAccessFlagBits VK_ACCESS_COMMAND_PREPROCESS_WRITE_BIT_EXT = new VkAccessFlagBits(262144);
    public static final VkAccessFlagBits VK_ACCESS_COMMAND_PREPROCESS_WRITE_BIT_NV = new VkAccessFlagBits(262144);
    ...
    public static final VkAccessFlagBits VK_ACCESS_NONE_KHR = new VkAccessFlagBits(0);
    ...
    public static final VkAccessFlagBits VK_ACCESS_SHADING_RATE_IMAGE_READ_BIT_NV = new VkAccessFlagBits(8388608);
