...
public class StdVideoAV1GlobalMotion {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        MemoryLayout.sequenceLayout(8, VulkanFFM.C_CHAR).withName("GmType"),
        MemoryLayout.sequenceLayout(8, MemoryLayout.sequenceLayout(6, VulkanFFM.C_INT)).withName("gm_params")
