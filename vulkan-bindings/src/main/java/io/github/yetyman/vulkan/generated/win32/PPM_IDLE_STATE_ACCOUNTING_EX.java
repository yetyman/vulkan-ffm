...
public class PPM_IDLE_STATE_ACCOUNTING_EX {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        VulkanWin32FFM.C_LONG_LONG.withName("TotalTime"),
        VulkanWin32FFM.C_LONG.withName("IdleTransitions"),
        VulkanWin32FFM.C_LONG.withName("FailedTransitions"),
        VulkanWin32FFM.C_LONG.withName("InvalidBucketIndex"),
        VulkanWin32FFM.C_LONG.withName("MinTimeUs"),
        VulkanWin32FFM.C_LONG.withName("MaxTimeUs"),
        VulkanWin32FFM.C_LONG.withName("CancelledTransitions"),
        MemoryLayout.sequenceLayout(16, PPM_IDLE_STATE_BUCKET_EX.layout()).withName("IdleTimeBuckets")
    ).withName("$anon$17691:9");
