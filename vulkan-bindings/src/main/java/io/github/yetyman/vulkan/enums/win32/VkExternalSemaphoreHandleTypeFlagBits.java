...
public record VkExternalSemaphoreHandleTypeFlagBits(int value) {
    ...
    public static final VkExternalSemaphoreHandleTypeFlagBits VK_EXTERNAL_SEMAPHORE_HANDLE_TYPE_D3D12_FENCE_BIT = new VkExternalSemaphoreHandleTypeFlagBits(8);
    public static final VkExternalSemaphoreHandleTypeFlagBits VK_EXTERNAL_SEMAPHORE_HANDLE_TYPE_D3D12_FENCE_BIT_KHR = new VkExternalSemaphoreHandleTypeFlagBits(8);
    ...
    public static final VkExternalSemaphoreHandleTypeFlagBits VK_EXTERNAL_SEMAPHORE_HANDLE_TYPE_OPAQUE_FD_BIT_KHR = new VkExternalSemaphoreHandleTypeFlagBits(1);
    ...
    public static final VkExternalSemaphoreHandleTypeFlagBits VK_EXTERNAL_SEMAPHORE_HANDLE_TYPE_OPAQUE_WIN32_BIT_KHR = new VkExternalSemaphoreHandleTypeFlagBits(2);
    ...
    public static final VkExternalSemaphoreHandleTypeFlagBits VK_EXTERNAL_SEMAPHORE_HANDLE_TYPE_OPAQUE_WIN32_KMT_BIT_KHR = new VkExternalSemaphoreHandleTypeFlagBits(4);
    ...
    public static final VkExternalSemaphoreHandleTypeFlagBits VK_EXTERNAL_SEMAPHORE_HANDLE_TYPE_SYNC_FD_BIT_KHR = new VkExternalSemaphoreHandleTypeFlagBits(16);
