...
/**
 * Constants for VkPresentStageFlagBitsEXT
 * Generated from jextract bindings
 */
public final class VkPresentStageFlagBitsEXT {
    private VkPresentStageFlagBitsEXT() {}

    public static final int VK_PRESENT_STAGE_FLAG_BITS_MAX_ENUM_EXT = 2147483647;
