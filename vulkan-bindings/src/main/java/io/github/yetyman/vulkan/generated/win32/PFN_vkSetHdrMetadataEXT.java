...
/**
 * {@snippet lang=c :
 * typedef void (*PFN_vkSetHdrMetadataEXT)(VkDevice, uint32_t, const VkSwapchainKHR *, const VkHdrMetadataEXT *) __attribute__((stdcall))
 * }
 */
public final class PFN_vkSetHdrMetadataEXT {

    private PFN_vkSetHdrMetadataEXT() {
    ...
    private static final MethodHandle UP$MH = VulkanWin32FFM.upcallHandle(PFN_vkSetHdrMetadataEXT.Function.class, "apply", $DESC);
