...
public class _SECURITY_DESCRIPTOR {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        VulkanWin32FFM.C_CHAR.withName("Revision"),
        VulkanWin32FFM.C_CHAR.withName("Sbz1"),
        VulkanWin32FFM.C_SHORT.withName("Control"),
        MemoryLayout.paddingLayout(4),
        VulkanWin32FFM.C_POINTER.withName("Owner"),
        VulkanWin32FFM.C_POINTER.withName("Group"),
        VulkanWin32FFM.C_POINTER.withName("Sacl"),
        VulkanWin32FFM.C_POINTER.withName("Dacl")
