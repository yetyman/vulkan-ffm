...
/**
 * {@snippet lang=c :
 * typedef VkResult (*PFN_vkBindImageMemory)(VkDevice, VkImage, VkDeviceMemory, VkDeviceSize) __attribute__((stdcall))
 * }
 */
public final class PFN_vkBindImageMemory {

    private PFN_vkBindImageMemory() {
    ...
    private static final MethodHandle UP$MH = VulkanWin32FFM.upcallHandle(PFN_vkBindImageMemory.Function.class, "apply", $DESC);
