...
public class _PROCESS_MITIGATION_USER_SHADOW_STACK_POLICY {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        MemoryLayout.unionLayout(
            ...
            ).withName("$anon$12792:9")
        ).withName("$anon$12790:5")
    ...
    private static final OfInt Flags$LAYOUT = (OfInt)$LAYOUT.select(groupElement("$anon$12790:5"), groupElement("Flags"));
    ...
    private static final long Flags$OFFSET = $LAYOUT.byteOffset(groupElement("$anon$12790:5"), groupElement("Flags"));
