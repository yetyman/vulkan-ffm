...
public class VkPhysicalDeviceAccelerationStructurePropertiesKHR {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        ...
        VulkanFFM.C_LONG_LONG.withName("maxGeometryCount"),
        VulkanFFM.C_LONG_LONG.withName("maxInstanceCount"),
        VulkanFFM.C_LONG_LONG.withName("maxPrimitiveCount"),
        VulkanFFM.C_INT.withName("maxPerStageDescriptorAccelerationStructures"),
        VulkanFFM.C_INT.withName("maxPerStageDescriptorUpdateAfterBindAccelerationStructures"),
        VulkanFFM.C_INT.withName("maxDescriptorSetAccelerationStructures"),
        VulkanFFM.C_INT.withName("maxDescriptorSetUpdateAfterBindAccelerationStructures"),
        VulkanFFM.C_INT.withName("minAccelerationStructureScratchOffsetAlignment"),
        MemoryLayout.paddingLayout(4)
