...
public class VkPhysicalDeviceVulkan11Features {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        ...
        VulkanFFM.C_INT.withName("storageBuffer16BitAccess"),
        VulkanFFM.C_INT.withName("uniformAndStorageBuffer16BitAccess"),
        VulkanFFM.C_INT.withName("storagePushConstant16"),
        VulkanFFM.C_INT.withName("storageInputOutput16"),
        VulkanFFM.C_INT.withName("multiview"),
        VulkanFFM.C_INT.withName("multiviewGeometryShader"),
        VulkanFFM.C_INT.withName("multiviewTessellationShader"),
        VulkanFFM.C_INT.withName("variablePointersStorageBuffer"),
        VulkanFFM.C_INT.withName("variablePointers"),
        VulkanFFM.C_INT.withName("protectedMemory"),
        VulkanFFM.C_INT.withName("samplerYcbcrConversion"),
        VulkanFFM.C_INT.withName("shaderDrawParameters")
