...
public class VkGraphicsPipelineShaderGroupsCreateInfoNV {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        ...
        VulkanWin32FFM.C_INT.withName("pipelineCount"),
        MemoryLayout.paddingLayout(4),
        VulkanWin32FFM.C_POINTER.withName("pPipelines")
    ...
    private static final long pipelineCount$OFFSET = $LAYOUT.byteOffset(groupElement("pipelineCount"));
    ...
    private static final long pPipelines$OFFSET = $LAYOUT.byteOffset(groupElement("pPipelines"));
