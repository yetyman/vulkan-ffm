...
public class VkImageViewSampleWeightCreateInfoQCOM {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        ...
        VulkanWin32FFM.C_INT.withName("numPhases"),
        MemoryLayout.paddingLayout(4)
    ...
    private static final long filterCenter$OFFSET = $LAYOUT.byteOffset(groupElement("filterCenter"));
    ...
    private static final long filterSize$OFFSET = $LAYOUT.byteOffset(groupElement("filterSize"));
    ...
    private static final long numPhases$OFFSET = $LAYOUT.byteOffset(groupElement("numPhases"));
