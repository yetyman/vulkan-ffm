...
public class VkPhysicalDeviceToolProperties {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        ...
        MemoryLayout.sequenceLayout(256, VulkanWin32FFM.C_CHAR).withName("name"),
        MemoryLayout.sequenceLayout(256, VulkanWin32FFM.C_CHAR).withName("version"),
        VulkanWin32FFM.C_INT.withName("purposes"),
        MemoryLayout.sequenceLayout(256, VulkanWin32FFM.C_CHAR).withName("description"),
        MemoryLayout.sequenceLayout(256, VulkanWin32FFM.C_CHAR).withName("layer"),
        MemoryLayout.paddingLayout(4)
    ...
    public static byte version(MemorySegment struct, long index0) {
        return (byte)version$ELEM_HANDLE.get(struct, version$OFFSET, index0);
    }
    ...
    public static void version(MemorySegment struct, long index0, byte fieldValue) {
        version$ELEM_HANDLE.set(struct, version$OFFSET, index0, fieldValue);
    }
    ...
    private static final long purposes$OFFSET = $LAYOUT.byteOffset(groupElement("purposes"));
    ...
    public static byte layer(MemorySegment struct, long index0) {
        return (byte)layer$ELEM_HANDLE.get(struct, layer$OFFSET, index0);
    }
    ...
    public static void layer(MemorySegment struct, long index0, byte fieldValue) {
        layer$ELEM_HANDLE.set(struct, layer$OFFSET, index0, fieldValue);
    }
