...
public class VkVideoEncodeRateControlInfoKHR {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        ...
        VulkanFFM.C_INT.withName("rateControlMode"),
        VulkanFFM.C_INT.withName("layerCount"),
        MemoryLayout.paddingLayout(4),
        VulkanFFM.C_POINTER.withName("pLayers"),
        VulkanFFM.C_INT.withName("virtualBufferSizeInMs"),
        VulkanFFM.C_INT.withName("initialVirtualBufferSizeInMs")
