...
public class VkPushDescriptorSetWithTemplateInfo {
    ...
    private static final long descriptorUpdateTemplate$OFFSET = $LAYOUT.byteOffset(groupElement("descriptorUpdateTemplate"));
