...
public class tagDRAWITEMSTRUCT {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        ...
        VulkanWin32FFM.C_INT.withName("itemID"),
        VulkanWin32FFM.C_INT.withName("itemAction"),
        VulkanWin32FFM.C_INT.withName("itemState"),
        MemoryLayout.paddingLayout(4),
        VulkanWin32FFM.C_POINTER.withName("hwndItem"),
        VulkanWin32FFM.C_POINTER.withName("hDC"),
        tagRECT.layout().withName("rcItem"),
        VulkanWin32FFM.C_LONG_LONG.withName("itemData")
