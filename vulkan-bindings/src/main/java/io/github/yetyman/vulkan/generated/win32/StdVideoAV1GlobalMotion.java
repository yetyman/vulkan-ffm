...
public class StdVideoAV1GlobalMotion {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        MemoryLayout.sequenceLayout(8, VulkanWin32FFM.C_CHAR).withName("GmType"),
        MemoryLayout.sequenceLayout(8, MemoryLayout.sequenceLayout(6, VulkanWin32FFM.C_INT)).withName("gm_params")
