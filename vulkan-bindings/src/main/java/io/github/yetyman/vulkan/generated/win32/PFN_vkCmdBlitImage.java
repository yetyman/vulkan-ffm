...
/**
 * {@snippet lang=c :
 * typedef void (*PFN_vkCmdBlitImage)(VkCommandBuffer, VkImage, VkImageLayout, VkImage, VkImageLayout, uint32_t, const VkImageBlit *, VkFilter) __attribute__((stdcall))
 * }
 */
public final class PFN_vkCmdBlitImage {

    private PFN_vkCmdBlitImage() {
    ...
    private static final MethodHandle UP$MH = VulkanWin32FFM.upcallHandle(PFN_vkCmdBlitImage.Function.class, "apply", $DESC);
