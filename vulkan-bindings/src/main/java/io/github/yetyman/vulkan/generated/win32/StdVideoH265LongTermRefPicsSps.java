...
public class StdVideoH265LongTermRefPicsSps {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        VulkanWin32FFM.C_INT.withName("used_by_curr_pic_lt_sps_flag"),
        MemoryLayout.sequenceLayout(32, VulkanWin32FFM.C_INT).withName("lt_ref_pic_poc_lsb_sps")
    ...
    private static final long used_by_curr_pic_lt_sps_flag$OFFSET = $LAYOUT.byteOffset(groupElement("used_by_curr_pic_lt_sps_flag"));
    ...
    private static final long lt_ref_pic_poc_lsb_sps$OFFSET = $LAYOUT.byteOffset(groupElement("lt_ref_pic_poc_lsb_sps"));
