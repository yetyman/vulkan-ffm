...
public record VkGeometryInstanceFlagBitsKHR(int value) {
    ...
    public static final VkGeometryInstanceFlagBitsKHR VK_GEOMETRY_INSTANCE_DISABLE_OPACITY_MICROMAPS_EXT = new VkGeometryInstanceFlagBitsKHR(32);
    ...
    public static final VkGeometryInstanceFlagBitsKHR VK_GEOMETRY_INSTANCE_FORCE_NO_OPAQUE_BIT_NV = new VkGeometryInstanceFlagBitsKHR(8);
    ...
    public static final VkGeometryInstanceFlagBitsKHR VK_GEOMETRY_INSTANCE_FORCE_OPACITY_MICROMAP_2_STATE_EXT = new VkGeometryInstanceFlagBitsKHR(16);
    ...
    public static final VkGeometryInstanceFlagBitsKHR VK_GEOMETRY_INSTANCE_FORCE_OPAQUE_BIT_NV = new VkGeometryInstanceFlagBitsKHR(4);
    ...
    public static final VkGeometryInstanceFlagBitsKHR VK_GEOMETRY_INSTANCE_TRIANGLE_FACING_CULL_DISABLE_BIT_KHR = new VkGeometryInstanceFlagBitsKHR(1);
    ...
    public static final VkGeometryInstanceFlagBitsKHR VK_GEOMETRY_INSTANCE_TRIANGLE_FRONT_COUNTERCLOCKWISE_BIT_KHR = new VkGeometryInstanceFlagBitsKHR(2);
    public static final VkGeometryInstanceFlagBitsKHR VK_GEOMETRY_INSTANCE_TRIANGLE_FRONT_COUNTERCLOCKWISE_BIT_NV = new VkGeometryInstanceFlagBitsKHR(2);
