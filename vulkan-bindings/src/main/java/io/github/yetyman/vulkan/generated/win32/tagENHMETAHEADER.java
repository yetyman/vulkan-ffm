...
public class tagENHMETAHEADER {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        VulkanWin32FFM.C_LONG.withName("iType"),
        VulkanWin32FFM.C_LONG.withName("nSize"),
        _RECTL.layout().withName("rclBounds"),
        _RECTL.layout().withName("rclFrame"),
        VulkanWin32FFM.C_LONG.withName("dSignature"),
        VulkanWin32FFM.C_LONG.withName("nVersion"),
        VulkanWin32FFM.C_LONG.withName("nBytes"),
        VulkanWin32FFM.C_LONG.withName("nRecords"),
        VulkanWin32FFM.C_SHORT.withName("nHandles"),
        VulkanWin32FFM.C_SHORT.withName("sReserved"),
        VulkanWin32FFM.C_LONG.withName("nDescription"),
        VulkanWin32FFM.C_LONG.withName("offDescription"),
        VulkanWin32FFM.C_LONG.withName("nPalEntries"),
        tagSIZE.layout().withName("szlDevice"),
        tagSIZE.layout().withName("szlMillimeters"),
        VulkanWin32FFM.C_LONG.withName("cbPixelFormat"),
        VulkanWin32FFM.C_LONG.withName("offPixelFormat"),
        VulkanWin32FFM.C_LONG.withName("bOpenGL"),
