...
public record VkPipelineRobustnessImageBehavior(int value) {
    ...
    public static final VkPipelineRobustnessImageBehavior VK_PIPELINE_ROBUSTNESS_IMAGE_BEHAVIOR_DEVICE_DEFAULT_EXT = new VkPipelineRobustnessImageBehavior(0);
    ...
    public static final VkPipelineRobustnessImageBehavior VK_PIPELINE_ROBUSTNESS_IMAGE_BEHAVIOR_DISABLED_EXT = new VkPipelineRobustnessImageBehavior(1);
    ...
    public static final VkPipelineRobustnessImageBehavior VK_PIPELINE_ROBUSTNESS_IMAGE_BEHAVIOR_ROBUST_IMAGE_ACCESS_2_EXT = new VkPipelineRobustnessImageBehavior(3);
    public static final VkPipelineRobustnessImageBehavior VK_PIPELINE_ROBUSTNESS_IMAGE_BEHAVIOR_ROBUST_IMAGE_ACCESS_EXT = new VkPipelineRobustnessImageBehavior(2);
