...
public class StdVideoAV1TileInfo {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        ...
        VulkanFFM.C_CHAR.withName("TileCols"),
        VulkanFFM.C_CHAR.withName("TileRows"),
        VulkanFFM.C_SHORT.withName("context_update_tile_id"),
        VulkanFFM.C_CHAR.withName("tile_size_bytes_minus_1"),
        MemoryLayout.sequenceLayout(7, VulkanFFM.C_CHAR).withName("reserved1"),
        VulkanFFM.C_POINTER.withName("pMiColStarts"),
        VulkanFFM.C_POINTER.withName("pMiRowStarts"),
        VulkanFFM.C_POINTER.withName("pWidthInSbsMinus1"),
        VulkanFFM.C_POINTER.withName("pHeightInSbsMinus1")
