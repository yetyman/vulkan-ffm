...
public class _PROCESS_MITIGATION_STRICT_HANDLE_CHECK_POLICY {
    ...
    private static final OfInt Flags$LAYOUT = (OfInt)$LAYOUT.select(groupElement("$anon$12590:5"), groupElement("Flags"));
    ...
    private static final long Flags$OFFSET = $LAYOUT.byteOffset(groupElement("$anon$12590:5"), groupElement("Flags"));
