...
public class _JOBOBJECT_CPU_RATE_CONTROL_INFORMATION {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        VulkanWin32FFM.C_LONG.withName("ControlFlags"),
        MemoryLayout.unionLayout(
            VulkanWin32FFM.C_LONG.withName("CpuRate"),
            VulkanWin32FFM.C_LONG.withName("Weight"),
            MemoryLayout.structLayout(
                VulkanWin32FFM.C_SHORT.withName("MinRate"),
                VulkanWin32FFM.C_SHORT.withName("MaxRate")
            ).withName("$anon$13030:9")
        ).withName("$anon$13027:5")
    ...
    private static final OfInt CpuRate$LAYOUT = (OfInt)$LAYOUT.select(groupElement("$anon$13027:5"), groupElement("CpuRate"));
    ...
    private static final long CpuRate$OFFSET = $LAYOUT.byteOffset(groupElement("$anon$13027:5"), groupElement("CpuRate"));
    ...
    private static final OfInt Weight$LAYOUT = (OfInt)$LAYOUT.select(groupElement("$anon$13027:5"), groupElement("Weight"));
    ...
    private static final long Weight$OFFSET = $LAYOUT.byteOffset(groupElement("$anon$13027:5"), groupElement("Weight"));
    ...
    private static final OfShort MinRate$LAYOUT = (OfShort)$LAYOUT.select(groupElement("$anon$13027:5"), groupElement("$anon$13030:9"), groupElement("MinRate"));
    ...
    private static final long MinRate$OFFSET = $LAYOUT.byteOffset(groupElement("$anon$13027:5"), groupElement("$anon$13030:9"), groupElement("MinRate"));
    ...
    private static final OfShort MaxRate$LAYOUT = (OfShort)$LAYOUT.select(groupElement("$anon$13027:5"), groupElement("$anon$13030:9"), groupElement("MaxRate"));
    ...
    private static final long MaxRate$OFFSET = $LAYOUT.byteOffset(groupElement("$anon$13027:5"), groupElement("$anon$13030:9"), groupElement("MaxRate"));
