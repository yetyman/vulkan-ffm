...
public class _KEY_EVENT_RECORD {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        VulkanWin32FFM.C_INT.withName("bKeyDown"),
        VulkanWin32FFM.C_SHORT.withName("wRepeatCount"),
        VulkanWin32FFM.C_SHORT.withName("wVirtualKeyCode"),
        VulkanWin32FFM.C_SHORT.withName("wVirtualScanCode"),
        _KEY_EVENT_RECORD.uChar.layout().withName("uChar"),
        VulkanWin32FFM.C_LONG.withName("dwControlKeyState")
    ...
    public static class uChar {
        ...
        private static final GroupLayout $LAYOUT = MemoryLayout.unionLayout(
            VulkanWin32FFM.C_SHORT.withName("UnicodeChar"),
            VulkanWin32FFM.C_CHAR.withName("AsciiChar")
        ).withName("$anon$53:5");
