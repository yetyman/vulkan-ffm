...
public class StdVideoEncodeH264ReferenceListsInfo {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        ...
        VulkanFFM.C_CHAR.withName("num_ref_idx_l0_active_minus1"),
        VulkanFFM.C_CHAR.withName("num_ref_idx_l1_active_minus1"),
        MemoryLayout.sequenceLayout(32, VulkanFFM.C_CHAR).withName("RefPicList0"),
        MemoryLayout.sequenceLayout(32, VulkanFFM.C_CHAR).withName("RefPicList1"),
        VulkanFFM.C_CHAR.withName("refList0ModOpCount"),
        VulkanFFM.C_CHAR.withName("refList1ModOpCount"),
        VulkanFFM.C_CHAR.withName("refPicMarkingOpCount"),
        MemoryLayout.sequenceLayout(7, VulkanFFM.C_CHAR).withName("reserved1"),
        VulkanFFM.C_POINTER.withName("pRefList0ModOperations"),
        VulkanFFM.C_POINTER.withName("pRefList1ModOperations"),
        VulkanFFM.C_POINTER.withName("pRefPicMarkingOperations")
