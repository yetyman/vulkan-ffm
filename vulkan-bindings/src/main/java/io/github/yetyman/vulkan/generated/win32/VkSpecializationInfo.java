...
public class VkSpecializationInfo {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        VulkanWin32FFM.C_INT.withName("mapEntryCount"),
        MemoryLayout.paddingLayout(4),
        VulkanWin32FFM.C_POINTER.withName("pMapEntries"),
    ...
    private static final long mapEntryCount$OFFSET = $LAYOUT.byteOffset(groupElement("mapEntryCount"));
    ...
    private static final long pMapEntries$OFFSET = $LAYOUT.byteOffset(groupElement("pMapEntries"));
