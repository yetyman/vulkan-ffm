...
public class _SYSTEM_POWER_POLICY {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        ...
        VulkanWin32FFM.C_INT.withName("LidOpenWake"),
        VulkanWin32FFM.C_LONG.withName("Reserved"),
        POWER_ACTION_POLICY.layout().withName("Idle"),
        VulkanWin32FFM.C_LONG.withName("IdleTimeout"),
        VulkanWin32FFM.C_CHAR.withName("IdleSensitivity"),
        VulkanWin32FFM.C_CHAR.withName("DynamicThrottle"),
        MemoryLayout.sequenceLayout(2, VulkanWin32FFM.C_CHAR).withName("Spare2"),
        VulkanWin32FFM.C_INT.withName("MinSleep"),
        VulkanWin32FFM.C_INT.withName("MaxSleep"),
        VulkanWin32FFM.C_INT.withName("ReducedLatencySleep"),
        VulkanWin32FFM.C_LONG.withName("WinLogonFlags"),
        VulkanWin32FFM.C_LONG.withName("Spare3"),
        VulkanWin32FFM.C_LONG.withName("DozeS4Timeout"),
        VulkanWin32FFM.C_LONG.withName("BroadcastCapacityResolution"),
        MemoryLayout.sequenceLayout(4, SYSTEM_POWER_LEVEL.layout()).withName("DischargePolicy"),
        VulkanWin32FFM.C_LONG.withName("VideoTimeout"),
        VulkanWin32FFM.C_CHAR.withName("VideoDimDisplay"),
        MemoryLayout.paddingLayout(3),
        MemoryLayout.sequenceLayout(3, VulkanWin32FFM.C_LONG).withName("VideoReserved"),
        VulkanWin32FFM.C_LONG.withName("SpindownTimeout"),
        VulkanWin32FFM.C_CHAR.withName("OptimizeForPower"),
        VulkanWin32FFM.C_CHAR.withName("FanThrottleTolerance"),
        VulkanWin32FFM.C_CHAR.withName("ForcedThrottle"),
