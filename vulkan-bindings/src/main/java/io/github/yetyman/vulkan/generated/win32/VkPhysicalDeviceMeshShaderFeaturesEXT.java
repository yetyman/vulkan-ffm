...
public class VkPhysicalDeviceMeshShaderFeaturesEXT {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        ...
        VulkanWin32FFM.C_INT.withName("taskShader"),
        VulkanWin32FFM.C_INT.withName("meshShader"),
        VulkanWin32FFM.C_INT.withName("multiviewMeshShader"),
        VulkanWin32FFM.C_INT.withName("primitiveFragmentShadingRateMeshShader"),
        VulkanWin32FFM.C_INT.withName("meshShaderQueries"),
        MemoryLayout.paddingLayout(4)
    ...
    private static final long primitiveFragmentShadingRateMeshShader$OFFSET = $LAYOUT.byteOffset(groupElement("primitiveFragmentShadingRateMeshShader"));
