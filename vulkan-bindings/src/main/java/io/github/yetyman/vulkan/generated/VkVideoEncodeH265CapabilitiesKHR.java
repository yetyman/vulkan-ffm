...
public class VkVideoEncodeH265CapabilitiesKHR {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        ...
        VulkanFFM.C_INT.withName("maxLevelIdc"),
        VulkanFFM.C_INT.withName("maxSliceSegmentCount"),
        VkExtent2D.layout().withName("maxTiles"),
        VulkanFFM.C_INT.withName("ctbSizes"),
        VulkanFFM.C_INT.withName("transformBlockSizes"),
        VulkanFFM.C_INT.withName("maxPPictureL0ReferenceCount"),
        VulkanFFM.C_INT.withName("maxBPictureL0ReferenceCount"),
        VulkanFFM.C_INT.withName("maxL1ReferenceCount"),
        VulkanFFM.C_INT.withName("maxSubLayerCount"),
        VulkanFFM.C_INT.withName("expectDyadicTemporalSubLayerPattern"),
        VulkanFFM.C_INT.withName("minQp"),
        VulkanFFM.C_INT.withName("maxQp"),
