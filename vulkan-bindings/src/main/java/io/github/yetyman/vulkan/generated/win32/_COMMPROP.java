...
public class _COMMPROP {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        VulkanWin32FFM.C_SHORT.withName("wPacketLength"),
        VulkanWin32FFM.C_SHORT.withName("wPacketVersion"),
        VulkanWin32FFM.C_LONG.withName("dwServiceMask"),
        VulkanWin32FFM.C_LONG.withName("dwReserved1"),
        VulkanWin32FFM.C_LONG.withName("dwMaxTxQueue"),
        VulkanWin32FFM.C_LONG.withName("dwMaxRxQueue"),
        VulkanWin32FFM.C_LONG.withName("dwMaxBaud"),
        VulkanWin32FFM.C_LONG.withName("dwProvSubType"),
        VulkanWin32FFM.C_LONG.withName("dwProvCapabilities"),
        VulkanWin32FFM.C_LONG.withName("dwSettableParams"),
        VulkanWin32FFM.C_LONG.withName("dwSettableBaud"),
        VulkanWin32FFM.C_SHORT.withName("wSettableData"),
        VulkanWin32FFM.C_SHORT.withName("wSettableStopParity"),
        VulkanWin32FFM.C_LONG.withName("dwCurrentTxQueue"),
        VulkanWin32FFM.C_LONG.withName("dwCurrentRxQueue"),
        VulkanWin32FFM.C_LONG.withName("dwProvSpec1"),
        VulkanWin32FFM.C_LONG.withName("dwProvSpec2"),
        MemoryLayout.sequenceLayout(1, VulkanWin32FFM.C_SHORT).withName("wcProvChar"),
