...
public class _GLYPHMETRICS {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        VulkanWin32FFM.C_INT.withName("gmBlackBoxX"),
        VulkanWin32FFM.C_INT.withName("gmBlackBoxY"),
        tagPOINT.layout().withName("gmptGlyphOrigin"),
        VulkanWin32FFM.C_SHORT.withName("gmCellIncX"),
        VulkanWin32FFM.C_SHORT.withName("gmCellIncY")
