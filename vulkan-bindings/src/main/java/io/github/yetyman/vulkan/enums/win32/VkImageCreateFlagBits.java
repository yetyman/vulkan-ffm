...
public record VkImageCreateFlagBits(int value) {
    ...
    public static final VkImageCreateFlagBits VK_IMAGE_CREATE_2D_ARRAY_COMPATIBLE_BIT_KHR = new VkImageCreateFlagBits(32);
    ...
    public static final VkImageCreateFlagBits VK_IMAGE_CREATE_ALIAS_BIT_KHR = new VkImageCreateFlagBits(1024);
    public static final VkImageCreateFlagBits VK_IMAGE_CREATE_BLOCK_TEXEL_VIEW_COMPATIBLE_BIT = new VkImageCreateFlagBits(128);
    public static final VkImageCreateFlagBits VK_IMAGE_CREATE_BLOCK_TEXEL_VIEW_COMPATIBLE_BIT_KHR = new VkImageCreateFlagBits(128);
    ...
    public static final VkImageCreateFlagBits VK_IMAGE_CREATE_DISJOINT_BIT_KHR = new VkImageCreateFlagBits(512);
    public static final VkImageCreateFlagBits VK_IMAGE_CREATE_EXTENDED_USAGE_BIT = new VkImageCreateFlagBits(256);
    public static final VkImageCreateFlagBits VK_IMAGE_CREATE_EXTENDED_USAGE_BIT_KHR = new VkImageCreateFlagBits(256);
    ...
    public static final VkImageCreateFlagBits VK_IMAGE_CREATE_FRAGMENT_DENSITY_MAP_OFFSET_BIT_QCOM = new VkImageCreateFlagBits(32768);
    ...
    public static final VkImageCreateFlagBits VK_IMAGE_CREATE_SPLIT_INSTANCE_BIND_REGIONS_BIT_KHR = new VkImageCreateFlagBits(64);
