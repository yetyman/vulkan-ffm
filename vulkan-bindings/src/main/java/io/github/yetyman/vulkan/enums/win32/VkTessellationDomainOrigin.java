...
public record VkTessellationDomainOrigin(int value) {
    ...
    public static final VkTessellationDomainOrigin VK_TESSELLATION_DOMAIN_ORIGIN_LOWER_LEFT_KHR = new VkTessellationDomainOrigin(1);
    ...
    public static final VkTessellationDomainOrigin VK_TESSELLATION_DOMAIN_ORIGIN_UPPER_LEFT_KHR = new VkTessellationDomainOrigin(0);
