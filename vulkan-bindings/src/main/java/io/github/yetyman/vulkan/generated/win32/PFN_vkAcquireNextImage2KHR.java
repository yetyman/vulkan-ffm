...
/**
 * {@snippet lang=c :
 * typedef VkResult (*PFN_vkAcquireNextImage2KHR)(VkDevice, const VkAcquireNextImageInfoKHR *, uint32_t *) __attribute__((stdcall))
 * }
 */
public final class PFN_vkAcquireNextImage2KHR {

    private PFN_vkAcquireNextImage2KHR() {
    ...
    private static final MethodHandle UP$MH = VulkanWin32FFM.upcallHandle(PFN_vkAcquireNextImage2KHR.Function.class, "apply", $DESC);
