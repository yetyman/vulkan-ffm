...
public class VkPerformanceCounterDescriptionKHR {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        ...
        MemoryLayout.sequenceLayout(256, VulkanWin32FFM.C_CHAR).withName("category"),
    ...
    public static byte category(MemorySegment struct, long index0) {
        return (byte)category$ELEM_HANDLE.get(struct, category$OFFSET, index0);
    }
    ...
    public static void category(MemorySegment struct, long index0, byte fieldValue) {
        category$ELEM_HANDLE.set(struct, category$OFFSET, index0, fieldValue);
    }
