...
public class StdVideoEncodeH265LongTermRefPics {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        VulkanWin32FFM.C_CHAR.withName("num_long_term_sps"),
        VulkanWin32FFM.C_CHAR.withName("num_long_term_pics"),
        MemoryLayout.sequenceLayout(32, VulkanWin32FFM.C_CHAR).withName("lt_idx_sps"),
        MemoryLayout.sequenceLayout(16, VulkanWin32FFM.C_CHAR).withName("poc_lsb_lt"),
        VulkanWin32FFM.C_SHORT.withName("used_by_curr_pic_lt_flag"),
        MemoryLayout.sequenceLayout(48, VulkanWin32FFM.C_CHAR).withName("delta_poc_msb_present_flag"),
        MemoryLayout.sequenceLayout(48, VulkanWin32FFM.C_CHAR).withName("delta_poc_msb_cycle_lt")
    ...
    private static final long num_long_term_sps$OFFSET = $LAYOUT.byteOffset(groupElement("num_long_term_sps"));
    ...
    private static final long num_long_term_pics$OFFSET = $LAYOUT.byteOffset(groupElement("num_long_term_pics"));
    ...
    private static final long lt_idx_sps$OFFSET = $LAYOUT.byteOffset(groupElement("lt_idx_sps"));
    ...
    public static byte lt_idx_sps(MemorySegment struct, long index0) {
        return (byte)lt_idx_sps$ELEM_HANDLE.get(struct, lt_idx_sps$OFFSET, index0);
    }
    ...
    public static void lt_idx_sps(MemorySegment struct, long index0, byte fieldValue) {
        lt_idx_sps$ELEM_HANDLE.set(struct, lt_idx_sps$OFFSET, index0, fieldValue);
    }
    ...
    private static final long poc_lsb_lt$OFFSET = $LAYOUT.byteOffset(groupElement("poc_lsb_lt"));
    ...
    public static byte poc_lsb_lt(MemorySegment struct, long index0) {
        return (byte)poc_lsb_lt$ELEM_HANDLE.get(struct, poc_lsb_lt$OFFSET, index0);
    }
    ...
    public static void poc_lsb_lt(MemorySegment struct, long index0, byte fieldValue) {
        poc_lsb_lt$ELEM_HANDLE.set(struct, poc_lsb_lt$OFFSET, index0, fieldValue);
    }
    ...
    private static final long used_by_curr_pic_lt_flag$OFFSET = $LAYOUT.byteOffset(groupElement("used_by_curr_pic_lt_flag"));
    ...
    private static final long delta_poc_msb_present_flag$OFFSET = $LAYOUT.byteOffset(groupElement("delta_poc_msb_present_flag"));
    ...
    public static byte delta_poc_msb_present_flag(MemorySegment struct, long index0) {
        return (byte)delta_poc_msb_present_flag$ELEM_HANDLE.get(struct, delta_poc_msb_present_flag$OFFSET, index0);
    }
    ...
    public static void delta_poc_msb_present_flag(MemorySegment struct, long index0, byte fieldValue) {
        delta_poc_msb_present_flag$ELEM_HANDLE.set(struct, delta_poc_msb_present_flag$OFFSET, index0, fieldValue);
    }
    ...
    private static final long delta_poc_msb_cycle_lt$OFFSET = $LAYOUT.byteOffset(groupElement("delta_poc_msb_cycle_lt"));
    ...
    public static byte delta_poc_msb_cycle_lt(MemorySegment struct, long index0) {
        return (byte)delta_poc_msb_cycle_lt$ELEM_HANDLE.get(struct, delta_poc_msb_cycle_lt$OFFSET, index0);
    }
    ...
    public static void delta_poc_msb_cycle_lt(MemorySegment struct, long index0, byte fieldValue) {
        delta_poc_msb_cycle_lt$ELEM_HANDLE.set(struct, delta_poc_msb_cycle_lt$OFFSET, index0, fieldValue);
    }
