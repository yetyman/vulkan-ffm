...
/**
 * {@snippet lang=c :
 * typedef void (*PFN_vkFreeFunction)(void *, void *) __attribute__((stdcall))
 * }
 */
public final class PFN_vkFreeFunction {

    private PFN_vkFreeFunction() {
    ...
    private static final MethodHandle UP$MH = VulkanWin32FFM.upcallHandle(PFN_vkFreeFunction.Function.class, "apply", $DESC);
