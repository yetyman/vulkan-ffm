...
public record VkFormatFeatureFlagBits(int value) {
    ...
    public static final VkFormatFeatureFlagBits VK_FORMAT_FEATURE_COSITED_CHROMA_SAMPLES_BIT_KHR = new VkFormatFeatureFlagBits(8388608);
    ...
    public static final VkFormatFeatureFlagBits VK_FORMAT_FEATURE_DISJOINT_BIT_KHR = new VkFormatFeatureFlagBits(4194304);
    ...
    public static final VkFormatFeatureFlagBits VK_FORMAT_FEATURE_MIDPOINT_CHROMA_SAMPLES_BIT_KHR = new VkFormatFeatureFlagBits(131072);
    ...
    public static final VkFormatFeatureFlagBits VK_FORMAT_FEATURE_SAMPLED_IMAGE_FILTER_CUBIC_BIT_IMG = new VkFormatFeatureFlagBits(8192);
    ...
    public static final VkFormatFeatureFlagBits VK_FORMAT_FEATURE_SAMPLED_IMAGE_FILTER_MINMAX_BIT_EXT = new VkFormatFeatureFlagBits(65536);
    ...
    public static final VkFormatFeatureFlagBits VK_FORMAT_FEATURE_SAMPLED_IMAGE_YCBCR_CONVERSION_CHROMA_RECONSTRUCTION_EXPLICIT_BIT_KHR = new VkFormatFeatureFlagBits(1048576);
    ...
    public static final VkFormatFeatureFlagBits VK_FORMAT_FEATURE_SAMPLED_IMAGE_YCBCR_CONVERSION_CHROMA_RECONSTRUCTION_EXPLICIT_FORCEABLE_BIT_KHR = new VkFormatFeatureFlagBits(2097152);
    ...
    public static final VkFormatFeatureFlagBits VK_FORMAT_FEATURE_SAMPLED_IMAGE_YCBCR_CONVERSION_LINEAR_FILTER_BIT_KHR = new VkFormatFeatureFlagBits(262144);
    ...
    public static final VkFormatFeatureFlagBits VK_FORMAT_FEATURE_SAMPLED_IMAGE_YCBCR_CONVERSION_SEPARATE_RECONSTRUCTION_FILTER_BIT_KHR = new VkFormatFeatureFlagBits(524288);
    ...
    public static final VkFormatFeatureFlagBits VK_FORMAT_FEATURE_TRANSFER_DST_BIT_KHR = new VkFormatFeatureFlagBits(32768);
    public static final VkFormatFeatureFlagBits VK_FORMAT_FEATURE_TRANSFER_SRC_BIT = new VkFormatFeatureFlagBits(16384);
    public static final VkFormatFeatureFlagBits VK_FORMAT_FEATURE_TRANSFER_SRC_BIT_KHR = new VkFormatFeatureFlagBits(16384);
