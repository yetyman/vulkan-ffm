...
public class tagNONCLIENTMETRICSW {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        ...
        VulkanWin32FFM.C_INT.withName("iBorderWidth"),
        VulkanWin32FFM.C_INT.withName("iScrollWidth"),
        VulkanWin32FFM.C_INT.withName("iScrollHeight"),
        VulkanWin32FFM.C_INT.withName("iCaptionWidth"),
        VulkanWin32FFM.C_INT.withName("iCaptionHeight"),
        tagLOGFONTW.layout().withName("lfCaptionFont"),
        VulkanWin32FFM.C_INT.withName("iSmCaptionWidth"),
        VulkanWin32FFM.C_INT.withName("iSmCaptionHeight"),
        tagLOGFONTW.layout().withName("lfSmCaptionFont"),
        VulkanWin32FFM.C_INT.withName("iMenuWidth"),
        VulkanWin32FFM.C_INT.withName("iMenuHeight"),
        tagLOGFONTW.layout().withName("lfMenuFont"),
        tagLOGFONTW.layout().withName("lfStatusFont"),
        tagLOGFONTW.layout().withName("lfMessageFont"),
        VulkanWin32FFM.C_INT.withName("iPaddedBorderWidth")
