...
public class StdVideoH265PictureParameterSet {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        ...
        VulkanWin32FFM.C_CHAR.withName("pps_pic_parameter_set_id"),
        VulkanWin32FFM.C_CHAR.withName("pps_seq_parameter_set_id"),
        VulkanWin32FFM.C_CHAR.withName("sps_video_parameter_set_id"),
        VulkanWin32FFM.C_CHAR.withName("num_extra_slice_header_bits"),
        VulkanWin32FFM.C_CHAR.withName("num_ref_idx_l0_default_active_minus1"),
        VulkanWin32FFM.C_CHAR.withName("num_ref_idx_l1_default_active_minus1"),
        VulkanWin32FFM.C_CHAR.withName("init_qp_minus26"),
        VulkanWin32FFM.C_CHAR.withName("diff_cu_qp_delta_depth"),
        VulkanWin32FFM.C_CHAR.withName("pps_cb_qp_offset"),
        VulkanWin32FFM.C_CHAR.withName("pps_cr_qp_offset"),
        VulkanWin32FFM.C_CHAR.withName("pps_beta_offset_div2"),
        VulkanWin32FFM.C_CHAR.withName("pps_tc_offset_div2"),
        VulkanWin32FFM.C_CHAR.withName("log2_parallel_merge_level_minus2"),
        VulkanWin32FFM.C_CHAR.withName("log2_max_transform_skip_block_size_minus2"),
        VulkanWin32FFM.C_CHAR.withName("diff_cu_chroma_qp_offset_depth"),
        VulkanWin32FFM.C_CHAR.withName("chroma_qp_offset_list_len_minus1"),
        MemoryLayout.sequenceLayout(6, VulkanWin32FFM.C_CHAR).withName("cb_qp_offset_list"),
        MemoryLayout.sequenceLayout(6, VulkanWin32FFM.C_CHAR).withName("cr_qp_offset_list"),
        VulkanWin32FFM.C_CHAR.withName("log2_sao_offset_scale_luma"),
        VulkanWin32FFM.C_CHAR.withName("log2_sao_offset_scale_chroma"),
        VulkanWin32FFM.C_CHAR.withName("pps_act_y_qp_offset_plus5"),
        VulkanWin32FFM.C_CHAR.withName("pps_act_cb_qp_offset_plus5"),
        VulkanWin32FFM.C_CHAR.withName("pps_act_cr_qp_offset_plus3"),
        VulkanWin32FFM.C_CHAR.withName("pps_num_palette_predictor_initializers"),
        VulkanWin32FFM.C_CHAR.withName("luma_bit_depth_entry_minus8"),
        VulkanWin32FFM.C_CHAR.withName("chroma_bit_depth_entry_minus8"),
        VulkanWin32FFM.C_CHAR.withName("num_tile_columns_minus1"),
        VulkanWin32FFM.C_CHAR.withName("num_tile_rows_minus1"),
        VulkanWin32FFM.C_CHAR.withName("reserved1"),
        VulkanWin32FFM.C_CHAR.withName("reserved2"),
        MemoryLayout.sequenceLayout(19, VulkanWin32FFM.C_SHORT).withName("column_width_minus1"),
        MemoryLayout.sequenceLayout(21, VulkanWin32FFM.C_SHORT).withName("row_height_minus1"),
    ...
    private static final long pps_pic_parameter_set_id$OFFSET = $LAYOUT.byteOffset(groupElement("pps_pic_parameter_set_id"));
    ...
    private static final long pps_seq_parameter_set_id$OFFSET = $LAYOUT.byteOffset(groupElement("pps_seq_parameter_set_id"));
    ...
    private static final long num_extra_slice_header_bits$OFFSET = $LAYOUT.byteOffset(groupElement("num_extra_slice_header_bits"));
    ...
    private static final long num_ref_idx_l0_default_active_minus1$OFFSET = $LAYOUT.byteOffset(groupElement("num_ref_idx_l0_default_active_minus1"));
    ...
    private static final long num_ref_idx_l1_default_active_minus1$OFFSET = $LAYOUT.byteOffset(groupElement("num_ref_idx_l1_default_active_minus1"));
    ...
    private static final long init_qp_minus26$OFFSET = $LAYOUT.byteOffset(groupElement("init_qp_minus26"));
    ...
    private static final long diff_cu_qp_delta_depth$OFFSET = $LAYOUT.byteOffset(groupElement("diff_cu_qp_delta_depth"));
    ...
    private static final long pps_cb_qp_offset$OFFSET = $LAYOUT.byteOffset(groupElement("pps_cb_qp_offset"));
    ...
    private static final long pps_cr_qp_offset$OFFSET = $LAYOUT.byteOffset(groupElement("pps_cr_qp_offset"));
    ...
    private static final long pps_beta_offset_div2$OFFSET = $LAYOUT.byteOffset(groupElement("pps_beta_offset_div2"));
    ...
    private static final long pps_tc_offset_div2$OFFSET = $LAYOUT.byteOffset(groupElement("pps_tc_offset_div2"));
    ...
    private static final long log2_parallel_merge_level_minus2$OFFSET = $LAYOUT.byteOffset(groupElement("log2_parallel_merge_level_minus2"));
    ...
    private static final long log2_max_transform_skip_block_size_minus2$OFFSET = $LAYOUT.byteOffset(groupElement("log2_max_transform_skip_block_size_minus2"));
    ...
    private static final long diff_cu_chroma_qp_offset_depth$OFFSET = $LAYOUT.byteOffset(groupElement("diff_cu_chroma_qp_offset_depth"));
    ...
    private static final long chroma_qp_offset_list_len_minus1$OFFSET = $LAYOUT.byteOffset(groupElement("chroma_qp_offset_list_len_minus1"));
    ...
    private static final long cb_qp_offset_list$OFFSET = $LAYOUT.byteOffset(groupElement("cb_qp_offset_list"));
    ...
    public static byte cb_qp_offset_list(MemorySegment struct, long index0) {
        return (byte)cb_qp_offset_list$ELEM_HANDLE.get(struct, cb_qp_offset_list$OFFSET, index0);
    }
    ...
    public static void cb_qp_offset_list(MemorySegment struct, long index0, byte fieldValue) {
        cb_qp_offset_list$ELEM_HANDLE.set(struct, cb_qp_offset_list$OFFSET, index0, fieldValue);
    }
    ...
    private static final long cr_qp_offset_list$OFFSET = $LAYOUT.byteOffset(groupElement("cr_qp_offset_list"));
    ...
    public static byte cr_qp_offset_list(MemorySegment struct, long index0) {
        return (byte)cr_qp_offset_list$ELEM_HANDLE.get(struct, cr_qp_offset_list$OFFSET, index0);
    }
    ...
    public static void cr_qp_offset_list(MemorySegment struct, long index0, byte fieldValue) {
        cr_qp_offset_list$ELEM_HANDLE.set(struct, cr_qp_offset_list$OFFSET, index0, fieldValue);
    }
    ...
    private static final long log2_sao_offset_scale_luma$OFFSET = $LAYOUT.byteOffset(groupElement("log2_sao_offset_scale_luma"));
    ...
    private static final long log2_sao_offset_scale_chroma$OFFSET = $LAYOUT.byteOffset(groupElement("log2_sao_offset_scale_chroma"));
    ...
    private static final long pps_act_y_qp_offset_plus5$OFFSET = $LAYOUT.byteOffset(groupElement("pps_act_y_qp_offset_plus5"));
    ...
    private static final long pps_act_cb_qp_offset_plus5$OFFSET = $LAYOUT.byteOffset(groupElement("pps_act_cb_qp_offset_plus5"));
    ...
    private static final long pps_act_cr_qp_offset_plus3$OFFSET = $LAYOUT.byteOffset(groupElement("pps_act_cr_qp_offset_plus3"));
    ...
    private static final long pps_num_palette_predictor_initializers$OFFSET = $LAYOUT.byteOffset(groupElement("pps_num_palette_predictor_initializers"));
    ...
    private static final long luma_bit_depth_entry_minus8$OFFSET = $LAYOUT.byteOffset(groupElement("luma_bit_depth_entry_minus8"));
    ...
    private static final long chroma_bit_depth_entry_minus8$OFFSET = $LAYOUT.byteOffset(groupElement("chroma_bit_depth_entry_minus8"));
    ...
    private static final long num_tile_columns_minus1$OFFSET = $LAYOUT.byteOffset(groupElement("num_tile_columns_minus1"));
    ...
    private static final long num_tile_rows_minus1$OFFSET = $LAYOUT.byteOffset(groupElement("num_tile_rows_minus1"));
    ...
    private static final long column_width_minus1$OFFSET = $LAYOUT.byteOffset(groupElement("column_width_minus1"));
    ...
    public static short column_width_minus1(MemorySegment struct, long index0) {
        return (short)column_width_minus1$ELEM_HANDLE.get(struct, column_width_minus1$OFFSET, index0);
    }
    ...
    public static void column_width_minus1(MemorySegment struct, long index0, short fieldValue) {
        column_width_minus1$ELEM_HANDLE.set(struct, column_width_minus1$OFFSET, index0, fieldValue);
    }
    ...
    private static final long row_height_minus1$OFFSET = $LAYOUT.byteOffset(groupElement("row_height_minus1"));
    ...
    public static short row_height_minus1(MemorySegment struct, long index0) {
        return (short)row_height_minus1$ELEM_HANDLE.get(struct, row_height_minus1$OFFSET, index0);
    }
    ...
    public static void row_height_minus1(MemorySegment struct, long index0, short fieldValue) {
        row_height_minus1$ELEM_HANDLE.set(struct, row_height_minus1$OFFSET, index0, fieldValue);
    }
