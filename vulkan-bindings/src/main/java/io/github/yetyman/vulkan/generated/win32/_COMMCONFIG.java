...
public class _COMMCONFIG {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        ...
        VulkanWin32FFM.C_SHORT.withName("wVersion"),
        VulkanWin32FFM.C_SHORT.withName("wReserved"),
        _DCB.layout().withName("dcb"),
        VulkanWin32FFM.C_LONG.withName("dwProviderSubType"),
        VulkanWin32FFM.C_LONG.withName("dwProviderOffset"),
        VulkanWin32FFM.C_LONG.withName("dwProviderSize"),
        MemoryLayout.sequenceLayout(1, VulkanWin32FFM.C_SHORT).withName("wcProviderData"),
