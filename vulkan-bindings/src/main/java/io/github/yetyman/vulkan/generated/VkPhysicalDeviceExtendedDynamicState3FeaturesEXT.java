...
public class VkPhysicalDeviceExtendedDynamicState3FeaturesEXT {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        ...
        VulkanFFM.C_INT.withName("extendedDynamicState3TessellationDomainOrigin"),
        VulkanFFM.C_INT.withName("extendedDynamicState3DepthClampEnable"),
        VulkanFFM.C_INT.withName("extendedDynamicState3PolygonMode"),
        VulkanFFM.C_INT.withName("extendedDynamicState3RasterizationSamples"),
        VulkanFFM.C_INT.withName("extendedDynamicState3SampleMask"),
        VulkanFFM.C_INT.withName("extendedDynamicState3AlphaToCoverageEnable"),
        VulkanFFM.C_INT.withName("extendedDynamicState3AlphaToOneEnable"),
        VulkanFFM.C_INT.withName("extendedDynamicState3LogicOpEnable"),
        VulkanFFM.C_INT.withName("extendedDynamicState3ColorBlendEnable"),
        VulkanFFM.C_INT.withName("extendedDynamicState3ColorBlendEquation"),
        VulkanFFM.C_INT.withName("extendedDynamicState3ColorWriteMask"),
        VulkanFFM.C_INT.withName("extendedDynamicState3RasterizationStream"),
        VulkanFFM.C_INT.withName("extendedDynamicState3ConservativeRasterizationMode"),
        VulkanFFM.C_INT.withName("extendedDynamicState3ExtraPrimitiveOverestimationSize"),
        VulkanFFM.C_INT.withName("extendedDynamicState3DepthClipEnable"),
        VulkanFFM.C_INT.withName("extendedDynamicState3SampleLocationsEnable"),
        VulkanFFM.C_INT.withName("extendedDynamicState3ColorBlendAdvanced"),
        VulkanFFM.C_INT.withName("extendedDynamicState3ProvokingVertexMode"),
        VulkanFFM.C_INT.withName("extendedDynamicState3LineRasterizationMode"),
        VulkanFFM.C_INT.withName("extendedDynamicState3LineStippleEnable"),
        VulkanFFM.C_INT.withName("extendedDynamicState3DepthClipNegativeOneToOne"),
        VulkanFFM.C_INT.withName("extendedDynamicState3ViewportWScalingEnable"),
        VulkanFFM.C_INT.withName("extendedDynamicState3ViewportSwizzle"),
        VulkanFFM.C_INT.withName("extendedDynamicState3CoverageToColorEnable"),
        VulkanFFM.C_INT.withName("extendedDynamicState3CoverageToColorLocation"),
        VulkanFFM.C_INT.withName("extendedDynamicState3CoverageModulationMode"),
        VulkanFFM.C_INT.withName("extendedDynamicState3CoverageModulationTableEnable"),
        VulkanFFM.C_INT.withName("extendedDynamicState3CoverageModulationTable"),
        VulkanFFM.C_INT.withName("extendedDynamicState3CoverageReductionMode"),
        VulkanFFM.C_INT.withName("extendedDynamicState3RepresentativeFragmentTestEnable"),
        VulkanFFM.C_INT.withName("extendedDynamicState3ShadingRateImageEnable"),
        MemoryLayout.paddingLayout(4)
