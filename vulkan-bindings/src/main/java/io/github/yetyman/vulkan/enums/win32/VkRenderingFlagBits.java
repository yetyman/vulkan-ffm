...
public record VkRenderingFlagBits(int value) {
    ...
    public static final VkRenderingFlagBits VK_RENDERING_CONTENTS_INLINE_BIT_KHR = new VkRenderingFlagBits(16);
    public static final VkRenderingFlagBits VK_RENDERING_CONTENTS_SECONDARY_COMMAND_BUFFERS_BIT = new VkRenderingFlagBits(1);
    public static final VkRenderingFlagBits VK_RENDERING_CONTENTS_SECONDARY_COMMAND_BUFFERS_BIT_KHR = new VkRenderingFlagBits(1);
    ...
    public static final VkRenderingFlagBits VK_RENDERING_RESUMING_BIT_KHR = new VkRenderingFlagBits(4);
    public static final VkRenderingFlagBits VK_RENDERING_SUSPENDING_BIT = new VkRenderingFlagBits(2);
    public static final VkRenderingFlagBits VK_RENDERING_SUSPENDING_BIT_KHR = new VkRenderingFlagBits(2);
