...
public record VkIndexType(int value) {
    ...
    public static final VkIndexType VK_INDEX_TYPE_NONE_NV = new VkIndexType(1000165000);
    ...
    public static final VkIndexType VK_INDEX_TYPE_UINT8_EXT = new VkIndexType(1000265000);
    public static final VkIndexType VK_INDEX_TYPE_UINT8_KHR = new VkIndexType(1000265000);
