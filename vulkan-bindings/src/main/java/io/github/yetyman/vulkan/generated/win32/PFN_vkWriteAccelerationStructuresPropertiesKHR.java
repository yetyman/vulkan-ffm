...
/**
 * {@snippet lang=c :
 * typedef VkResult (*PFN_vkWriteAccelerationStructuresPropertiesKHR)(VkDevice, uint32_t, const VkAccelerationStructureKHR *, VkQueryType, size_t, void *, size_t) __attribute__((stdcall))
 * }
 */
public final class PFN_vkWriteAccelerationStructuresPropertiesKHR {

    private PFN_vkWriteAccelerationStructuresPropertiesKHR() {
    ...
    private static final MethodHandle UP$MH = VulkanWin32FFM.upcallHandle(PFN_vkWriteAccelerationStructuresPropertiesKHR.Function.class, "apply", $DESC);
