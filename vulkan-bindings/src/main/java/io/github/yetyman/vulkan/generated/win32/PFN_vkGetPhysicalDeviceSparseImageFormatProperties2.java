...
/**
 * {@snippet lang=c :
 * typedef void (*PFN_vkGetPhysicalDeviceSparseImageFormatProperties2)(VkPhysicalDevice, const VkPhysicalDeviceSparseImageFormatInfo2 *, uint32_t *, VkSparseImageFormatProperties2 *) __attribute__((stdcall))
 * }
 */
public final class PFN_vkGetPhysicalDeviceSparseImageFormatProperties2 {

    private PFN_vkGetPhysicalDeviceSparseImageFormatProperties2() {
    ...
    private static final MethodHandle UP$MH = VulkanWin32FFM.upcallHandle(PFN_vkGetPhysicalDeviceSparseImageFormatProperties2.Function.class, "apply", $DESC);
