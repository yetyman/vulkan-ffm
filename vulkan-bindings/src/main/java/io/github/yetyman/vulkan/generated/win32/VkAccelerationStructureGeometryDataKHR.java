...
public class VkAccelerationStructureGeometryDataKHR {
    ...
    private static final long triangles$OFFSET = $LAYOUT.byteOffset(groupElement("triangles"));
    ...
    private static final long aabbs$OFFSET = $LAYOUT.byteOffset(groupElement("aabbs"));
    ...
    private static final long instances$OFFSET = $LAYOUT.byteOffset(groupElement("instances"));
