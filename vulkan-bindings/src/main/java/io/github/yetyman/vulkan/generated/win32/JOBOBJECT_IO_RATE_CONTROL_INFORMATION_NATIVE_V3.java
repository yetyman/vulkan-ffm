...
public class JOBOBJECT_IO_RATE_CONTROL_INFORMATION_NATIVE_V3 {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        VulkanWin32FFM.C_LONG_LONG.withName("MaxIops"),
        VulkanWin32FFM.C_LONG_LONG.withName("MaxBandwidth"),
        VulkanWin32FFM.C_LONG_LONG.withName("ReservationIops"),
        VulkanWin32FFM.C_POINTER.withName("VolumeName"),
        VulkanWin32FFM.C_LONG.withName("BaseIoSize"),
        VulkanWin32FFM.C_INT.withName("ControlFlags"),
        VulkanWin32FFM.C_SHORT.withName("VolumeNameLength"),
        MemoryLayout.paddingLayout(6),
        VulkanWin32FFM.C_LONG_LONG.withName("CriticalReservationIops"),
        VulkanWin32FFM.C_LONG_LONG.withName("ReservationBandwidth"),
        VulkanWin32FFM.C_LONG_LONG.withName("CriticalReservationBandwidth"),
        VulkanWin32FFM.C_LONG_LONG.withName("MaxTimePercent"),
        VulkanWin32FFM.C_LONG_LONG.withName("ReservationTimePercent"),
        VulkanWin32FFM.C_LONG_LONG.withName("CriticalReservationTimePercent"),
        VulkanWin32FFM.C_LONG_LONG.withName("SoftMaxIops"),
        VulkanWin32FFM.C_LONG_LONG.withName("SoftMaxBandwidth"),
        VulkanWin32FFM.C_LONG_LONG.withName("SoftMaxTimePercent"),
        VulkanWin32FFM.C_LONG_LONG.withName("LimitExcessNotifyIops"),
        VulkanWin32FFM.C_LONG_LONG.withName("LimitExcessNotifyBandwidth"),
        VulkanWin32FFM.C_LONG_LONG.withName("LimitExcessNotifyTimePercent")
