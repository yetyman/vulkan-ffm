...
public class _JOBOBJECT_BASIC_PROCESS_ID_LIST {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        VulkanWin32FFM.C_LONG.withName("NumberOfAssignedProcesses"),
        VulkanWin32FFM.C_LONG.withName("NumberOfProcessIdsInList"),
        MemoryLayout.sequenceLayout(1, VulkanWin32FFM.C_LONG_LONG).withName("ProcessIdList")
