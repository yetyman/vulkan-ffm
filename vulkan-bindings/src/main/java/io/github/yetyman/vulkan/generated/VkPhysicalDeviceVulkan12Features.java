...
public class VkPhysicalDeviceVulkan12Features {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        ...
        VulkanFFM.C_INT.withName("samplerMirrorClampToEdge"),
        VulkanFFM.C_INT.withName("drawIndirectCount"),
        VulkanFFM.C_INT.withName("storageBuffer8BitAccess"),
        VulkanFFM.C_INT.withName("uniformAndStorageBuffer8BitAccess"),
        VulkanFFM.C_INT.withName("storagePushConstant8"),
        VulkanFFM.C_INT.withName("shaderBufferInt64Atomics"),
        VulkanFFM.C_INT.withName("shaderSharedInt64Atomics"),
        VulkanFFM.C_INT.withName("shaderFloat16"),
        VulkanFFM.C_INT.withName("shaderInt8"),
        VulkanFFM.C_INT.withName("descriptorIndexing"),
        VulkanFFM.C_INT.withName("shaderInputAttachmentArrayDynamicIndexing"),
        VulkanFFM.C_INT.withName("shaderUniformTexelBufferArrayDynamicIndexing"),
        VulkanFFM.C_INT.withName("shaderStorageTexelBufferArrayDynamicIndexing"),
        VulkanFFM.C_INT.withName("shaderUniformBufferArrayNonUniformIndexing"),
        VulkanFFM.C_INT.withName("shaderSampledImageArrayNonUniformIndexing"),
        VulkanFFM.C_INT.withName("shaderStorageBufferArrayNonUniformIndexing"),
        VulkanFFM.C_INT.withName("shaderStorageImageArrayNonUniformIndexing"),
        VulkanFFM.C_INT.withName("shaderInputAttachmentArrayNonUniformIndexing"),
        VulkanFFM.C_INT.withName("shaderUniformTexelBufferArrayNonUniformIndexing"),
        VulkanFFM.C_INT.withName("shaderStorageTexelBufferArrayNonUniformIndexing"),
        VulkanFFM.C_INT.withName("descriptorBindingUniformBufferUpdateAfterBind"),
        VulkanFFM.C_INT.withName("descriptorBindingSampledImageUpdateAfterBind"),
        VulkanFFM.C_INT.withName("descriptorBindingStorageImageUpdateAfterBind"),
        VulkanFFM.C_INT.withName("descriptorBindingStorageBufferUpdateAfterBind"),
        VulkanFFM.C_INT.withName("descriptorBindingUniformTexelBufferUpdateAfterBind"),
        VulkanFFM.C_INT.withName("descriptorBindingStorageTexelBufferUpdateAfterBind"),
        VulkanFFM.C_INT.withName("descriptorBindingUpdateUnusedWhilePending"),
        VulkanFFM.C_INT.withName("descriptorBindingPartiallyBound"),
        VulkanFFM.C_INT.withName("descriptorBindingVariableDescriptorCount"),
        VulkanFFM.C_INT.withName("runtimeDescriptorArray"),
        VulkanFFM.C_INT.withName("samplerFilterMinmax"),
        VulkanFFM.C_INT.withName("scalarBlockLayout"),
        VulkanFFM.C_INT.withName("imagelessFramebuffer"),
        VulkanFFM.C_INT.withName("uniformBufferStandardLayout"),
        VulkanFFM.C_INT.withName("shaderSubgroupExtendedTypes"),
        VulkanFFM.C_INT.withName("separateDepthStencilLayouts"),
        VulkanFFM.C_INT.withName("hostQueryReset"),
        VulkanFFM.C_INT.withName("timelineSemaphore"),
        VulkanFFM.C_INT.withName("bufferDeviceAddress"),
        VulkanFFM.C_INT.withName("bufferDeviceAddressCaptureReplay"),
        VulkanFFM.C_INT.withName("bufferDeviceAddressMultiDevice"),
        VulkanFFM.C_INT.withName("vulkanMemoryModel"),
        VulkanFFM.C_INT.withName("vulkanMemoryModelDeviceScope"),
        VulkanFFM.C_INT.withName("vulkanMemoryModelAvailabilityVisibilityChains"),
        VulkanFFM.C_INT.withName("shaderOutputViewportIndex"),
        VulkanFFM.C_INT.withName("shaderOutputLayer"),
        VulkanFFM.C_INT.withName("subgroupBroadcastDynamicId"),
        MemoryLayout.paddingLayout(4)
