...
public class StdVideoAV1FilmGrain {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        ...
        VulkanWin32FFM.C_CHAR.withName("grain_scaling_minus_8"),
        VulkanWin32FFM.C_CHAR.withName("ar_coeff_lag"),
        VulkanWin32FFM.C_CHAR.withName("ar_coeff_shift_minus_6"),
        VulkanWin32FFM.C_CHAR.withName("grain_scale_shift"),
        VulkanWin32FFM.C_SHORT.withName("grain_seed"),
        VulkanWin32FFM.C_CHAR.withName("film_grain_params_ref_idx"),
        VulkanWin32FFM.C_CHAR.withName("num_y_points"),
        MemoryLayout.sequenceLayout(14, VulkanWin32FFM.C_CHAR).withName("point_y_value"),
        MemoryLayout.sequenceLayout(14, VulkanWin32FFM.C_CHAR).withName("point_y_scaling"),
        VulkanWin32FFM.C_CHAR.withName("num_cb_points"),
        MemoryLayout.sequenceLayout(10, VulkanWin32FFM.C_CHAR).withName("point_cb_value"),
        MemoryLayout.sequenceLayout(10, VulkanWin32FFM.C_CHAR).withName("point_cb_scaling"),
        VulkanWin32FFM.C_CHAR.withName("num_cr_points"),
        MemoryLayout.sequenceLayout(10, VulkanWin32FFM.C_CHAR).withName("point_cr_value"),
        MemoryLayout.sequenceLayout(10, VulkanWin32FFM.C_CHAR).withName("point_cr_scaling"),
        MemoryLayout.sequenceLayout(24, VulkanWin32FFM.C_CHAR).withName("ar_coeffs_y_plus_128"),
        MemoryLayout.sequenceLayout(25, VulkanWin32FFM.C_CHAR).withName("ar_coeffs_cb_plus_128"),
        MemoryLayout.sequenceLayout(25, VulkanWin32FFM.C_CHAR).withName("ar_coeffs_cr_plus_128"),
        VulkanWin32FFM.C_CHAR.withName("cb_mult"),
        VulkanWin32FFM.C_CHAR.withName("cb_luma_mult"),
        VulkanWin32FFM.C_SHORT.withName("cb_offset"),
        VulkanWin32FFM.C_CHAR.withName("cr_mult"),
        VulkanWin32FFM.C_CHAR.withName("cr_luma_mult"),
        VulkanWin32FFM.C_SHORT.withName("cr_offset")
    ...
    private static final long grain_scaling_minus_8$OFFSET = $LAYOUT.byteOffset(groupElement("grain_scaling_minus_8"));
    ...
    private static final long ar_coeff_shift_minus_6$OFFSET = $LAYOUT.byteOffset(groupElement("ar_coeff_shift_minus_6"));
    ...
    private static final long grain_seed$OFFSET = $LAYOUT.byteOffset(groupElement("grain_seed"));
    ...
    private static final long film_grain_params_ref_idx$OFFSET = $LAYOUT.byteOffset(groupElement("film_grain_params_ref_idx"));
    ...
    private static final long point_y_value$OFFSET = $LAYOUT.byteOffset(groupElement("point_y_value"));
    ...
    public static byte point_y_value(MemorySegment struct, long index0) {
        return (byte)point_y_value$ELEM_HANDLE.get(struct, point_y_value$OFFSET, index0);
    }
    ...
    public static void point_y_value(MemorySegment struct, long index0, byte fieldValue) {
        point_y_value$ELEM_HANDLE.set(struct, point_y_value$OFFSET, index0, fieldValue);
    }
    ...
    private static final long point_y_scaling$OFFSET = $LAYOUT.byteOffset(groupElement("point_y_scaling"));
    ...
    public static byte point_y_scaling(MemorySegment struct, long index0) {
        return (byte)point_y_scaling$ELEM_HANDLE.get(struct, point_y_scaling$OFFSET, index0);
    }
    ...
    public static void point_y_scaling(MemorySegment struct, long index0, byte fieldValue) {
        point_y_scaling$ELEM_HANDLE.set(struct, point_y_scaling$OFFSET, index0, fieldValue);
    }
    ...
    private static final long num_cb_points$OFFSET = $LAYOUT.byteOffset(groupElement("num_cb_points"));
    ...
    private static final long point_cb_value$OFFSET = $LAYOUT.byteOffset(groupElement("point_cb_value"));
    ...
    public static byte point_cb_value(MemorySegment struct, long index0) {
        return (byte)point_cb_value$ELEM_HANDLE.get(struct, point_cb_value$OFFSET, index0);
    }
    ...
    public static void point_cb_value(MemorySegment struct, long index0, byte fieldValue) {
        point_cb_value$ELEM_HANDLE.set(struct, point_cb_value$OFFSET, index0, fieldValue);
    }
    ...
    private static final long point_cb_scaling$OFFSET = $LAYOUT.byteOffset(groupElement("point_cb_scaling"));
    ...
    public static byte point_cb_scaling(MemorySegment struct, long index0) {
        return (byte)point_cb_scaling$ELEM_HANDLE.get(struct, point_cb_scaling$OFFSET, index0);
    }
    ...
    public static void point_cb_scaling(MemorySegment struct, long index0, byte fieldValue) {
        point_cb_scaling$ELEM_HANDLE.set(struct, point_cb_scaling$OFFSET, index0, fieldValue);
    }
    ...
    private static final long num_cr_points$OFFSET = $LAYOUT.byteOffset(groupElement("num_cr_points"));
    ...
    private static final long point_cr_value$OFFSET = $LAYOUT.byteOffset(groupElement("point_cr_value"));
    ...
    public static byte point_cr_value(MemorySegment struct, long index0) {
        return (byte)point_cr_value$ELEM_HANDLE.get(struct, point_cr_value$OFFSET, index0);
    }
    ...
    public static void point_cr_value(MemorySegment struct, long index0, byte fieldValue) {
        point_cr_value$ELEM_HANDLE.set(struct, point_cr_value$OFFSET, index0, fieldValue);
    }
    ...
    private static final long point_cr_scaling$OFFSET = $LAYOUT.byteOffset(groupElement("point_cr_scaling"));
    ...
    public static byte point_cr_scaling(MemorySegment struct, long index0) {
        return (byte)point_cr_scaling$ELEM_HANDLE.get(struct, point_cr_scaling$OFFSET, index0);
    }
    ...
    public static void point_cr_scaling(MemorySegment struct, long index0, byte fieldValue) {
        point_cr_scaling$ELEM_HANDLE.set(struct, point_cr_scaling$OFFSET, index0, fieldValue);
    }
    ...
    private static final long ar_coeffs_y_plus_128$OFFSET = $LAYOUT.byteOffset(groupElement("ar_coeffs_y_plus_128"));
    ...
    public static byte ar_coeffs_y_plus_128(MemorySegment struct, long index0) {
        return (byte)ar_coeffs_y_plus_128$ELEM_HANDLE.get(struct, ar_coeffs_y_plus_128$OFFSET, index0);
    }
    ...
    public static void ar_coeffs_y_plus_128(MemorySegment struct, long index0, byte fieldValue) {
        ar_coeffs_y_plus_128$ELEM_HANDLE.set(struct, ar_coeffs_y_plus_128$OFFSET, index0, fieldValue);
    }
    ...
    private static final long ar_coeffs_cb_plus_128$OFFSET = $LAYOUT.byteOffset(groupElement("ar_coeffs_cb_plus_128"));
    ...
    public static byte ar_coeffs_cb_plus_128(MemorySegment struct, long index0) {
        return (byte)ar_coeffs_cb_plus_128$ELEM_HANDLE.get(struct, ar_coeffs_cb_plus_128$OFFSET, index0);
    }
    ...
    public static void ar_coeffs_cb_plus_128(MemorySegment struct, long index0, byte fieldValue) {
        ar_coeffs_cb_plus_128$ELEM_HANDLE.set(struct, ar_coeffs_cb_plus_128$OFFSET, index0, fieldValue);
    }
    ...
    private static final long ar_coeffs_cr_plus_128$OFFSET = $LAYOUT.byteOffset(groupElement("ar_coeffs_cr_plus_128"));
    ...
    public static byte ar_coeffs_cr_plus_128(MemorySegment struct, long index0) {
        return (byte)ar_coeffs_cr_plus_128$ELEM_HANDLE.get(struct, ar_coeffs_cr_plus_128$OFFSET, index0);
    }
    ...
    public static void ar_coeffs_cr_plus_128(MemorySegment struct, long index0, byte fieldValue) {
        ar_coeffs_cr_plus_128$ELEM_HANDLE.set(struct, ar_coeffs_cr_plus_128$OFFSET, index0, fieldValue);
    }
    ...
    private static final long cb_mult$OFFSET = $LAYOUT.byteOffset(groupElement("cb_mult"));
    ...
    private static final long cb_luma_mult$OFFSET = $LAYOUT.byteOffset(groupElement("cb_luma_mult"));
    ...
    private static final long cb_offset$OFFSET = $LAYOUT.byteOffset(groupElement("cb_offset"));
    ...
    private static final long cr_mult$OFFSET = $LAYOUT.byteOffset(groupElement("cr_mult"));
    ...
    private static final long cr_luma_mult$OFFSET = $LAYOUT.byteOffset(groupElement("cr_luma_mult"));
    ...
    private static final long cr_offset$OFFSET = $LAYOUT.byteOffset(groupElement("cr_offset"));
