...
public class _IMAGE_RELOCATION {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        MemoryLayout.unionLayout(
            VulkanWin32FFM.align(VulkanWin32FFM.C_LONG, 2).withName("VirtualAddress"),
            VulkanWin32FFM.align(VulkanWin32FFM.C_LONG, 2).withName("RelocCount")
        ).withName("$anon$19013:5"),
        VulkanWin32FFM.align(VulkanWin32FFM.C_LONG, 2).withName("SymbolTableIndex"),
    ...
    private static final OfInt VirtualAddress$LAYOUT = (OfInt)$LAYOUT.select(groupElement("$anon$19013:5"), groupElement("VirtualAddress"));
    ...
    private static final long VirtualAddress$OFFSET = $LAYOUT.byteOffset(groupElement("$anon$19013:5"), groupElement("VirtualAddress"));
    ...
    private static final OfInt RelocCount$LAYOUT = (OfInt)$LAYOUT.select(groupElement("$anon$19013:5"), groupElement("RelocCount"));
    ...
    private static final long RelocCount$OFFSET = $LAYOUT.byteOffset(groupElement("$anon$19013:5"), groupElement("RelocCount"));
