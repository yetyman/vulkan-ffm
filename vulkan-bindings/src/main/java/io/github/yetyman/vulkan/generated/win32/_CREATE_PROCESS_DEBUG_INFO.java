...
public class _CREATE_PROCESS_DEBUG_INFO {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        VulkanWin32FFM.C_POINTER.withName("hFile"),
        VulkanWin32FFM.C_POINTER.withName("hProcess"),
        VulkanWin32FFM.C_POINTER.withName("hThread"),
        VulkanWin32FFM.C_POINTER.withName("lpBaseOfImage"),
        VulkanWin32FFM.C_LONG.withName("dwDebugInfoFileOffset"),
        VulkanWin32FFM.C_LONG.withName("nDebugInfoSize"),
        VulkanWin32FFM.C_POINTER.withName("lpThreadLocalBase"),
        VulkanWin32FFM.C_POINTER.withName("lpStartAddress"),
        VulkanWin32FFM.C_POINTER.withName("lpImageName"),
        VulkanWin32FFM.C_SHORT.withName("fUnicode"),
