...
public class VkSampleLocationsInfoEXT {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        ...
        VulkanWin32FFM.C_INT.withName("sampleLocationsPerPixel"),
        VkExtent2D.layout().withName("sampleLocationGridSize"),
        VulkanWin32FFM.C_INT.withName("sampleLocationsCount"),
        VulkanWin32FFM.C_POINTER.withName("pSampleLocations")
    ...
    private static final long sampleLocationsPerPixel$OFFSET = $LAYOUT.byteOffset(groupElement("sampleLocationsPerPixel"));
    ...
    private static final long sampleLocationGridSize$OFFSET = $LAYOUT.byteOffset(groupElement("sampleLocationGridSize"));
