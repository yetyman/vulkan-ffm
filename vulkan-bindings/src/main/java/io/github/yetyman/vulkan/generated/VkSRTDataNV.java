...
public class VkSRTDataNV {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        VulkanFFM.C_FLOAT.withName("sx"),
        VulkanFFM.C_FLOAT.withName("a"),
        VulkanFFM.C_FLOAT.withName("b"),
        VulkanFFM.C_FLOAT.withName("pvx"),
        VulkanFFM.C_FLOAT.withName("sy"),
        VulkanFFM.C_FLOAT.withName("c"),
        VulkanFFM.C_FLOAT.withName("pvy"),
        VulkanFFM.C_FLOAT.withName("sz"),
        VulkanFFM.C_FLOAT.withName("pvz"),
        VulkanFFM.C_FLOAT.withName("qx"),
        VulkanFFM.C_FLOAT.withName("qy"),
        VulkanFFM.C_FLOAT.withName("qz"),
        VulkanFFM.C_FLOAT.withName("qw"),
        VulkanFFM.C_FLOAT.withName("tx"),
        VulkanFFM.C_FLOAT.withName("ty"),
        VulkanFFM.C_FLOAT.withName("tz")
