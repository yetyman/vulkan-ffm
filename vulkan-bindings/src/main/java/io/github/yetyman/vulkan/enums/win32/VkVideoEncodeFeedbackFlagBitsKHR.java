...
/**
 * Constants for VkVideoEncodeFeedbackFlagBitsKHR
 * Generated from jextract bindings
 */
public final class VkVideoEncodeFeedbackFlagBitsKHR {
    private VkVideoEncodeFeedbackFlagBitsKHR() {}
    ...
    public static final int VK_VIDEO_ENCODE_FEEDBACK_FLAG_BITS_MAX_ENUM_KHR = 2147483647;
}
