...
public class StdVideoEncodeH265LongTermRefPics {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        VulkanFFM.C_CHAR.withName("num_long_term_sps"),
        VulkanFFM.C_CHAR.withName("num_long_term_pics"),
        MemoryLayout.sequenceLayout(32, VulkanFFM.C_CHAR).withName("lt_idx_sps"),
        MemoryLayout.sequenceLayout(16, VulkanFFM.C_CHAR).withName("poc_lsb_lt"),
        VulkanFFM.C_SHORT.withName("used_by_curr_pic_lt_flag"),
        MemoryLayout.sequenceLayout(48, VulkanFFM.C_CHAR).withName("delta_poc_msb_present_flag"),
        MemoryLayout.sequenceLayout(48, VulkanFFM.C_CHAR).withName("delta_poc_msb_cycle_lt")
