...
public record VkAttachmentLoadOp(int value) {
    ...
    public static final VkAttachmentLoadOp VK_ATTACHMENT_LOAD_OP_NONE_EXT = VK_ATTACHMENT_LOAD_OP_NONE;
    public static final VkAttachmentLoadOp VK_ATTACHMENT_LOAD_OP_NONE_KHR = VK_ATTACHMENT_LOAD_OP_NONE;
