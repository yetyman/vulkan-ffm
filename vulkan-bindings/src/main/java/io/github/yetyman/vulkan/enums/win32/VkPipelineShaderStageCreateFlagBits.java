...
public record VkPipelineShaderStageCreateFlagBits(int value) {
    ...
    public static final VkPipelineShaderStageCreateFlagBits VK_PIPELINE_SHADER_STAGE_CREATE_ALLOW_VARYING_SUBGROUP_SIZE_BIT_EXT = new VkPipelineShaderStageCreateFlagBits(1);
    ...
    public static final VkPipelineShaderStageCreateFlagBits VK_PIPELINE_SHADER_STAGE_CREATE_REQUIRE_FULL_SUBGROUPS_BIT_EXT = new VkPipelineShaderStageCreateFlagBits(2);
