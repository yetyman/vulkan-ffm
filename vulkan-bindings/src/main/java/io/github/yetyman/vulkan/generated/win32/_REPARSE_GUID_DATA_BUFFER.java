...
public class _REPARSE_GUID_DATA_BUFFER {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        VulkanWin32FFM.C_LONG.withName("ReparseTag"),
        VulkanWin32FFM.C_SHORT.withName("ReparseDataLength"),
    ...
    public static class GenericReparseBuffer {
        ...
        private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
            MemoryLayout.sequenceLayout(1, VulkanWin32FFM.C_CHAR).withName("DataBuffer")
        ).withName("$anon$14588:5");
