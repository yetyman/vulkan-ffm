...
/**
 * {@snippet lang=c :
 * typedef VkResult (*PFN_vkGetPhysicalDeviceSurfaceCapabilities2EXT)(VkPhysicalDevice, VkSurfaceKHR, VkSurfaceCapabilities2EXT *) __attribute__((stdcall))
 * }
 */
public final class PFN_vkGetPhysicalDeviceSurfaceCapabilities2EXT {

    private PFN_vkGetPhysicalDeviceSurfaceCapabilities2EXT() {
    ...
    private static final MethodHandle UP$MH = VulkanWin32FFM.upcallHandle(PFN_vkGetPhysicalDeviceSurfaceCapabilities2EXT.Function.class, "apply", $DESC);
