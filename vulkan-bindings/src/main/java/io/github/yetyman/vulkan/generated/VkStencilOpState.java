...
public class VkStencilOpState {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        VulkanFFM.C_INT.withName("failOp"),
        VulkanFFM.C_INT.withName("passOp"),
        VulkanFFM.C_INT.withName("depthFailOp"),
        VulkanFFM.C_INT.withName("compareOp"),
        VulkanFFM.C_INT.withName("compareMask"),
        VulkanFFM.C_INT.withName("writeMask"),
        VulkanFFM.C_INT.withName("reference")
