...
/**
 * {@snippet lang=c :
 * typedef void (*PFN_vkCmdSetCoverageToColorEnableNV)(VkCommandBuffer, VkBool32) __attribute__((stdcall))
 * }
 */
public final class PFN_vkCmdSetCoverageToColorEnableNV {

    private PFN_vkCmdSetCoverageToColorEnableNV() {
    ...
    private static final MethodHandle UP$MH = VulkanWin32FFM.upcallHandle(PFN_vkCmdSetCoverageToColorEnableNV.Function.class, "apply", $DESC);
