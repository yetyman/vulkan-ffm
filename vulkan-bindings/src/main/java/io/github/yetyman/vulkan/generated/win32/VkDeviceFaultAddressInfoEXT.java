...
public class VkDeviceFaultAddressInfoEXT {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        VulkanWin32FFM.C_INT.withName("addressType"),
        MemoryLayout.paddingLayout(4),
        VulkanWin32FFM.C_LONG_LONG.withName("reportedAddress"),
        VulkanWin32FFM.C_LONG_LONG.withName("addressPrecision")
    ...
    private static final long reportedAddress$OFFSET = $LAYOUT.byteOffset(groupElement("reportedAddress"));
    ...
    private static final long addressPrecision$OFFSET = $LAYOUT.byteOffset(groupElement("addressPrecision"));
