...
public class value_entA {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        VulkanWin32FFM.C_POINTER.withName("ve_valuename"),
        VulkanWin32FFM.C_LONG.withName("ve_valuelen"),
        MemoryLayout.paddingLayout(4),
        VulkanWin32FFM.C_LONG_LONG.withName("ve_valueptr"),
        VulkanWin32FFM.C_LONG.withName("ve_type"),
        MemoryLayout.paddingLayout(4)
    ).withName("value_entA");
