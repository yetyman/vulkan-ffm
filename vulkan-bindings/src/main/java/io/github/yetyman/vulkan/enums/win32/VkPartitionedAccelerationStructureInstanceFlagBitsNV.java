...
/**
 * Constants for VkPartitionedAccelerationStructureInstanceFlagBitsNV
 * Generated from jextract bindings
 */
public final class VkPartitionedAccelerationStructureInstanceFlagBitsNV {
    private VkPartitionedAccelerationStructureInstanceFlagBitsNV() {}

    public static final int VK_PARTITIONED_ACCELERATION_STRUCTURE_INSTANCE_FLAG_BITS_MAX_ENUM_NV = 2147483647;
