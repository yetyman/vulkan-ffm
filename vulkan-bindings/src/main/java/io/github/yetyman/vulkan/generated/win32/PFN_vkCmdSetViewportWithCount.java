...
/**
 * {@snippet lang=c :
 * typedef void (*PFN_vkCmdSetViewportWithCount)(VkCommandBuffer, uint32_t, const VkViewport *) __attribute__((stdcall))
 * }
 */
public final class PFN_vkCmdSetViewportWithCount {

    private PFN_vkCmdSetViewportWithCount() {
    ...
    private static final MethodHandle UP$MH = VulkanWin32FFM.upcallHandle(PFN_vkCmdSetViewportWithCount.Function.class, "apply", $DESC);
