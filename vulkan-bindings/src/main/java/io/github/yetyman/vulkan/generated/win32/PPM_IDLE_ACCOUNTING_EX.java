...
public class PPM_IDLE_ACCOUNTING_EX {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        VulkanWin32FFM.C_LONG.withName("StateCount"),
        VulkanWin32FFM.C_LONG.withName("TotalTransitions"),
        VulkanWin32FFM.C_LONG.withName("ResetCount"),
        VulkanWin32FFM.C_LONG.withName("AbortCount"),
        VulkanWin32FFM.C_LONG_LONG.withName("StartTime"),
        MemoryLayout.sequenceLayout(1, PPM_IDLE_STATE_ACCOUNTING_EX.layout()).withName("State")
    ).withName("$anon$17702:9");
