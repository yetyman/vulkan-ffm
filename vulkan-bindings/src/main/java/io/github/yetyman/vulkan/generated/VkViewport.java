...
public class VkViewport {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        VulkanFFM.C_FLOAT.withName("x"),
        VulkanFFM.C_FLOAT.withName("y"),
        VulkanFFM.C_FLOAT.withName("width"),
        VulkanFFM.C_FLOAT.withName("height"),
        VulkanFFM.C_FLOAT.withName("minDepth"),
        VulkanFFM.C_FLOAT.withName("maxDepth")
    ).withName("VkViewport");
