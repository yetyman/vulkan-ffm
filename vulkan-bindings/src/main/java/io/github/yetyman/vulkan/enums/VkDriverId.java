...
public record VkDriverId(int value) {
    ...
    public static final VkDriverId VK_DRIVER_ID_AMD_OPEN_SOURCE_KHR = VK_DRIVER_ID_AMD_OPEN_SOURCE;
    public static final VkDriverId VK_DRIVER_ID_AMD_PROPRIETARY = new VkDriverId(1);
    public static final VkDriverId VK_DRIVER_ID_AMD_PROPRIETARY_KHR = VK_DRIVER_ID_AMD_PROPRIETARY;
    public static final VkDriverId VK_DRIVER_ID_ARM_PROPRIETARY = new VkDriverId(9);
    public static final VkDriverId VK_DRIVER_ID_ARM_PROPRIETARY_KHR = VK_DRIVER_ID_ARM_PROPRIETARY;
    public static final VkDriverId VK_DRIVER_ID_BROADCOM_PROPRIETARY = new VkDriverId(12);
    public static final VkDriverId VK_DRIVER_ID_BROADCOM_PROPRIETARY_KHR = VK_DRIVER_ID_BROADCOM_PROPRIETARY;
    ...
    public static final VkDriverId VK_DRIVER_ID_GGP_PROPRIETARY_KHR = VK_DRIVER_ID_GGP_PROPRIETARY;
    public static final VkDriverId VK_DRIVER_ID_GOOGLE_SWIFTSHADER = new VkDriverId(10);
    public static final VkDriverId VK_DRIVER_ID_GOOGLE_SWIFTSHADER_KHR = VK_DRIVER_ID_GOOGLE_SWIFTSHADER;
    ...
    public static final VkDriverId VK_DRIVER_ID_IMAGINATION_PROPRIETARY_KHR = VK_DRIVER_ID_IMAGINATION_PROPRIETARY;
    public static final VkDriverId VK_DRIVER_ID_INTEL_OPEN_SOURCE_MESA = new VkDriverId(6);
    public static final VkDriverId VK_DRIVER_ID_INTEL_OPEN_SOURCE_MESA_KHR = VK_DRIVER_ID_INTEL_OPEN_SOURCE_MESA;
    public static final VkDriverId VK_DRIVER_ID_INTEL_PROPRIETARY_WINDOWS = new VkDriverId(5);
    public static final VkDriverId VK_DRIVER_ID_INTEL_PROPRIETARY_WINDOWS_KHR = VK_DRIVER_ID_INTEL_PROPRIETARY_WINDOWS;
    ...
    public static final VkDriverId VK_DRIVER_ID_MESA_RADV_KHR = VK_DRIVER_ID_MESA_RADV;
    ...
    public static final VkDriverId VK_DRIVER_ID_NVIDIA_PROPRIETARY_KHR = VK_DRIVER_ID_NVIDIA_PROPRIETARY;
    public static final VkDriverId VK_DRIVER_ID_QUALCOMM_PROPRIETARY = new VkDriverId(8);
    public static final VkDriverId VK_DRIVER_ID_QUALCOMM_PROPRIETARY_KHR = VK_DRIVER_ID_QUALCOMM_PROPRIETARY;
