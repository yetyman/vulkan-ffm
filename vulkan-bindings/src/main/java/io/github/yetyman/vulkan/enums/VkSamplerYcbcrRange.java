...
public record VkSamplerYcbcrRange(int value) {
    ...
    public static final VkSamplerYcbcrRange VK_SAMPLER_YCBCR_RANGE_ITU_FULL_KHR = VK_SAMPLER_YCBCR_RANGE_ITU_FULL;
    public static final VkSamplerYcbcrRange VK_SAMPLER_YCBCR_RANGE_ITU_NARROW = new VkSamplerYcbcrRange(1);
    public static final VkSamplerYcbcrRange VK_SAMPLER_YCBCR_RANGE_ITU_NARROW_KHR = VK_SAMPLER_YCBCR_RANGE_ITU_NARROW;
