...
public class tagDESIGNVECTOR {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        VulkanWin32FFM.C_LONG.withName("dvReserved"),
        VulkanWin32FFM.C_LONG.withName("dvNumAxes"),
        MemoryLayout.sequenceLayout(16, VulkanWin32FFM.C_LONG).withName("dvValues")
