...
/**
 * Constants for VkClusterAccelerationStructureAddressResolutionFlagBitsNV
 * Generated from jextract bindings
 */
public final class VkClusterAccelerationStructureAddressResolutionFlagBitsNV {
    private VkClusterAccelerationStructureAddressResolutionFlagBitsNV() {}

    public static final int VK_CLUSTER_ACCELERATION_STRUCTURE_ADDRESS_RESOLUTION_FLAG_BITS_MAX_ENUM_NV = 2147483647;
