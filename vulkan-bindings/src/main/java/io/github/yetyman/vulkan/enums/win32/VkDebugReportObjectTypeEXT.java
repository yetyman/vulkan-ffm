...
public record VkDebugReportObjectTypeEXT(int value) {
    ...
    public static final VkDebugReportObjectTypeEXT VK_DEBUG_REPORT_OBJECT_TYPE_DEBUG_REPORT_EXT = new VkDebugReportObjectTypeEXT(28);
    ...
    public static final VkDebugReportObjectTypeEXT VK_DEBUG_REPORT_OBJECT_TYPE_DESCRIPTOR_UPDATE_TEMPLATE_KHR_EXT = new VkDebugReportObjectTypeEXT(1000085000);
    ...
    public static final VkDebugReportObjectTypeEXT VK_DEBUG_REPORT_OBJECT_TYPE_SAMPLER_YCBCR_CONVERSION_KHR_EXT = new VkDebugReportObjectTypeEXT(1000156000);
    ...
    public static final VkDebugReportObjectTypeEXT VK_DEBUG_REPORT_OBJECT_TYPE_VALIDATION_CACHE_EXT_EXT = new VkDebugReportObjectTypeEXT(33);
