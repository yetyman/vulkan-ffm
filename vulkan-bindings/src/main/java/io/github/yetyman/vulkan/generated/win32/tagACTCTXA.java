...
public class tagACTCTXA {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        ...
        VulkanWin32FFM.C_POINTER.withName("lpSource"),
        VulkanWin32FFM.C_SHORT.withName("wProcessorArchitecture"),
        VulkanWin32FFM.C_SHORT.withName("wLangId"),
        MemoryLayout.paddingLayout(4),
        VulkanWin32FFM.C_POINTER.withName("lpAssemblyDirectory"),
        VulkanWin32FFM.C_POINTER.withName("lpResourceName"),
        VulkanWin32FFM.C_POINTER.withName("lpApplicationName"),
        VulkanWin32FFM.C_POINTER.withName("hModule")
    ).withName("tagACTCTXA");
