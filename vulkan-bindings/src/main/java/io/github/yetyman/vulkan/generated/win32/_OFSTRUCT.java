...
public class _OFSTRUCT {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        VulkanWin32FFM.C_CHAR.withName("cBytes"),
        VulkanWin32FFM.C_CHAR.withName("fFixedDisk"),
        VulkanWin32FFM.C_SHORT.withName("nErrCode"),
        VulkanWin32FFM.C_SHORT.withName("Reserved1"),
        VulkanWin32FFM.C_SHORT.withName("Reserved2"),
        MemoryLayout.sequenceLayout(128, VulkanWin32FFM.C_CHAR).withName("szPathName")
    ).withName("_OFSTRUCT");
