...
public class _DOCINFOA {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        ...
        VulkanWin32FFM.C_POINTER.withName("lpszDocName"),
        VulkanWin32FFM.C_POINTER.withName("lpszOutput"),
        VulkanWin32FFM.C_POINTER.withName("lpszDatatype"),
        VulkanWin32FFM.C_LONG.withName("fwType"),
        MemoryLayout.paddingLayout(4)
    ).withName("_DOCINFOA");
