...
public class VkVideoSessionCreateInfoKHR {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        ...
        VulkanFFM.C_POINTER.withName("pVideoProfile"),
        VulkanFFM.C_INT.withName("pictureFormat"),
        VkExtent2D.layout().withName("maxCodedExtent"),
        VulkanFFM.C_INT.withName("referencePictureFormat"),
        VulkanFFM.C_INT.withName("maxDpbSlots"),
        VulkanFFM.C_INT.withName("maxActiveReferencePictures"),
        VulkanFFM.C_POINTER.withName("pStdHeaderVersion")
