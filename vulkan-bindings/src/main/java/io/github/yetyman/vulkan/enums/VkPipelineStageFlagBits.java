...
public record VkPipelineStageFlagBits(int value) {
    ...
    public static final VkPipelineStageFlagBits VK_PIPELINE_STAGE_ACCELERATION_STRUCTURE_BUILD_BIT_NV = VK_PIPELINE_STAGE_ACCELERATION_STRUCTURE_BUILD_BIT_KHR;
    ...
    public static final VkPipelineStageFlagBits VK_PIPELINE_STAGE_COMMAND_PREPROCESS_BIT_NV = VK_PIPELINE_STAGE_COMMAND_PREPROCESS_BIT_EXT;
    ...
    public static final VkPipelineStageFlagBits VK_PIPELINE_STAGE_MESH_SHADER_BIT_NV = VK_PIPELINE_STAGE_MESH_SHADER_BIT_EXT;
    public static final VkPipelineStageFlagBits VK_PIPELINE_STAGE_NONE = new VkPipelineStageFlagBits(0);
    public static final VkPipelineStageFlagBits VK_PIPELINE_STAGE_NONE_KHR = VK_PIPELINE_STAGE_NONE;
    ...
    public static final VkPipelineStageFlagBits VK_PIPELINE_STAGE_RAY_TRACING_SHADER_BIT_NV = VK_PIPELINE_STAGE_RAY_TRACING_SHADER_BIT_KHR;
    public static final VkPipelineStageFlagBits VK_PIPELINE_STAGE_SHADING_RATE_IMAGE_BIT_NV = VK_PIPELINE_STAGE_FRAGMENT_SHADING_RATE_ATTACHMENT_BIT_KHR;
    public static final VkPipelineStageFlagBits VK_PIPELINE_STAGE_TASK_SHADER_BIT_EXT = new VkPipelineStageFlagBits(524288);
    public static final VkPipelineStageFlagBits VK_PIPELINE_STAGE_TASK_SHADER_BIT_NV = VK_PIPELINE_STAGE_TASK_SHADER_BIT_EXT;
