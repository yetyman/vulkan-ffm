...
public record VkColorSpaceKHR(int value) {
    ...
    public static final VkColorSpaceKHR VK_COLOR_SPACE_DISPLAY_P3_LINEAR_EXT = new VkColorSpaceKHR(1000104003);
    ...
    public static final VkColorSpaceKHR VK_COLOR_SPACE_SRGB_NONLINEAR_KHR = new VkColorSpaceKHR(0);
