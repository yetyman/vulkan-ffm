...
public record VkPresentGravityFlagBitsKHR(int value) {
    ...
    public static final VkPresentGravityFlagBitsKHR VK_PRESENT_GRAVITY_CENTERED_BIT_KHR = VK_PRESENT_GRAVITY_CENTERED_BIT_EXT;
    ...
    public static final VkPresentGravityFlagBitsKHR VK_PRESENT_GRAVITY_MAX_BIT_KHR = VK_PRESENT_GRAVITY_MAX_BIT_EXT;
    public static final VkPresentGravityFlagBitsKHR VK_PRESENT_GRAVITY_MIN_BIT_EXT = new VkPresentGravityFlagBitsKHR(1);
    public static final VkPresentGravityFlagBitsKHR VK_PRESENT_GRAVITY_MIN_BIT_KHR = VK_PRESENT_GRAVITY_MIN_BIT_EXT;
