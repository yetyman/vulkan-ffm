...
public record VkRayTracingInvocationReorderModeEXT(int value) {
    ...
    public static final VkRayTracingInvocationReorderModeEXT VK_RAY_TRACING_INVOCATION_REORDER_MODE_NONE_NV = new VkRayTracingInvocationReorderModeEXT(0);
    ...
    public static final VkRayTracingInvocationReorderModeEXT VK_RAY_TRACING_INVOCATION_REORDER_MODE_REORDER_NV = new VkRayTracingInvocationReorderModeEXT(1);
