...
/**
 * {@snippet lang=c :
 * typedef VkResult (*PFN_vkQueueBindSparse)(VkQueue, uint32_t, const VkBindSparseInfo *, VkFence) __attribute__((stdcall))
 * }
 */
public final class PFN_vkQueueBindSparse {

    private PFN_vkQueueBindSparse() {
    ...
    private static final MethodHandle UP$MH = VulkanWin32FFM.upcallHandle(PFN_vkQueueBindSparse.Function.class, "apply", $DESC);
