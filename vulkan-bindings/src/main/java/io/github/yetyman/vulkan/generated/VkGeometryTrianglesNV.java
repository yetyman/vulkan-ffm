...
public class VkGeometryTrianglesNV {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        ...
        VulkanFFM.C_POINTER.withName("vertexData"),
        VulkanFFM.C_LONG_LONG.withName("vertexOffset"),
        VulkanFFM.C_INT.withName("vertexCount"),
        MemoryLayout.paddingLayout(4),
        VulkanFFM.C_LONG_LONG.withName("vertexStride"),
        VulkanFFM.C_INT.withName("vertexFormat"),
        MemoryLayout.paddingLayout(4),
        VulkanFFM.C_POINTER.withName("indexData"),
        VulkanFFM.C_LONG_LONG.withName("indexOffset"),
        VulkanFFM.C_INT.withName("indexCount"),
        VulkanFFM.C_INT.withName("indexType"),
        VulkanFFM.C_POINTER.withName("transformData"),
        VulkanFFM.C_LONG_LONG.withName("transformOffset")
