...
/**
 * Constants for VkRenderingAttachmentFlagBitsKHR
 * Generated from jextract bindings
 */
public final class VkRenderingAttachmentFlagBitsKHR {
    private VkRenderingAttachmentFlagBitsKHR() {}

    public static final int VK_RENDERING_ATTACHMENT_FLAG_BITS_MAX_ENUM_KHR = 2147483647;
