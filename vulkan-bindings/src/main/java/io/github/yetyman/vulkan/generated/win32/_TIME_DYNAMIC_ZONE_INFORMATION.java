...
public class _TIME_DYNAMIC_ZONE_INFORMATION {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        VulkanWin32FFM.C_LONG.withName("Bias"),
        MemoryLayout.sequenceLayout(32, VulkanWin32FFM.C_SHORT).withName("StandardName"),
        _SYSTEMTIME.layout().withName("StandardDate"),
        VulkanWin32FFM.C_LONG.withName("StandardBias"),
        MemoryLayout.sequenceLayout(32, VulkanWin32FFM.C_SHORT).withName("DaylightName"),
        _SYSTEMTIME.layout().withName("DaylightDate"),
        VulkanWin32FFM.C_LONG.withName("DaylightBias"),
        MemoryLayout.sequenceLayout(128, VulkanWin32FFM.C_SHORT).withName("TimeZoneKeyName"),
        VulkanWin32FFM.C_CHAR.withName("DynamicDaylightTimeDisabled"),
