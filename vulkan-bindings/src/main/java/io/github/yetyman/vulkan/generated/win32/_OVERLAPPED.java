...
public class _OVERLAPPED {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        VulkanWin32FFM.C_LONG_LONG.withName("Internal"),
        VulkanWin32FFM.C_LONG_LONG.withName("InternalHigh"),
        MemoryLayout.unionLayout(
            MemoryLayout.structLayout(
                VulkanWin32FFM.C_LONG.withName("Offset"),
                VulkanWin32FFM.C_LONG.withName("OffsetHigh")
            ).withName("$anon$56:9"),
            VulkanWin32FFM.C_POINTER.withName("Pointer")
        ).withName("$anon$55:5"),
        VulkanWin32FFM.C_POINTER.withName("hEvent")
