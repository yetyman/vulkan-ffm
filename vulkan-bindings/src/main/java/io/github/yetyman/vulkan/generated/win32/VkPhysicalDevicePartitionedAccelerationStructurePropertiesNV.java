 ...
 * }
 */
public class VkPhysicalDevicePartitionedAccelerationStructurePropertiesNV {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        ...
        VulkanWin32FFM.C_INT.withName("maxPartitionCount"),
        MemoryLayout.paddingLayout(4)
    ).withName("VkPhysicalDevicePartitionedAccelerationStructurePropertiesNV");
