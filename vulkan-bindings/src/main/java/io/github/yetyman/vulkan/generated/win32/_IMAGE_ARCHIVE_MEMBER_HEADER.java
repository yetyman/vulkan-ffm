...
public class _IMAGE_ARCHIVE_MEMBER_HEADER {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        MemoryLayout.sequenceLayout(16, VulkanWin32FFM.C_CHAR).withName("Name"),
        MemoryLayout.sequenceLayout(12, VulkanWin32FFM.C_CHAR).withName("Date"),
        MemoryLayout.sequenceLayout(6, VulkanWin32FFM.C_CHAR).withName("UserID"),
        MemoryLayout.sequenceLayout(6, VulkanWin32FFM.C_CHAR).withName("GroupID"),
        MemoryLayout.sequenceLayout(8, VulkanWin32FFM.C_CHAR).withName("Mode"),
        MemoryLayout.sequenceLayout(10, VulkanWin32FFM.C_CHAR).withName("Size"),
        MemoryLayout.sequenceLayout(2, VulkanWin32FFM.C_CHAR).withName("EndHeader")
