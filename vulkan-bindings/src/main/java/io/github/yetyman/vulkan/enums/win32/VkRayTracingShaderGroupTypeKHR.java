...
public record VkRayTracingShaderGroupTypeKHR(int value) {
    ...
    public static final VkRayTracingShaderGroupTypeKHR VK_RAY_TRACING_SHADER_GROUP_TYPE_GENERAL_NV = new VkRayTracingShaderGroupTypeKHR(0);
    ...
    public static final VkRayTracingShaderGroupTypeKHR VK_RAY_TRACING_SHADER_GROUP_TYPE_PROCEDURAL_HIT_GROUP_NV = new VkRayTracingShaderGroupTypeKHR(2);
    ...
    public static final VkRayTracingShaderGroupTypeKHR VK_RAY_TRACING_SHADER_GROUP_TYPE_TRIANGLES_HIT_GROUP_NV = new VkRayTracingShaderGroupTypeKHR(1);
