...
public class pvalueA {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        VulkanWin32FFM.C_POINTER.withName("pv_valuename"),
        VulkanWin32FFM.C_INT.withName("pv_valuelen"),
        MemoryLayout.paddingLayout(4),
        VulkanWin32FFM.C_POINTER.withName("pv_value_context"),
        VulkanWin32FFM.C_LONG.withName("pv_type"),
        MemoryLayout.paddingLayout(4)
    ).withName("pvalueA");
