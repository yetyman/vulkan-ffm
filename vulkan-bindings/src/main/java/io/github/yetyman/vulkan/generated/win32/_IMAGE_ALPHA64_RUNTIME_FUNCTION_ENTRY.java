...
public class _IMAGE_ALPHA64_RUNTIME_FUNCTION_ENTRY {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        VulkanWin32FFM.align(VulkanWin32FFM.C_LONG_LONG, 4).withName("BeginAddress"),
        VulkanWin32FFM.align(VulkanWin32FFM.C_LONG_LONG, 4).withName("EndAddress"),
        VulkanWin32FFM.align(VulkanWin32FFM.C_LONG_LONG, 4).withName("ExceptionHandler"),
        VulkanWin32FFM.align(VulkanWin32FFM.C_LONG_LONG, 4).withName("HandlerData"),
        VulkanWin32FFM.align(VulkanWin32FFM.C_LONG_LONG, 4).withName("PrologEndAddress")
