...
public class VkImageBlit2 {
    ...
    private static final long srcSubresource$OFFSET = $LAYOUT.byteOffset(groupElement("srcSubresource"));
    ...
    private static final long srcOffsets$OFFSET = $LAYOUT.byteOffset(groupElement("srcOffsets"));
    ...
    public static MemorySegment srcOffsets(MemorySegment struct, long index0) {
        try {
            return (MemorySegment)srcOffsets$ELEM_HANDLE.invokeExact(struct, srcOffsets$OFFSET, index0);
    ...
    private static final long dstSubresource$OFFSET = $LAYOUT.byteOffset(groupElement("dstSubresource"));
    ...
    private static final long dstOffsets$OFFSET = $LAYOUT.byteOffset(groupElement("dstOffsets"));
    ...
    public static MemorySegment dstOffsets(MemorySegment struct, long index0) {
        try {
            return (MemorySegment)dstOffsets$ELEM_HANDLE.invokeExact(struct, dstOffsets$OFFSET, index0);
        } catch (Error | RuntimeException ex) {
            throw ex;
        } catch (Throwable ex$) {
            throw new AssertionError("should not reach here", ex$);
