...
public class _SERVICE_TRIGGER {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        VulkanWin32FFM.C_LONG.withName("dwTriggerType"),
        VulkanWin32FFM.C_LONG.withName("dwAction"),
        VulkanWin32FFM.C_POINTER.withName("pTriggerSubtype"),
        VulkanWin32FFM.C_LONG.withName("cDataItems"),
        MemoryLayout.paddingLayout(4),
        VulkanWin32FFM.C_POINTER.withName("pDataItems")
