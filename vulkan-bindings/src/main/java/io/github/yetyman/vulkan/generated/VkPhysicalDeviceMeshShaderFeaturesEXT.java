...
public class VkPhysicalDeviceMeshShaderFeaturesEXT {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        ...
        VulkanFFM.C_INT.withName("taskShader"),
        VulkanFFM.C_INT.withName("meshShader"),
        VulkanFFM.C_INT.withName("multiviewMeshShader"),
        VulkanFFM.C_INT.withName("primitiveFragmentShadingRateMeshShader"),
        VulkanFFM.C_INT.withName("meshShaderQueries"),
        MemoryLayout.paddingLayout(4)
