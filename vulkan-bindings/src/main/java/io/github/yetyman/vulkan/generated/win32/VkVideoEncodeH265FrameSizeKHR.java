...
public class VkVideoEncodeH265FrameSizeKHR {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        VulkanWin32FFM.C_INT.withName("frameISize"),
        VulkanWin32FFM.C_INT.withName("framePSize"),
        VulkanWin32FFM.C_INT.withName("frameBSize")
    ...
    private static final long frameISize$OFFSET = $LAYOUT.byteOffset(groupElement("frameISize"));
    ...
    private static final long framePSize$OFFSET = $LAYOUT.byteOffset(groupElement("framePSize"));
    ...
    private static final long frameBSize$OFFSET = $LAYOUT.byteOffset(groupElement("frameBSize"));
