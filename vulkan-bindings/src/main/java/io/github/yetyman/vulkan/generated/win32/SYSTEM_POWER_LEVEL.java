...
public class SYSTEM_POWER_LEVEL {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        VulkanWin32FFM.C_CHAR.withName("Enable"),
        MemoryLayout.sequenceLayout(3, VulkanWin32FFM.C_CHAR).withName("Spare"),
        VulkanWin32FFM.C_LONG.withName("BatteryLevel"),
        POWER_ACTION_POLICY.layout().withName("PowerPolicy"),
        VulkanWin32FFM.C_INT.withName("MinSystemState")
    ).withName("$anon$17893:9");
