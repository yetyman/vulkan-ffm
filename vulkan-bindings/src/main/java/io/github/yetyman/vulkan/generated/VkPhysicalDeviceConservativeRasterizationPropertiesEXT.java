...
public class VkPhysicalDeviceConservativeRasterizationPropertiesEXT {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        ...
        VulkanFFM.C_FLOAT.withName("primitiveOverestimationSize"),
        VulkanFFM.C_FLOAT.withName("maxExtraPrimitiveOverestimationSize"),
        VulkanFFM.C_FLOAT.withName("extraPrimitiveOverestimationSizeGranularity"),
        VulkanFFM.C_INT.withName("primitiveUnderestimation"),
        VulkanFFM.C_INT.withName("conservativePointAndLineRasterization"),
        VulkanFFM.C_INT.withName("degenerateTrianglesRasterized"),
        VulkanFFM.C_INT.withName("degenerateLinesRasterized"),
        VulkanFFM.C_INT.withName("fullyCoveredFragmentShaderInputVariable"),
        VulkanFFM.C_INT.withName("conservativeRasterizationPostDepthCoverage"),
        MemoryLayout.paddingLayout(4)
