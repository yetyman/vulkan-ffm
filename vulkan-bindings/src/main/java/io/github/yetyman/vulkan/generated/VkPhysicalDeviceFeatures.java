...
public class VkPhysicalDeviceFeatures {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        VulkanFFM.C_INT.withName("robustBufferAccess"),
        VulkanFFM.C_INT.withName("fullDrawIndexUint32"),
        VulkanFFM.C_INT.withName("imageCubeArray"),
        VulkanFFM.C_INT.withName("independentBlend"),
        VulkanFFM.C_INT.withName("geometryShader"),
        VulkanFFM.C_INT.withName("tessellationShader"),
        VulkanFFM.C_INT.withName("sampleRateShading"),
        VulkanFFM.C_INT.withName("dualSrcBlend"),
        VulkanFFM.C_INT.withName("logicOp"),
        VulkanFFM.C_INT.withName("multiDrawIndirect"),
        VulkanFFM.C_INT.withName("drawIndirectFirstInstance"),
        VulkanFFM.C_INT.withName("depthClamp"),
        VulkanFFM.C_INT.withName("depthBiasClamp"),
        VulkanFFM.C_INT.withName("fillModeNonSolid"),
        VulkanFFM.C_INT.withName("depthBounds"),
        VulkanFFM.C_INT.withName("wideLines"),
        VulkanFFM.C_INT.withName("largePoints"),
        VulkanFFM.C_INT.withName("alphaToOne"),
        VulkanFFM.C_INT.withName("multiViewport"),
        VulkanFFM.C_INT.withName("samplerAnisotropy"),
        VulkanFFM.C_INT.withName("textureCompressionETC2"),
        VulkanFFM.C_INT.withName("textureCompressionASTC_LDR"),
        VulkanFFM.C_INT.withName("textureCompressionBC"),
        VulkanFFM.C_INT.withName("occlusionQueryPrecise"),
        VulkanFFM.C_INT.withName("pipelineStatisticsQuery"),
        VulkanFFM.C_INT.withName("vertexPipelineStoresAndAtomics"),
        VulkanFFM.C_INT.withName("fragmentStoresAndAtomics"),
        VulkanFFM.C_INT.withName("shaderTessellationAndGeometryPointSize"),
        VulkanFFM.C_INT.withName("shaderImageGatherExtended"),
        VulkanFFM.C_INT.withName("shaderStorageImageExtendedFormats"),
        VulkanFFM.C_INT.withName("shaderStorageImageMultisample"),
        VulkanFFM.C_INT.withName("shaderStorageImageReadWithoutFormat"),
        VulkanFFM.C_INT.withName("shaderStorageImageWriteWithoutFormat"),
        VulkanFFM.C_INT.withName("shaderUniformBufferArrayDynamicIndexing"),
        VulkanFFM.C_INT.withName("shaderSampledImageArrayDynamicIndexing"),
        VulkanFFM.C_INT.withName("shaderStorageBufferArrayDynamicIndexing"),
        VulkanFFM.C_INT.withName("shaderStorageImageArrayDynamicIndexing"),
        VulkanFFM.C_INT.withName("shaderClipDistance"),
        VulkanFFM.C_INT.withName("shaderCullDistance"),
        VulkanFFM.C_INT.withName("shaderFloat64"),
        VulkanFFM.C_INT.withName("shaderInt64"),
        VulkanFFM.C_INT.withName("shaderInt16"),
        VulkanFFM.C_INT.withName("shaderResourceResidency"),
        VulkanFFM.C_INT.withName("shaderResourceMinLod"),
        VulkanFFM.C_INT.withName("sparseBinding"),
        VulkanFFM.C_INT.withName("sparseResidencyBuffer"),
        VulkanFFM.C_INT.withName("sparseResidencyImage2D"),
        VulkanFFM.C_INT.withName("sparseResidencyImage3D"),
        VulkanFFM.C_INT.withName("sparseResidency2Samples"),
        VulkanFFM.C_INT.withName("sparseResidency4Samples"),
        VulkanFFM.C_INT.withName("sparseResidency8Samples"),
        VulkanFFM.C_INT.withName("sparseResidency16Samples"),
        VulkanFFM.C_INT.withName("sparseResidencyAliased"),
        VulkanFFM.C_INT.withName("variableMultisampleRate"),
        VulkanFFM.C_INT.withName("inheritedQueries")
