...
/**
 * {@snippet lang=c :
 * typedef void (*PFN_vkDestroySamplerYcbcrConversion)(VkDevice, VkSamplerYcbcrConversion, const VkAllocationCallbacks *) __attribute__((stdcall))
 * }
 */
public final class PFN_vkDestroySamplerYcbcrConversion {

    private PFN_vkDestroySamplerYcbcrConversion() {
    ...
    private static final MethodHandle UP$MH = VulkanWin32FFM.upcallHandle(PFN_vkDestroySamplerYcbcrConversion.Function.class, "apply", $DESC);
