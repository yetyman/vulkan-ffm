...
public class _EVENTSFORLOGFILE {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        VulkanWin32FFM.C_LONG.withName("ulSize"),
        MemoryLayout.sequenceLayout(256, VulkanWin32FFM.C_SHORT).withName("szLogicalLogFile"),
        VulkanWin32FFM.C_LONG.withName("ulNumRecords"),
