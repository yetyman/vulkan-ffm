...
public class VkPhysicalDeviceMeshShaderPropertiesEXT {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        ...
        VulkanFFM.C_INT.withName("maxTaskWorkGroupTotalCount"),
        MemoryLayout.sequenceLayout(3, VulkanFFM.C_INT).withName("maxTaskWorkGroupCount"),
        VulkanFFM.C_INT.withName("maxTaskWorkGroupInvocations"),
        MemoryLayout.sequenceLayout(3, VulkanFFM.C_INT).withName("maxTaskWorkGroupSize"),
        VulkanFFM.C_INT.withName("maxTaskPayloadSize"),
        VulkanFFM.C_INT.withName("maxTaskSharedMemorySize"),
        VulkanFFM.C_INT.withName("maxTaskPayloadAndSharedMemorySize"),
        VulkanFFM.C_INT.withName("maxMeshWorkGroupTotalCount"),
        MemoryLayout.sequenceLayout(3, VulkanFFM.C_INT).withName("maxMeshWorkGroupCount"),
        VulkanFFM.C_INT.withName("maxMeshWorkGroupInvocations"),
        MemoryLayout.sequenceLayout(3, VulkanFFM.C_INT).withName("maxMeshWorkGroupSize"),
        VulkanFFM.C_INT.withName("maxMeshSharedMemorySize"),
        VulkanFFM.C_INT.withName("maxMeshPayloadAndSharedMemorySize"),
        VulkanFFM.C_INT.withName("maxMeshOutputMemorySize"),
        VulkanFFM.C_INT.withName("maxMeshPayloadAndOutputMemorySize"),
        VulkanFFM.C_INT.withName("maxMeshOutputComponents"),
        VulkanFFM.C_INT.withName("maxMeshOutputVertices"),
        VulkanFFM.C_INT.withName("maxMeshOutputPrimitives"),
        VulkanFFM.C_INT.withName("maxMeshOutputLayers"),
        VulkanFFM.C_INT.withName("maxMeshMultiviewViewCount"),
        VulkanFFM.C_INT.withName("meshOutputPerVertexGranularity"),
        VulkanFFM.C_INT.withName("meshOutputPerPrimitiveGranularity"),
        VulkanFFM.C_INT.withName("maxPreferredTaskWorkGroupInvocations"),
        VulkanFFM.C_INT.withName("maxPreferredMeshWorkGroupInvocations"),
        VulkanFFM.C_INT.withName("prefersLocalInvocationVertexOutput"),
        VulkanFFM.C_INT.withName("prefersLocalInvocationPrimitiveOutput"),
        VulkanFFM.C_INT.withName("prefersCompactVertexOutput"),
        VulkanFFM.C_INT.withName("prefersCompactPrimitiveOutput")
