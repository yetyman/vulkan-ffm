...
public class _TRANSACTION_PROPERTIES_INFORMATION {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        VulkanWin32FFM.C_LONG.withName("IsolationLevel"),
        VulkanWin32FFM.C_LONG.withName("IsolationFlags"),
        _LARGE_INTEGER.layout().withName("Timeout"),
        VulkanWin32FFM.C_LONG.withName("Outcome"),
        VulkanWin32FFM.C_LONG.withName("DescriptionLength"),
        MemoryLayout.sequenceLayout(1, VulkanWin32FFM.C_SHORT).withName("Description"),
