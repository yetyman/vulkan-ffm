...
public class StdVideoH265VideoParameterSet {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        ...
        VulkanFFM.C_CHAR.withName("vps_video_parameter_set_id"),
        VulkanFFM.C_CHAR.withName("vps_max_sub_layers_minus1"),
        VulkanFFM.C_CHAR.withName("reserved1"),
        VulkanFFM.C_CHAR.withName("reserved2"),
        VulkanFFM.C_INT.withName("vps_num_units_in_tick"),
        VulkanFFM.C_INT.withName("vps_time_scale"),
        VulkanFFM.C_INT.withName("vps_num_ticks_poc_diff_one_minus1"),
