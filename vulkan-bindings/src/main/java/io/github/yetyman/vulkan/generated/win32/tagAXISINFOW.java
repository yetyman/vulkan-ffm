...
public class tagAXISINFOW {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        VulkanWin32FFM.C_LONG.withName("axMinValue"),
        VulkanWin32FFM.C_LONG.withName("axMaxValue"),
        MemoryLayout.sequenceLayout(16, VulkanWin32FFM.C_SHORT).withName("axAxisName")
