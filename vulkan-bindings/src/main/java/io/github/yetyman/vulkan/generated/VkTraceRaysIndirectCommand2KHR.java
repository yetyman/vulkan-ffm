...
public class VkTraceRaysIndirectCommand2KHR {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        VulkanFFM.C_LONG_LONG.withName("raygenShaderRecordAddress"),
        VulkanFFM.C_LONG_LONG.withName("raygenShaderRecordSize"),
        VulkanFFM.C_LONG_LONG.withName("missShaderBindingTableAddress"),
        VulkanFFM.C_LONG_LONG.withName("missShaderBindingTableSize"),
        VulkanFFM.C_LONG_LONG.withName("missShaderBindingTableStride"),
        VulkanFFM.C_LONG_LONG.withName("hitShaderBindingTableAddress"),
        VulkanFFM.C_LONG_LONG.withName("hitShaderBindingTableSize"),
        VulkanFFM.C_LONG_LONG.withName("hitShaderBindingTableStride"),
        VulkanFFM.C_LONG_LONG.withName("callableShaderBindingTableAddress"),
        VulkanFFM.C_LONG_LONG.withName("callableShaderBindingTableSize"),
        VulkanFFM.C_LONG_LONG.withName("callableShaderBindingTableStride"),
        VulkanFFM.C_INT.withName("width"),
        VulkanFFM.C_INT.withName("height"),
        VulkanFFM.C_INT.withName("depth"),
