...
public class _SYSTEM_INFO {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        MemoryLayout.unionLayout(
            VulkanWin32FFM.C_LONG.withName("dwOemId"),
            MemoryLayout.structLayout(
                VulkanWin32FFM.C_SHORT.withName("wProcessorArchitecture"),
                VulkanWin32FFM.C_SHORT.withName("wReserved")
            ).withName("$anon$50:9")
        ).withName("$anon$48:5"),
        VulkanWin32FFM.C_LONG.withName("dwPageSize"),
        VulkanWin32FFM.C_POINTER.withName("lpMinimumApplicationAddress"),
        VulkanWin32FFM.C_POINTER.withName("lpMaximumApplicationAddress"),
        VulkanWin32FFM.C_LONG_LONG.withName("dwActiveProcessorMask"),
        VulkanWin32FFM.C_LONG.withName("dwNumberOfProcessors"),
        VulkanWin32FFM.C_LONG.withName("dwProcessorType"),
        VulkanWin32FFM.C_LONG.withName("dwAllocationGranularity"),
        VulkanWin32FFM.C_SHORT.withName("wProcessorLevel"),
        VulkanWin32FFM.C_SHORT.withName("wProcessorRevision")
