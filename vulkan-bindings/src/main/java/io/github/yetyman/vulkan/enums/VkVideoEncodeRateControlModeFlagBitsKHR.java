...
/**
 * Constants for VkVideoEncodeRateControlModeFlagBitsKHR
 * Generated from jextract bindings
 */
public final class VkVideoEncodeRateControlModeFlagBitsKHR {
    private VkVideoEncodeRateControlModeFlagBitsKHR() {}
    ...
    public static final int VK_VIDEO_ENCODE_RATE_CONTROL_MODE_FLAG_BITS_MAX_ENUM_KHR = 2147483647;
