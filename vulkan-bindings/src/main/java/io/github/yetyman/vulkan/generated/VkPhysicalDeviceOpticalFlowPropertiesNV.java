...
public class VkPhysicalDeviceOpticalFlowPropertiesNV {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        ...
        VulkanFFM.C_INT.withName("supportedOutputGridSizes"),
        VulkanFFM.C_INT.withName("supportedHintGridSizes"),
        VulkanFFM.C_INT.withName("hintSupported"),
        VulkanFFM.C_INT.withName("costSupported"),
        VulkanFFM.C_INT.withName("bidirectionalFlowSupported"),
        VulkanFFM.C_INT.withName("globalFlowSupported"),
        VulkanFFM.C_INT.withName("minWidth"),
        VulkanFFM.C_INT.withName("minHeight"),
        VulkanFFM.C_INT.withName("maxWidth"),
        VulkanFFM.C_INT.withName("maxHeight"),
        VulkanFFM.C_INT.withName("maxNumRegionsOfInterest"),
        MemoryLayout.paddingLayout(4)
