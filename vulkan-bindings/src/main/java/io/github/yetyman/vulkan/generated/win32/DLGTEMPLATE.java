...
public class DLGTEMPLATE {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        VulkanWin32FFM.align(VulkanWin32FFM.C_LONG, 2).withName("style"),
        VulkanWin32FFM.align(VulkanWin32FFM.C_LONG, 2).withName("dwExtendedStyle"),
        VulkanWin32FFM.C_SHORT.withName("cdit"),
        VulkanWin32FFM.C_SHORT.withName("x"),
        VulkanWin32FFM.C_SHORT.withName("y"),
        VulkanWin32FFM.C_SHORT.withName("cx"),
        VulkanWin32FFM.C_SHORT.withName("cy")
    ).withName("$anon$4909:9");
