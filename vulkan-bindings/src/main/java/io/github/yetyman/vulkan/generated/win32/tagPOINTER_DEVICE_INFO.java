...
public class tagPOINTER_DEVICE_INFO {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        VulkanWin32FFM.C_LONG.withName("displayOrientation"),
        MemoryLayout.paddingLayout(4),
        VulkanWin32FFM.C_POINTER.withName("device"),
        VulkanWin32FFM.C_INT.withName("pointerDeviceType"),
        MemoryLayout.paddingLayout(4),
        VulkanWin32FFM.C_POINTER.withName("monitor"),
        VulkanWin32FFM.C_LONG.withName("startingCursorId"),
        VulkanWin32FFM.C_SHORT.withName("maxActiveContacts"),
        MemoryLayout.sequenceLayout(520, VulkanWin32FFM.C_SHORT).withName("productString"),
