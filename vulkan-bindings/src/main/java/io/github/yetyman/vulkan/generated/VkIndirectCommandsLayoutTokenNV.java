...
public class VkIndirectCommandsLayoutTokenNV {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        ...
        VulkanFFM.C_INT.withName("tokenType"),
        VulkanFFM.C_INT.withName("stream"),
        VulkanFFM.C_INT.withName("offset"),
        VulkanFFM.C_INT.withName("vertexBindingUnit"),
        VulkanFFM.C_INT.withName("vertexDynamicStride"),
        MemoryLayout.paddingLayout(4),
        VulkanFFM.C_POINTER.withName("pushconstantPipelineLayout"),
        VulkanFFM.C_INT.withName("pushconstantShaderStageFlags"),
        VulkanFFM.C_INT.withName("pushconstantOffset"),
        VulkanFFM.C_INT.withName("pushconstantSize"),
        VulkanFFM.C_INT.withName("indirectStateFlags"),
        VulkanFFM.C_INT.withName("indexTypeCount"),
        MemoryLayout.paddingLayout(4),
        VulkanFFM.C_POINTER.withName("pIndexTypes"),
        VulkanFFM.C_POINTER.withName("pIndexTypeValues")
