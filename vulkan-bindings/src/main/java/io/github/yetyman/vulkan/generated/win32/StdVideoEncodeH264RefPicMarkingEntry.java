...
public class StdVideoEncodeH264RefPicMarkingEntry {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        VulkanWin32FFM.C_INT.withName("memory_management_control_operation"),
        VulkanWin32FFM.C_SHORT.withName("difference_of_pic_nums_minus1"),
        VulkanWin32FFM.C_SHORT.withName("long_term_pic_num"),
        VulkanWin32FFM.C_SHORT.withName("long_term_frame_idx"),
        VulkanWin32FFM.C_SHORT.withName("max_long_term_frame_idx_plus1")
    ...
    private static final long memory_management_control_operation$OFFSET = $LAYOUT.byteOffset(groupElement("memory_management_control_operation"));
    ...
    private static final long difference_of_pic_nums_minus1$OFFSET = $LAYOUT.byteOffset(groupElement("difference_of_pic_nums_minus1"));
    ...
    private static final long max_long_term_frame_idx_plus1$OFFSET = $LAYOUT.byteOffset(groupElement("max_long_term_frame_idx_plus1"));
