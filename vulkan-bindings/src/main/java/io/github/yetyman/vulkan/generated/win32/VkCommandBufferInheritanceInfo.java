...
public class VkCommandBufferInheritanceInfo {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        ...
        MemoryLayout.paddingLayout(4),
        VulkanWin32FFM.C_POINTER.withName("framebuffer"),
        VulkanWin32FFM.C_INT.withName("occlusionQueryEnable"),
        VulkanWin32FFM.C_INT.withName("queryFlags"),
    ...
    private static final long occlusionQueryEnable$OFFSET = $LAYOUT.byteOffset(groupElement("occlusionQueryEnable"));
    ...
    private static final long queryFlags$OFFSET = $LAYOUT.byteOffset(groupElement("queryFlags"));
