...
public class _SE_ACCESS_REQUEST {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        ...
        VulkanWin32FFM.C_POINTER.withName("SeSecurityDescriptor"),
        VulkanWin32FFM.C_LONG.withName("DesiredAccess"),
        VulkanWin32FFM.C_LONG.withName("PreviouslyGrantedAccess"),
        VulkanWin32FFM.C_POINTER.withName("PrincipalSelfSid"),
        VulkanWin32FFM.C_POINTER.withName("GenericMapping"),
        VulkanWin32FFM.C_LONG.withName("ObjectTypeListCount"),
        MemoryLayout.paddingLayout(4),
        VulkanWin32FFM.C_POINTER.withName("ObjectTypeList")
