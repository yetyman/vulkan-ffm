...
public class DISPLAYCONFIG_PATH_TARGET_INFO {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        ...
        VulkanWin32FFM.C_INT.withName("id"),
        MemoryLayout.unionLayout(
            VulkanWin32FFM.C_INT.withName("modeInfoIdx"),
            MemoryLayout.structLayout(
                MemoryLayout.paddingLayout(4)
            ).withName("$anon$2980:9")
        ).withName("$anon$2977:5"),
        VulkanWin32FFM.C_INT.withName("outputTechnology"),
        VulkanWin32FFM.C_INT.withName("rotation"),
        VulkanWin32FFM.C_INT.withName("scaling"),
        DISPLAYCONFIG_RATIONAL.layout().withName("refreshRate"),
        VulkanWin32FFM.C_INT.withName("scanLineOrdering"),
        VulkanWin32FFM.C_INT.withName("targetAvailable"),
        VulkanWin32FFM.C_INT.withName("statusFlags")
