...
public class StdVideoH265ShortTermRefPicSet {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        ...
        VulkanWin32FFM.C_INT.withName("delta_idx_minus1"),
        VulkanWin32FFM.C_SHORT.withName("use_delta_flag"),
        VulkanWin32FFM.C_SHORT.withName("abs_delta_rps_minus1"),
        VulkanWin32FFM.C_SHORT.withName("used_by_curr_pic_flag"),
        VulkanWin32FFM.C_SHORT.withName("used_by_curr_pic_s0_flag"),
        VulkanWin32FFM.C_SHORT.withName("used_by_curr_pic_s1_flag"),
        VulkanWin32FFM.C_SHORT.withName("reserved1"),
        VulkanWin32FFM.C_CHAR.withName("reserved2"),
        VulkanWin32FFM.C_CHAR.withName("reserved3"),
        VulkanWin32FFM.C_CHAR.withName("num_negative_pics"),
        VulkanWin32FFM.C_CHAR.withName("num_positive_pics"),
        MemoryLayout.sequenceLayout(16, VulkanWin32FFM.C_SHORT).withName("delta_poc_s0_minus1"),
        MemoryLayout.sequenceLayout(16, VulkanWin32FFM.C_SHORT).withName("delta_poc_s1_minus1")
    ...
    private static final long delta_idx_minus1$OFFSET = $LAYOUT.byteOffset(groupElement("delta_idx_minus1"));
    ...
    private static final long use_delta_flag$OFFSET = $LAYOUT.byteOffset(groupElement("use_delta_flag"));
    ...
    private static final long abs_delta_rps_minus1$OFFSET = $LAYOUT.byteOffset(groupElement("abs_delta_rps_minus1"));
    ...
    private static final long used_by_curr_pic_flag$OFFSET = $LAYOUT.byteOffset(groupElement("used_by_curr_pic_flag"));
    ...
    private static final long used_by_curr_pic_s0_flag$OFFSET = $LAYOUT.byteOffset(groupElement("used_by_curr_pic_s0_flag"));
    ...
    private static final long used_by_curr_pic_s1_flag$OFFSET = $LAYOUT.byteOffset(groupElement("used_by_curr_pic_s1_flag"));
    ...
    private static final long num_negative_pics$OFFSET = $LAYOUT.byteOffset(groupElement("num_negative_pics"));
    ...
    private static final long num_positive_pics$OFFSET = $LAYOUT.byteOffset(groupElement("num_positive_pics"));
    ...
    private static final long delta_poc_s0_minus1$OFFSET = $LAYOUT.byteOffset(groupElement("delta_poc_s0_minus1"));
    ...
    public static short delta_poc_s0_minus1(MemorySegment struct, long index0) {
        return (short)delta_poc_s0_minus1$ELEM_HANDLE.get(struct, delta_poc_s0_minus1$OFFSET, index0);
    }
    ...
    public static void delta_poc_s0_minus1(MemorySegment struct, long index0, short fieldValue) {
        delta_poc_s0_minus1$ELEM_HANDLE.set(struct, delta_poc_s0_minus1$OFFSET, index0, fieldValue);
    }
    ...
    private static final long delta_poc_s1_minus1$OFFSET = $LAYOUT.byteOffset(groupElement("delta_poc_s1_minus1"));
    ...
    public static short delta_poc_s1_minus1(MemorySegment struct, long index0) {
        return (short)delta_poc_s1_minus1$ELEM_HANDLE.get(struct, delta_poc_s1_minus1$OFFSET, index0);
    }
    ...
    public static void delta_poc_s1_minus1(MemorySegment struct, long index0, short fieldValue) {
        delta_poc_s1_minus1$ELEM_HANDLE.set(struct, delta_poc_s1_minus1$OFFSET, index0, fieldValue);
    }
