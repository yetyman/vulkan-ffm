...
public record VkComponentTypeKHR(int value) {
    ...
    public static final VkComponentTypeKHR VK_COMPONENT_TYPE_FLOAT16_NV = new VkComponentTypeKHR(0);
    public static final VkComponentTypeKHR VK_COMPONENT_TYPE_FLOAT32_KHR = new VkComponentTypeKHR(1);
    public static final VkComponentTypeKHR VK_COMPONENT_TYPE_FLOAT32_NV = new VkComponentTypeKHR(1);
    public static final VkComponentTypeKHR VK_COMPONENT_TYPE_FLOAT64_KHR = new VkComponentTypeKHR(2);
    public static final VkComponentTypeKHR VK_COMPONENT_TYPE_FLOAT64_NV = new VkComponentTypeKHR(2);
    ...
    public static final VkComponentTypeKHR VK_COMPONENT_TYPE_FLOAT_E4M3_NV = new VkComponentTypeKHR(1000491002);
    public static final VkComponentTypeKHR VK_COMPONENT_TYPE_FLOAT_E5M2_NV = new VkComponentTypeKHR(1000491003);
    ...
    public static final VkComponentTypeKHR VK_COMPONENT_TYPE_SINT16_NV = new VkComponentTypeKHR(4);
    public static final VkComponentTypeKHR VK_COMPONENT_TYPE_SINT32_KHR = new VkComponentTypeKHR(5);
    public static final VkComponentTypeKHR VK_COMPONENT_TYPE_SINT32_NV = new VkComponentTypeKHR(5);
    public static final VkComponentTypeKHR VK_COMPONENT_TYPE_SINT64_KHR = new VkComponentTypeKHR(6);
    public static final VkComponentTypeKHR VK_COMPONENT_TYPE_SINT64_NV = new VkComponentTypeKHR(6);
    public static final VkComponentTypeKHR VK_COMPONENT_TYPE_SINT8_KHR = new VkComponentTypeKHR(3);
    public static final VkComponentTypeKHR VK_COMPONENT_TYPE_SINT8_NV = new VkComponentTypeKHR(3);
    ...
    public static final VkComponentTypeKHR VK_COMPONENT_TYPE_UINT16_NV = new VkComponentTypeKHR(8);
    public static final VkComponentTypeKHR VK_COMPONENT_TYPE_UINT32_KHR = new VkComponentTypeKHR(9);
    public static final VkComponentTypeKHR VK_COMPONENT_TYPE_UINT32_NV = new VkComponentTypeKHR(9);
    public static final VkComponentTypeKHR VK_COMPONENT_TYPE_UINT64_KHR = new VkComponentTypeKHR(10);
    public static final VkComponentTypeKHR VK_COMPONENT_TYPE_UINT64_NV = new VkComponentTypeKHR(10);
    public static final VkComponentTypeKHR VK_COMPONENT_TYPE_UINT8_KHR = new VkComponentTypeKHR(7);
    public static final VkComponentTypeKHR VK_COMPONENT_TYPE_UINT8_NV = new VkComponentTypeKHR(7);
