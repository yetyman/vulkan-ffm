...
public record VkPipelineCreationFeedbackFlagBits(int value) {
    ...
    public static final VkPipelineCreationFeedbackFlagBits VK_PIPELINE_CREATION_FEEDBACK_APPLICATION_PIPELINE_CACHE_HIT_BIT_EXT = new VkPipelineCreationFeedbackFlagBits(2);
    ...
    public static final VkPipelineCreationFeedbackFlagBits VK_PIPELINE_CREATION_FEEDBACK_BASE_PIPELINE_ACCELERATION_BIT_EXT = new VkPipelineCreationFeedbackFlagBits(4);
    ...
    public static final VkPipelineCreationFeedbackFlagBits VK_PIPELINE_CREATION_FEEDBACK_VALID_BIT_EXT = new VkPipelineCreationFeedbackFlagBits(1);
