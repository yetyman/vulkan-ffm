...
public class _IMAGE_OPTIONAL_HEADER64 {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        VulkanWin32FFM.C_SHORT.withName("Magic"),
        VulkanWin32FFM.C_CHAR.withName("MajorLinkerVersion"),
        VulkanWin32FFM.C_CHAR.withName("MinorLinkerVersion"),
        VulkanWin32FFM.C_LONG.withName("SizeOfCode"),
        VulkanWin32FFM.C_LONG.withName("SizeOfInitializedData"),
        VulkanWin32FFM.C_LONG.withName("SizeOfUninitializedData"),
        VulkanWin32FFM.C_LONG.withName("AddressOfEntryPoint"),
        VulkanWin32FFM.C_LONG.withName("BaseOfCode"),
        VulkanWin32FFM.align(VulkanWin32FFM.C_LONG_LONG, 4).withName("ImageBase"),
        VulkanWin32FFM.C_LONG.withName("SectionAlignment"),
        VulkanWin32FFM.C_LONG.withName("FileAlignment"),
        VulkanWin32FFM.C_SHORT.withName("MajorOperatingSystemVersion"),
        VulkanWin32FFM.C_SHORT.withName("MinorOperatingSystemVersion"),
        VulkanWin32FFM.C_SHORT.withName("MajorImageVersion"),
        VulkanWin32FFM.C_SHORT.withName("MinorImageVersion"),
        VulkanWin32FFM.C_SHORT.withName("MajorSubsystemVersion"),
        VulkanWin32FFM.C_SHORT.withName("MinorSubsystemVersion"),
        VulkanWin32FFM.C_LONG.withName("Win32VersionValue"),
        VulkanWin32FFM.C_LONG.withName("SizeOfImage"),
        VulkanWin32FFM.C_LONG.withName("SizeOfHeaders"),
        VulkanWin32FFM.C_LONG.withName("CheckSum"),
        VulkanWin32FFM.C_SHORT.withName("Subsystem"),
        VulkanWin32FFM.C_SHORT.withName("DllCharacteristics"),
        VulkanWin32FFM.align(VulkanWin32FFM.C_LONG_LONG, 4).withName("SizeOfStackReserve"),
        VulkanWin32FFM.align(VulkanWin32FFM.C_LONG_LONG, 4).withName("SizeOfStackCommit"),
        VulkanWin32FFM.align(VulkanWin32FFM.C_LONG_LONG, 4).withName("SizeOfHeapReserve"),
        VulkanWin32FFM.align(VulkanWin32FFM.C_LONG_LONG, 4).withName("SizeOfHeapCommit"),
        VulkanWin32FFM.C_LONG.withName("LoaderFlags"),
        VulkanWin32FFM.C_LONG.withName("NumberOfRvaAndSizes"),
