...
public class PPM_WMI_PERF_STATES_EX {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        VulkanWin32FFM.C_LONG.withName("Count"),
        VulkanWin32FFM.C_LONG.withName("MaxFrequency"),
        VulkanWin32FFM.C_LONG.withName("CurrentState"),
        VulkanWin32FFM.C_LONG.withName("MaxPerfState"),
        VulkanWin32FFM.C_LONG.withName("MinPerfState"),
        VulkanWin32FFM.C_LONG.withName("LowestPerfState"),
        VulkanWin32FFM.C_LONG.withName("ThermalConstraint"),
        VulkanWin32FFM.C_CHAR.withName("BusyAdjThreshold"),
        VulkanWin32FFM.C_CHAR.withName("PolicyType"),
        VulkanWin32FFM.C_CHAR.withName("Type"),
        VulkanWin32FFM.C_CHAR.withName("Reserved"),
        VulkanWin32FFM.C_LONG.withName("TimerInterval"),
        MemoryLayout.paddingLayout(4),
        VulkanWin32FFM.C_POINTER.withName("TargetProcessors"),
        VulkanWin32FFM.C_LONG.withName("PStateHandler"),
        VulkanWin32FFM.C_LONG.withName("PStateContext"),
        VulkanWin32FFM.C_LONG.withName("TStateHandler"),
        VulkanWin32FFM.C_LONG.withName("TStateContext"),
        VulkanWin32FFM.C_LONG.withName("FeedbackHandler"),
        VulkanWin32FFM.C_LONG.withName("Reserved1"),
        VulkanWin32FFM.C_LONG_LONG.withName("Reserved2"),
        MemoryLayout.sequenceLayout(1, PPM_WMI_PERF_STATE.layout()).withName("State")
    ).withName("$anon$17632:9");
