...
public class tagEMRTEXT {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        ...
        VulkanWin32FFM.C_LONG.withName("nChars"),
        VulkanWin32FFM.C_LONG.withName("offString"),
        VulkanWin32FFM.C_LONG.withName("fOptions"),
        _RECTL.layout().withName("rcl"),
        VulkanWin32FFM.C_LONG.withName("offDx")
    ).withName("tagEMRTEXT");
