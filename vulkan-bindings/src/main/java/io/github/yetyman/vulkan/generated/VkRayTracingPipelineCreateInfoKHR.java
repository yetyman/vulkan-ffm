...
public class VkRayTracingPipelineCreateInfoKHR {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        ...
        VulkanFFM.C_INT.withName("groupCount"),
        MemoryLayout.paddingLayout(4),
        VulkanFFM.C_POINTER.withName("pGroups"),
        VulkanFFM.C_INT.withName("maxPipelineRayRecursionDepth"),
        MemoryLayout.paddingLayout(4),
        VulkanFFM.C_POINTER.withName("pLibraryInfo"),
        VulkanFFM.C_POINTER.withName("pLibraryInterface"),
