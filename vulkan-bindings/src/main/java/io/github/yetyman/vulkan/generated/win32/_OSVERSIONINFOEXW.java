...
public class _OSVERSIONINFOEXW {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        VulkanWin32FFM.C_LONG.withName("dwOSVersionInfoSize"),
        VulkanWin32FFM.C_LONG.withName("dwMajorVersion"),
        VulkanWin32FFM.C_LONG.withName("dwMinorVersion"),
        VulkanWin32FFM.C_LONG.withName("dwBuildNumber"),
        VulkanWin32FFM.C_LONG.withName("dwPlatformId"),
        MemoryLayout.sequenceLayout(128, VulkanWin32FFM.C_SHORT).withName("szCSDVersion"),
        VulkanWin32FFM.C_SHORT.withName("wServicePackMajor"),
        VulkanWin32FFM.C_SHORT.withName("wServicePackMinor"),
        VulkanWin32FFM.C_SHORT.withName("wSuiteMask"),
        VulkanWin32FFM.C_CHAR.withName("wProductType"),
        VulkanWin32FFM.C_CHAR.withName("wReserved")
