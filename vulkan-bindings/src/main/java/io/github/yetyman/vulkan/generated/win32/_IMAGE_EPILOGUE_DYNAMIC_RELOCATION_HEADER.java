...
public class _IMAGE_EPILOGUE_DYNAMIC_RELOCATION_HEADER {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        VulkanWin32FFM.align(VulkanWin32FFM.C_LONG, 1).withName("EpilogueCount"),
        VulkanWin32FFM.C_CHAR.withName("EpilogueByteCount"),
        VulkanWin32FFM.C_CHAR.withName("BranchDescriptorElementSize"),
        VulkanWin32FFM.align(VulkanWin32FFM.C_SHORT, 1).withName("BranchDescriptorCount")
