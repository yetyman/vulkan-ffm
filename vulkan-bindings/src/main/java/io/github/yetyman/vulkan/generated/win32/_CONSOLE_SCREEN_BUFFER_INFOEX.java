...
public class _CONSOLE_SCREEN_BUFFER_INFOEX {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        ...
        VulkanWin32FFM.C_SHORT.withName("wAttributes"),
        _SMALL_RECT.layout().withName("srWindow"),
        _COORD.layout().withName("dwMaximumWindowSize"),
        VulkanWin32FFM.C_SHORT.withName("wPopupAttributes"),
        VulkanWin32FFM.C_INT.withName("bFullscreenSupported"),
        MemoryLayout.sequenceLayout(16, VulkanWin32FFM.C_LONG).withName("ColorTable")
