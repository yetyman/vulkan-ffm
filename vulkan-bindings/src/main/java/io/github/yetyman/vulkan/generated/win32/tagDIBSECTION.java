...
public class tagDIBSECTION {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        ...
        MemoryLayout.sequenceLayout(3, VulkanWin32FFM.C_LONG).withName("dsBitfields"),
        MemoryLayout.paddingLayout(4),
        VulkanWin32FFM.C_POINTER.withName("dshSection"),
        VulkanWin32FFM.C_LONG.withName("dsOffset"),
        MemoryLayout.paddingLayout(4)
