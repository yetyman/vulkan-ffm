...
public record VkBufferUsageFlagBits(int value) {
    ...
    public static final VkBufferUsageFlagBits VK_BUFFER_USAGE_SHADER_BINDING_TABLE_BIT_KHR = new VkBufferUsageFlagBits(1024);
    public static final VkBufferUsageFlagBits VK_BUFFER_USAGE_SHADER_DEVICE_ADDRESS_BIT = new VkBufferUsageFlagBits(131072);
    public static final VkBufferUsageFlagBits VK_BUFFER_USAGE_SHADER_DEVICE_ADDRESS_BIT_EXT = new VkBufferUsageFlagBits(131072);
    public static final VkBufferUsageFlagBits VK_BUFFER_USAGE_SHADER_DEVICE_ADDRESS_BIT_KHR = new VkBufferUsageFlagBits(131072);
