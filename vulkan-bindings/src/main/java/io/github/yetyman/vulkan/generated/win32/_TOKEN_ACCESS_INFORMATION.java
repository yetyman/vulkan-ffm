...
public class _TOKEN_ACCESS_INFORMATION {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        VulkanWin32FFM.C_POINTER.withName("SidHash"),
        VulkanWin32FFM.C_POINTER.withName("RestrictedSidHash"),
        VulkanWin32FFM.C_POINTER.withName("Privileges"),
        _LUID.layout().withName("AuthenticationId"),
        VulkanWin32FFM.C_INT.withName("TokenType"),
        VulkanWin32FFM.C_INT.withName("ImpersonationLevel"),
        _TOKEN_MANDATORY_POLICY.layout().withName("MandatoryPolicy"),
        VulkanWin32FFM.C_LONG.withName("Flags"),
        VulkanWin32FFM.C_LONG.withName("AppContainerNumber"),
        MemoryLayout.paddingLayout(4),
        VulkanWin32FFM.C_POINTER.withName("PackageSid"),
        VulkanWin32FFM.C_POINTER.withName("CapabilitiesHash"),
        VulkanWin32FFM.C_POINTER.withName("TrustLevelSid"),
        VulkanWin32FFM.C_POINTER.withName("SecurityAttributes")
