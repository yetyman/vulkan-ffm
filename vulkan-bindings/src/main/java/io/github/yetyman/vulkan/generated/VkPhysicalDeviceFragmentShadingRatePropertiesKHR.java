...
public class VkPhysicalDeviceFragmentShadingRatePropertiesKHR {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        ...
        VulkanFFM.C_INT.withName("maxFragmentShadingRateAttachmentTexelSizeAspectRatio"),
        VulkanFFM.C_INT.withName("primitiveFragmentShadingRateWithMultipleViewports"),
        VulkanFFM.C_INT.withName("layeredShadingRateAttachments"),
        VulkanFFM.C_INT.withName("fragmentShadingRateNonTrivialCombinerOps"),
        VkExtent2D.layout().withName("maxFragmentSize"),
        VulkanFFM.C_INT.withName("maxFragmentSizeAspectRatio"),
        VulkanFFM.C_INT.withName("maxFragmentShadingRateCoverageSamples"),
        VulkanFFM.C_INT.withName("maxFragmentShadingRateRasterizationSamples"),
        VulkanFFM.C_INT.withName("fragmentShadingRateWithShaderDepthStencilWrites"),
        VulkanFFM.C_INT.withName("fragmentShadingRateWithSampleMask"),
        VulkanFFM.C_INT.withName("fragmentShadingRateWithShaderSampleMask"),
        VulkanFFM.C_INT.withName("fragmentShadingRateWithConservativeRasterization"),
        VulkanFFM.C_INT.withName("fragmentShadingRateWithFragmentShaderInterlock"),
        VulkanFFM.C_INT.withName("fragmentShadingRateWithCustomSampleLocations"),
        VulkanFFM.C_INT.withName("fragmentShadingRateStrictMultiplyCombiner")
