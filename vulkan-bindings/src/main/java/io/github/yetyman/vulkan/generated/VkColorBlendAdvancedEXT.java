...
public class VkColorBlendAdvancedEXT {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        VulkanFFM.C_INT.withName("advancedBlendOp"),
        VulkanFFM.C_INT.withName("srcPremultiplied"),
        VulkanFFM.C_INT.withName("dstPremultiplied"),
        VulkanFFM.C_INT.withName("blendOverlap"),
        VulkanFFM.C_INT.withName("clampResults")
