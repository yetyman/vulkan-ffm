...
/**
 * {@snippet lang=c :
 * typedef void (*PFN_vkGetDeviceImageSparseMemoryRequirementsKHR)(VkDevice, const VkDeviceImageMemoryRequirements *, uint32_t *, VkSparseImageMemoryRequirements2 *) __attribute__((stdcall))
 * }
 */
public final class PFN_vkGetDeviceImageSparseMemoryRequirementsKHR {

    private PFN_vkGetDeviceImageSparseMemoryRequirementsKHR() {
    ...
    private static final MethodHandle UP$MH = VulkanWin32FFM.upcallHandle(PFN_vkGetDeviceImageSparseMemoryRequirementsKHR.Function.class, "apply", $DESC);
