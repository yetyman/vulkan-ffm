...
public class MEM_EXTENDED_PARAMETER {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        ...
        ).withName("$anon$14113:5"),
        MemoryLayout.unionLayout(
            VulkanWin32FFM.C_LONG_LONG.withName("ULong64"),
            VulkanWin32FFM.C_POINTER.withName("Pointer"),
            VulkanWin32FFM.C_LONG_LONG.withName("Size"),
            VulkanWin32FFM.C_POINTER.withName("Handle"),
            VulkanWin32FFM.C_LONG.withName("ULong")
    ...
    private static final OfLong ULong64$LAYOUT = (OfLong)$LAYOUT.select(groupElement("$anon$14118:5"), groupElement("ULong64"));
    ...
    private static final long ULong64$OFFSET = $LAYOUT.byteOffset(groupElement("$anon$14118:5"), groupElement("ULong64"));
    ...
    private static final AddressLayout Pointer$LAYOUT = (AddressLayout)$LAYOUT.select(groupElement("$anon$14118:5"), groupElement("Pointer"));
    ...
    private static final long Pointer$OFFSET = $LAYOUT.byteOffset(groupElement("$anon$14118:5"), groupElement("Pointer"));
    ...
    private static final OfLong Size$LAYOUT = (OfLong)$LAYOUT.select(groupElement("$anon$14118:5"), groupElement("Size"));
    ...
    private static final long Size$OFFSET = $LAYOUT.byteOffset(groupElement("$anon$14118:5"), groupElement("Size"));
    ...
    private static final AddressLayout Handle$LAYOUT = (AddressLayout)$LAYOUT.select(groupElement("$anon$14118:5"), groupElement("Handle"));
    ...
    private static final long Handle$OFFSET = $LAYOUT.byteOffset(groupElement("$anon$14118:5"), groupElement("Handle"));
    ...
    private static final OfInt ULong$LAYOUT = (OfInt)$LAYOUT.select(groupElement("$anon$14118:5"), groupElement("ULong"));
    ...
    private static final long ULong$OFFSET = $LAYOUT.byteOffset(groupElement("$anon$14118:5"), groupElement("ULong"));
