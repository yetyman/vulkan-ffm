...
public record VkAttachmentStoreOp(int value) {
    ...
    public static final VkAttachmentStoreOp VK_ATTACHMENT_STORE_OP_NONE_EXT = VK_ATTACHMENT_STORE_OP_NONE;
    public static final VkAttachmentStoreOp VK_ATTACHMENT_STORE_OP_NONE_KHR = VK_ATTACHMENT_STORE_OP_NONE;
    public static final VkAttachmentStoreOp VK_ATTACHMENT_STORE_OP_NONE_QCOM = VK_ATTACHMENT_STORE_OP_NONE;
