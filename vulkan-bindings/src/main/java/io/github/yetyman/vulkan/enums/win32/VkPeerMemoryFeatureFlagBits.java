...
public record VkPeerMemoryFeatureFlagBits(int value) {
    ...
    public static final VkPeerMemoryFeatureFlagBits VK_PEER_MEMORY_FEATURE_COPY_DST_BIT_KHR = new VkPeerMemoryFeatureFlagBits(2);
    public static final VkPeerMemoryFeatureFlagBits VK_PEER_MEMORY_FEATURE_COPY_SRC_BIT = new VkPeerMemoryFeatureFlagBits(1);
    public static final VkPeerMemoryFeatureFlagBits VK_PEER_MEMORY_FEATURE_COPY_SRC_BIT_KHR = new VkPeerMemoryFeatureFlagBits(1);
    ...
    public static final VkPeerMemoryFeatureFlagBits VK_PEER_MEMORY_FEATURE_GENERIC_DST_BIT_KHR = new VkPeerMemoryFeatureFlagBits(8);
    public static final VkPeerMemoryFeatureFlagBits VK_PEER_MEMORY_FEATURE_GENERIC_SRC_BIT = new VkPeerMemoryFeatureFlagBits(4);
    public static final VkPeerMemoryFeatureFlagBits VK_PEER_MEMORY_FEATURE_GENERIC_SRC_BIT_KHR = new VkPeerMemoryFeatureFlagBits(4);
