...
/**
 * {@snippet lang=c :
 * typedef VkResult (*PFN_vkGetDisplayModePropertiesKHR)(VkPhysicalDevice, VkDisplayKHR, uint32_t *, VkDisplayModePropertiesKHR *) __attribute__((stdcall))
 * }
 */
public final class PFN_vkGetDisplayModePropertiesKHR {

    private PFN_vkGetDisplayModePropertiesKHR() {
    ...
    private static final MethodHandle UP$MH = VulkanWin32FFM.upcallHandle(PFN_vkGetDisplayModePropertiesKHR.Function.class, "apply", $DESC);
