...
public class StdVideoAV1LoopFilter {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        ...
        MemoryLayout.sequenceLayout(4, VulkanWin32FFM.C_CHAR).withName("loop_filter_level"),
        VulkanWin32FFM.C_CHAR.withName("loop_filter_sharpness"),
        VulkanWin32FFM.C_CHAR.withName("update_ref_delta"),
        MemoryLayout.sequenceLayout(8, VulkanWin32FFM.C_CHAR).withName("loop_filter_ref_deltas"),
    ...
    public static byte loop_filter_level(MemorySegment struct, long index0) {
        return (byte)loop_filter_level$ELEM_HANDLE.get(struct, loop_filter_level$OFFSET, index0);
    }
    ...
    public static void loop_filter_level(MemorySegment struct, long index0, byte fieldValue) {
        loop_filter_level$ELEM_HANDLE.set(struct, loop_filter_level$OFFSET, index0, fieldValue);
    }
