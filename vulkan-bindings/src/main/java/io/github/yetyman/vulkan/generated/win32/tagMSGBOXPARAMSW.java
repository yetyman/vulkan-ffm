...
public class tagMSGBOXPARAMSW {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        ...
        VulkanWin32FFM.C_POINTER.withName("hwndOwner"),
        VulkanWin32FFM.C_POINTER.withName("hInstance"),
        VulkanWin32FFM.C_POINTER.withName("lpszText"),
        VulkanWin32FFM.C_POINTER.withName("lpszCaption"),
        VulkanWin32FFM.C_LONG.withName("dwStyle"),
        MemoryLayout.paddingLayout(4),
        VulkanWin32FFM.C_POINTER.withName("lpszIcon"),
        VulkanWin32FFM.C_LONG_LONG.withName("dwContextHelpId"),
        VulkanWin32FFM.C_POINTER.withName("lpfnMsgBoxCallback"),
        VulkanWin32FFM.C_LONG.withName("dwLanguageId"),
        MemoryLayout.paddingLayout(4)
