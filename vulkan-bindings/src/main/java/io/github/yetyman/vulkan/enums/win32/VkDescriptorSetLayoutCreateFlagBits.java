...
public record VkDescriptorSetLayoutCreateFlagBits(int value) {
    ...
    public static final VkDescriptorSetLayoutCreateFlagBits VK_DESCRIPTOR_SET_LAYOUT_CREATE_HOST_ONLY_POOL_BIT_VALVE = new VkDescriptorSetLayoutCreateFlagBits(4);
    ...
    public static final VkDescriptorSetLayoutCreateFlagBits VK_DESCRIPTOR_SET_LAYOUT_CREATE_PUSH_DESCRIPTOR_BIT_KHR = new VkDescriptorSetLayoutCreateFlagBits(1);
    ...
    public static final VkDescriptorSetLayoutCreateFlagBits VK_DESCRIPTOR_SET_LAYOUT_CREATE_UPDATE_AFTER_BIND_POOL_BIT_EXT = new VkDescriptorSetLayoutCreateFlagBits(2);
