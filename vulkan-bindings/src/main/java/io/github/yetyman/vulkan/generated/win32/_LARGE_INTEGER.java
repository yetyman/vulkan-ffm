...
public class _LARGE_INTEGER {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.unionLayout(
        MemoryLayout.structLayout(
            VulkanWin32FFM.C_LONG.withName("LowPart"),
            VulkanWin32FFM.C_LONG.withName("HighPart")
        ).withName("$anon$875:5"),
        _LARGE_INTEGER.u.layout().withName("u"),
        VulkanWin32FFM.C_LONG_LONG.withName("QuadPart")
    ...
    private static final long LowPart$OFFSET = $LAYOUT.byteOffset(groupElement("$anon$875:5"), groupElement("LowPart"));
    ...
    private static final long HighPart$OFFSET = $LAYOUT.byteOffset(groupElement("$anon$875:5"), groupElement("HighPart"));
