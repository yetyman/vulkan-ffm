...
public class EnumGenerator {
    ...
    private static final Pattern CONSTANT_PATTERN = Pattern.compile("private static final int (shaderc_\\w+) = \\(int\\)(-?\\d+)L;");
    ...
    private static String determineEnumType(String constantName) {
        if (constantName.startsWith("shaderc_vertex_shader") || 
            constantName.startsWith("shaderc_fragment_shader") ||
            constantName.startsWith("shaderc_compute_shader") ||
            constantName.startsWith("shaderc_geometry_shader") ||
            constantName.startsWith("shaderc_tess_") ||
            constantName.startsWith("shaderc_glsl_") ||
            constantName.startsWith("shaderc_spirv_assembly") ||
            constantName.startsWith("shaderc_raygen_shader") ||
            constantName.startsWith("shaderc_anyhit_shader") ||
            constantName.startsWith("shaderc_closesthit_shader") ||
            constantName.startsWith("shaderc_miss_shader") ||
            constantName.startsWith("shaderc_intersection_shader") ||
            constantName.startsWith("shaderc_callable_shader") ||
            constantName.startsWith("shaderc_task_shader") ||
            constantName.startsWith("shaderc_mesh_shader")) return "ShadercShaderKind";
            
        if (constantName.startsWith("shaderc_compilation_status_")) return "ShadercCompilationStatus";
        if (constantName.startsWith("shaderc_source_language_")) return "ShadercSourceLanguage";
        if (constantName.startsWith("shaderc_optimization_level_")) return "ShadercOptimizationLevel";
        if (constantName.startsWith("shaderc_target_env_")) return "ShadercTargetEnv";
        if (constantName.startsWith("shaderc_env_version_")) return "ShadercEnvVersion";
        if (constantName.startsWith("shaderc_spirv_version_")) return "ShadercSpirvVersion";
    ...
    private static void generateEnumClass(String enumType, Map<String, Long> constants, Path outputDir) {
        try {
            ...
            sb.append("package io.github.yetyman.shaderc.enums;\n\n");
